...
outputFile="$1/_output.mp4"
ffmpeg -r 30 -f image2 -pattern_type glob -i "$1/*.png" -vcodec libx264 -crf 1 -pix_fmt yuv420p -f mp4 $outputFile
# On windws, glob might not work, so use this: `image2 -i %%04d.tga`
