...
var i = class e {
	...
	static get _emitter() {
		return e._emitterInstance ??= new Xe();
	}
	static on(t, n, r) {
...
var o = (e) => {
	...
	smpte170m: 6,
	"bt2020-ncl": 9
}, C = /* #__PURE__ */ _(S), ee = (e) => !!e && !!e.primaries && !!e.transfer && !!e.matrix && e.fullRange !== void 0, te = (e) => e instanceof ArrayBuffer || typeof SharedArrayBuffer < "u" && e instanceof SharedArrayBuffer || ArrayBuffer.isView(e), w = class {
	constructor() {
...
}, ne = /^[0-9a-fA-F]+$/, re = (e) => [...e].map((e) => e.toString(16).padStart(2, "0")).join(""), ie = (e) => {
	a(e.length % 2 == 0);
	let t = new Uint8Array(e.length / 2);
	for (let n = 0; n < e.length; n += 2) t[n / 2] = parseInt(e.slice(n, n + 2), 16);
	return t;
}, ae = (e) => (e = e >> 1 & 1431655765 | (e & 1431655765) << 1, e = e >> 2 & 858993459 | (e & 858993459) << 2, e = e >> 4 & 252645135 | (e & 252645135) << 4, e = e >> 8 & 16711935 | (e & 16711935) << 8, e = e >> 16 & 65535 | (e & 65535) << 16, e >>> 0), oe = (e, t, n) => {
...
}, pe = (e, t, n) => fe(e, t, n) << 8 >> 8, me = (e, t, n, r) => {
	...
	n = A(n, -8388608, 8388607), n < 0 && (n = n + 16777216 & 16777215), me(e, t, n, r);
}, k = (e, t, n, r) => {
	r ? (e.setUint32(t + 0, n, !0), e.setInt32(t + 4, Math.floor(n / 2 ** 32), !0)) : (e.setInt32(t + 0, Math.floor(n / 2 ** 32), !0), e.setUint32(t + 4, n, !0));
}, A = (e, t, n) => Math.max(t, Math.min(n, e)), j = (e) => {
	let t = Math.round(e);
	return Math.abs(e / t - 1) < 10 * 2 ** -52 ? t : e;
}, ge = (e, t) => Math.round(e / t) * t, _e = (e, t) => Math.round(e * t) / t, ve = (e, t) => Math.floor(e / t) * t, ye = (e, t) => Math.floor(e * t) / t, be = (e) => {
	let t = 0;
	for (; e;) t++, e >>= 1;
	return t;
}, xe = /^[a-z]{3}$/, Se = (e) => xe.test(e), Ce = 1e6 * (1 + 2 ** -52), we = (e, t) => {
	let n = e < 0 ? -1 : 1;
	e = Math.abs(e);
...
}, Ee = null, De = () => Ee === null ? Ee = !!(typeof navigator < "u" && (navigator.vendor?.match(/apple/i) || /AppleWebKit/.test(navigator.userAgent) && !/Chrome/.test(navigator.userAgent) || /\b(iPad|iPhone|iPod)\b/.test(navigator.userAgent))) : Ee, Oe = null, ke = () => Oe === null ? Oe = typeof navigator < "u" && navigator.userAgent?.includes("Firefox") : Oe, Ae = null, je = () => Ae === null ? Ae = !!(typeof navigator < "u" && (navigator.vendor?.includes("Google Inc") || /Chrome/.test(navigator.userAgent))) : Ae, Me = null, Ne = () => {
	if (Me !== null) return Me;
	if (typeof navigator > "u") return null;
	let e = /\bChrome\/(\d+)/.exec(navigator.userAgent);
	return e ? Me = Number(e[1]) : null;
}, Pe = (e, t) => e === -1 ? t : e, Fe = (e, t, n, r) => e <= r && n <= t, Ie = function* (e) {
	for (let t in e) {
		let n = e[t];
		n !== void 0 && (yield {
			key: t,
...
}, He = (e) => typeof e == "number" && !Number.isNaN(e), Ue = (e, t) => {
...
}, Je = (e) => new Promise((t) => setTimeout(t, e)), Ye = (e) => Array.isArray(e) ? e : [e], Xe = class {
	constructor() {
...
}, Ze = (e) => Math.ceil(e / 2) * 2, Qe = (e) => typeof e == "object" && !!e && Object.getPrototypeOf(e) === Object.prototype && Object.values(e).every((e) => typeof e == "string"), $e = class {
	constructor(e, t) {
	...
	if (e.raw !== void 0) {
		...
		for (let t of Object.values(e.raw)) if (t !== null && typeof t != "string" && !(t instanceof Uint8Array) && !(t instanceof $e) && !(t instanceof et) && !Qe(t)) throw TypeError("Each value in tags.raw must be a string, Uint8Array, RichImageData, AttachedFile, Record<string, string>, or null.");
	}
}, nt = (e) => e.title === void 0 && e.description === void 0 && e.artist === void 0 && e.album === void 0 && e.albumArtist === void 0 && e.trackNumber === void 0 && e.tracksTotal === void 0 && e.discNumber === void 0 && e.discsTotal === void 0 && e.genre === void 0 && e.date === void 0 && e.lyrics === void 0 && (!e.images || e.images.length === 0) && e.comment === void 0 && (e.raw === void 0 || Object.keys(e.raw).length === 0), rt = {
	default: !0,
	primary: !0,
	forced: !1,
	original: !1,
	...
	let t = new M(e), n = t.readBits(5);
	n === 31 && (n = 32 + t.readBits(6));
	let r = t.readBits(4), i = null;
	r === 15 ? i = t.readBits(24) : r < N.length && (i = N[r]);
	let a = t.readBits(4), o = null;
	return a >= 1 && a <= 7 && (o = P[a]), {
		objectType: n,
		frequencyIndex: r,
		sampleRate: i,
...
], mt = ".01.01.01.01.00", ht = ".0.110.01.01.01.0", gt = (e, t, n, r) => {
	if (e === "avc") {
		let e = Math.ceil(t / 16) * Math.ceil(n / 16), i = dt.find((t) => e <= t.maxMacroblocks && r <= t.maxBitrate) ?? s(dt), a = i ? i.level : 0;
		return `avc1.${"64".padStart(2, "0")}00${a.toString(16).padStart(2, "0")}`;
	} else if (e === "hevc") {
		let e = t * n, i = I.find((t) => e <= t.maxPictureSize && r <= t.maxBitrate) ?? s(I);
		return `hev1.1.6.${i.tier}${i.level}.B0`;
	} else if (e === "vp8") return "vp8";
	else if (e === "vp9") {
		let e = t * n;
		return `vp09.00.${(ft.find((t) => e <= t.maxPictureSize && r <= t.maxBitrate) ?? s(ft)).level.toString().padStart(2, "0")}.08`;
	} else if (e === "av1") {
		let e = t * n, i = pt.find((t) => e <= t.maxPictureSize && r <= t.maxBitrate) ?? s(pt);
	...
	if (t === "avc") {
		if (a(e.avcType !== null), i) {
			...
			return `avc${e.avcType}.${re(t)}`;
		}
		if (!n || n.byteLength < 4) throw TypeError("AVC decoder description is not provided or is not at least 4 bytes long.");
		return `avc${e.avcType}.${re(n.subarray(1, 4))}`;
	} else if (t === "hevc") {
		let e, t, r, i, a, s;
		if (o) e = o.generalProfileSpace, t = o.generalProfileIdc, r = ae(o.generalProfileCompatibilityFlags), i = o.generalTierFlag, a = o.generalLevelIdc, s = [...o.generalConstraintIndicatorFlags];
		else {
			...
			e = c >> 6 & 3, t = c & 31, r = ae(o.getUint32(2)), i = c >> 5 & 1, a = o.getUint8(12), s = [];
		...
		if (!c) {
			let t = e.width * e.height, n = s(ft).level;
			for (let e of ft) if (t <= e.maxPictureSize) {
				n = e.level;
				break;
			}
		...
		return d += `.${a}.${o}.${l}.${u}`, d.endsWith(mt) && (d = d.slice(0, -15)), d;
	} else if (t === "av1") {
		if (!l) {
			let t = e.width * e.height, n = s(ft).level;
			for (let e of ft) if (t <= e.maxPictureSize) {
		...
		return m += `.${o}.${c.toString().padStart(3, "0")}`, m += `.${u.toString().padStart(2, "0")}`, m += `.${d.toString().padStart(2, "0")}`, m += `.${f.toString().padStart(2, "0")}`, m += `.${p}`, m.endsWith(ht) && (m = m.slice(0, -17)), m;
	}
	...
	if (t === "aac") {
		...
		{
			let e;
			return e = r.objectType === null ? at(n).objectType : r.objectType, `mp4a.40.${e}`;
		}
	...
	else if (t && F.includes(t)) return t;
	throw TypeError(`Unhandled codec '${t}'.`);
}, St = 48e3, Ct = /^pcm-([usf])(\d+)(be)?$/, wt = (e) => {
	if (a(F.includes(e)), e === "ulaw") return {
		dataType: "ulaw",
		sampleSize: 1,
		littleEndian: !0,
		silentValue: 255
...
}, L = (e) => e.startsWith("avc1") || e.startsWith("avc3") ? "avc" : e.startsWith("hev1") || e.startsWith("hvc1") ? "hevc" : e === "vp8" ? "vp8" : e.startsWith("vp09") ? "vp9" : e.startsWith("av01") ? "av1" : e === "mp3" || e === "mp4a.69" || e === "mp4a.6B" || e === "mp4a.6b" || e === "mp4a.40.34" ? "mp3" : e.startsWith("mp4a.40.") || e === "mp4a.67" ? "aac" : e === "opus" ? "opus" : e === "vorbis" ? "vorbis" : e === "flac" ? "flac" : e === "ac-3" || e === "ac3" ? "ac3" : e === "ec-3" || e === "eac3" ? "eac3" : e === "ulaw" ? "ulaw" : e === "alaw" ? "alaw" : Ct.test(e) ? e : e === "webvtt" ? "webvtt" : null, Tt = (e) => e === "avc" ? { avc: { format: "avc" } } : e === "hevc" ? { hevc: { format: "hevc" } } : {}, Et = (e) => e === "aac" ? { aac: { format: "aac" } } : e === "opus" ? { opus: { format: "opus" } } : {}, Dt = [
	"avc1",
	"avc3",
	"hev1",
	"hvc1",
	...
	"vp09",
	"av01"
], Ot = /^(avc1|avc3)\.[0-9a-fA-F]{6}$/, kt = /^(hev1|hvc1)\.(?:[ABC]?\d+)\.[0-9a-fA-F]{1,8}\.[LH]\d+(?:\.[0-9a-fA-F]{1,2}){0,6}$/, At = /^vp09(?:\.\d{2}){3}(?:(?:\.\d{2}){5})?$/, jt = /^av01\.\d\.\d{2}[MH]\.\d{2}(?:\.\d\.\d{3}\.\d{2}\.\d{2}\.\d{2}\.\d)?$/, Mt = (e) => {
	...
	if (e.decoderConfig.description !== void 0 && !te(e.decoderConfig.description)) throw TypeError("Video chunk metadata decoder configuration description, when defined, must be an ArrayBuffer or an ArrayBuffer view.");
	...
	if (e.decoderConfig.codec.startsWith("avc1") || e.decoderConfig.codec.startsWith("avc3")) {
		...
		if (!At.test(e.decoderConfig.codec)) throw TypeError("Video chunk metadata decoder configuration codec string for VP9 must be a valid VP9 codec string as specified in Section \"Codecs Parameter String\" of https://www.webmproject.org/vp9/mp4/.");
	} else if (e.decoderConfig.codec.startsWith("av01") && !jt.test(e.decoderConfig.codec)) throw TypeError("Video chunk metadata decoder configuration codec string for AV1 must be a valid AV1 codec string as specified in Section \"Codecs Parameter String\" of https://aomediacodec.github.io/av1-isobmff/.");
}, Nt = [
	"mp4a",
	"mp3",
	"opus",
	...
	if (!Nt.some((t) => e.decoderConfig.codec.startsWith(t))) throw TypeError("Audio chunk metadata decoder configuration codec string must be a valid audio codec string as specified in the Mediabunny Codec Registry.");
	...
	if (e.decoderConfig.description !== void 0 && !te(e.decoderConfig.description)) throw TypeError("Audio chunk metadata decoder configuration description, when defined, must be an ArrayBuffer or an ArrayBuffer view.");
	...
	} else if ((e.decoderConfig.codec.startsWith("pcm") || e.decoderConfig.codec.startsWith("ulaw") || e.decoderConfig.codec.startsWith("alaw")) && !F.includes(e.decoderConfig.codec)) throw TypeError(`Audio chunk metadata decoder configuration codec string for PCM must be one of the supported PCM codecs (${F.join(", ")}).`);
}, Ft = (e) => {
	...
	256,
	-1
], Rt = 1483304551, zt = (e, t, n, r, i) => t === 0 ? 0 : t === 1 ? Math.floor(144 * n / (r << e)) + i : t === 2 ? Math.floor(144 * n / r) + i : (Math.floor(12 * n / r) + i) * 4, Bt = (e, t, n, r) => t === 0 ? 0 : t === 1 ? 144 * n / (r << e) : t === 2 ? 144 * n / r : 12 * n / r * 4, Vt = (e, t) => e === 3 ? t === 3 ? 21 : 36 : t === 3 ? 13 : 21, Ht = (e, t) => {
	...
	let c = r >> 3 & 3, l = r >> 1 & 3, u = i >> 4 & 15, d = (i >> 2 & 3) % 3, f = i >> 1 & 1, p = a >> 6 & 3, m = a >> 4 & 3, h = a >> 3 & 1, g = a >> 2 & 1, _ = a & 3, v = Lt[o * 16 * 4 + l * 16 + u];
	if (v === -1) return {
		header: null,
		bytesAdvanced: 1
	};
	let y = v * 1e3, b = It[d] >> o + s, x = zt(o, l, y, b, f);
...
var Zt = function* (e) {
	...
	for (; n + t <= e.length;) {
		let e;
		t === 1 ? e = r.getUint8(n) : t === 2 ? e = r.getUint16(n, !1) : t === 3 ? e = fe(r, n, !1) : (a(t === 4), e = r.getUint32(n, !1)), n += t, yield {
			offset: n,
			length: e
		}, n += e;
	}
}, $t = (e, t) => t.description ? Qt(e, (f(t.description)[4] & 3) + 1) : Zt(e), en = (e) => e & 31, tn = (e) => {
	let t = [], n = e.length;
	...
	let t = e.reduce((e, t) => e + nn.byteLength + t.byteLength, 0), n = new Uint8Array(t), r = 0;
	for (let t of e) n.set(nn, r), r += nn.byteLength, n.set(t, r), r += t.byteLength;
	return n;
}, an = (e, t) => {
	...
	return r;
}, on = (e, t) => t.description ? an(e, (f(t.description)[4] & 3) + 1) : rn(e), sn = (e) => {
	try {
		let t = [], n = [], r = [];
		for (let i of Zt(e)) {
			let a = e.subarray(i.offset, i.offset + i.length), o = en(a[0]);
			o === Yt.SPS ? t.push(a) : o === Yt.PPS ? n.push(a) : o === Yt.SPS_EXT && r.push(a);
		}
	...
	try {
		...
		if (t.readBits(1)) {
			...
			t.readBits(1) && t.skipBits(1), t.readBits(1) && (t.skipBits(3), ee = t.readBits(1), t.readBits(1) && (x = t.readBits(8), S = t.readBits(8), C = t.readBits(8))), t.readBits(1) && (l(t), l(t)), t.readBits(1) && (t.skipBits(32), t.skipBits(32), t.skipBits(1));
			let e = t.readBits(1);
			e && fn(t);
			let n = t.readBits(1);
			n && fn(t), (e || n) && t.skipBits(1), t.skipBits(1), t.readBits(1) && (t.skipBits(1), l(t), l(t), l(t), l(t), w = l(t), ne = l(t));
		}
		if (w === null) {
			a(ne === null);
			let e = r & 16;
			if ((n === 44 || n === 86 || n === 100 || n === 110 || n === 122 || n === 244) && e) w = 0, ne = 0;
			else {
				let e = m + 1, t = h + 1, n = (2 - b) * t, r = dt.find((e) => e.level >= i) ?? s(dt), a = Math.min(Math.floor(r.maxDpbMbs / (e * n)), 16);
				w = a, ne = a;
			}
		}
		return a(ne !== null), {
...
}, pn = (e, t) => t.description ? an(e, (f(t.description)[21] & 3) + 1) : rn(e), mn = (e, t) => t.description ? Qt(e, (f(t.description)[21] & 3) + 1) : Zt(e), hn = (e) => e >> 1 & 63, gn = (e) => {
	try {
		let t = new M(tn(e));
		t.skipBits(16), t.readBits(4);
		let n = t.readBits(3), r = t.readBits(1), { general_profile_space: i, general_tier_flag: a, general_profile_idc: o, general_profile_compatibility_flags: s, general_constraint_indicator_flags: c, general_level_idc: u } = vn(t, n);
		l(t);
		let d = l(t), f = 0;
		d === 3 && (f = t.readBits(1));
		...
		if (l(t), l(t), l(t), l(t), l(t), l(t), t.readBits(1) && t.readBits(1) && yn(t), t.skipBits(1), t.skipBits(1), t.readBits(1) && (t.skipBits(4), t.skipBits(4), l(t), l(t), t.skipBits(1)), bn(t, l(t)), t.readBits(1)) {
			let e = l(t);
			for (let n = 0; n < e; n++) l(t), t.skipBits(1);
		}
		t.skipBits(1), t.skipBits(1);
		let x = 2, S = 2, C = 2, ee = 0, te = 0, w = {
			num: 1,
			den: 1
		};
		if (t.readBits(1)) {
			let e = Sn(t, n);
			w = e.pixelAspectRatio, x = e.colourPrimaries, S = e.transferCharacteristics, C = e.matrixCoefficients, ee = e.fullRangeFlag, te = e.minSpatialSegmentationIdc;
		}
		return {
			displayWidth: h,
			displayHeight: g,
	...
	try {
		let t = [], n = [], r = [], i = [];
		for (let a of Zt(e)) {
			let o = e.subarray(a.offset, a.offset + a.length), s = hn(o[0]);
			s === Xt.VPS_NUT ? t.push(o) : s === Xt.SPS_NUT ? n.push(o) : s === Xt.PPS_NUT ? r.push(o) : (s === Xt.PREFIX_SEI_NUT || s === Xt.SUFFIX_SEI_NUT) && i.push(o);
		}
	...
	let n = [];
	for (let r = 0; r < t; r++) n[r] = xn(e, r, t, n);
}, xn = (e, t, n, r) => {
	let i = 0, a = 0, o = 0;
	...
	return e.readBits(1) && e.readBits(1), e.readBits(1) && (e.readBits(3), a = e.readBits(1), e.readBits(1) && (n = e.readBits(8), r = e.readBits(8), i = e.readBits(8))), e.readBits(1) && (l(e), l(e)), e.readBits(1), e.readBits(1), e.readBits(1), e.readBits(1) && (l(e), l(e), l(e), l(e)), e.readBits(1) && (e.readBits(32), e.readBits(32), e.readBits(1) && l(e), e.readBits(1) && Cn(e, !0, t)), e.readBits(1) && (e.readBits(1), e.readBits(1), e.readBits(1), o = l(e), l(e), l(e), l(e), l(e)), {
		pixelAspectRatio: s,
		colourPrimaries: n,
	...
	for (let t = 0; t <= n; t++) {
		...
		let s = 1;
		o || (s = l(e) + 1), r && wn(e, s, a), i && wn(e, s, a);
	}
}, wn = (e, t, n) => {
...
var Dn = (e, t) => {
	let n = /* @__PURE__ */ new Set(), r = En.audAllowed;
	for (let i of mn(e, t)) {
		if (r === En.noMoreDataAllowed) {
			n.add(i.offset);
			continue;
		}
		let t = hn(e[i.offset]);
		if (r === En.eoBitstreamAllowed && t !== 37) {
			n.add(i.offset);
			continue;
		}
		let a = !1;
		t === 35 ? r > En.audAllowed ? a = !0 : r = En.beforeFirstVcl : t <= 31 ? r > En.afterFirstVcl ? a = !0 : r = En.afterFirstVcl : t === 36 ? r === En.afterFirstVcl ? r = En.eoBitstreamAllowed : a = !0 : t === 37 ? r < En.afterFirstVcl ? a = !0 : r = En.noMoreDataAllowed : t === 32 || t === 33 || t === 34 || t === 39 || t >= 41 && t <= 44 || t >= 48 && t <= 55 ? r > En.beforeFirstVcl ? a = !0 : r = En.beforeFirstVcl : (t === 38 || t === 40 || t >= 45 && t <= 47 || t >= 56 && t <= 63) && r < En.afterFirstVcl && (a = !0), a && n.add(i.offset);
	}
	if (n.size === 0) return null;
	let i = [];
	for (let r of mn(e, t)) n.has(r.offset) || i.push(e.subarray(r.offset, r.offset + r.length));
	return pn(i, t);
}, On = (e) => {
	let t = new M(e);
	...
	let l = t.readBits(16), u = t.readBits(16), d = (l + 1) * (u + 1), f = s(ft).level;
	for (let e of ft) if (d <= e.maxPictureSize) {
		f = e.level;
		break;
	}
	return {
	...
	for (let { type: t, data: n } of kn(e)) {
		if (t !== 1) continue;
		let e = new M(n), r = e.readBits(3);
		e.readBits(1);
	...
	480,
	960
], Nn = (e) => ({ durationInSamples: Mn[e[0] >> 3] }), Pn = (e) => {
	...
	switch (e) {
		case "avc":
			for (let e of $t(n, t)) {
				let t = n[e.offset], r = en(t);
				if (r >= Yt.NON_IDR_SLICE && r <= Yt.SLICE_DPC) return "delta";
				if (r === Yt.IDR) return "key";
				if (r === Yt.SEI && (!je() || Ne() >= 144)) {
					let t = tn(n.subarray(e.offset, e.offset + e.length)), r = 1;
					do {
						let e = 0;
						for (;;) {
							let n = t[r++];
		...
		case "hevc":
			for (let e of mn(n, t)) {
				let t = hn(n[e.offset]);
				if (t < Xt.BLA_W_LP) return "delta";
				if (t <= Xt.RSV_IRAP_VCL23) return "key";
			}
			return "delta";
		...
		case "av1": {
			let e = !1;
			for (let { type: t, data: r } of kn(n)) if (t === 1) {
				let t = new M(r);
...
var Ln = (e, t) => {
	...
	for (let i = 0; i < o; i++) {
		...
		switch (t.raw ??= {}, t.raw[s] ??= c, s) {
			...
			case "METADATA_BLOCK_PICTURE":
				{
					let e = Re(c), n = p(e), r = n.getUint32(0, !1), i = n.getUint32(4, !1), a = String.fromCharCode(...e.subarray(8, 8 + i)), o = n.getUint32(8 + i, !1), s = m.decode(e.subarray(12 + i, 12 + i + o)), l = n.getUint32(i + o + 28), u = e.subarray(i + o + 32, i + o + 32 + l);
	...
	for (let { key: e, value: r } of Ie(t)) switch (e) {
		case "title":
			c("TITLE", r);
			break;
		case "description":
		...
		case "images":
			...
			for (let e of r) {
				...
				a.setUint32(0, t, !1), a.setUint32(4, n.length, !1), i.set(n, 8), a.setUint32(8 + n.length, r.length, !1), i.set(r, 12 + n.length), a.setUint32(28 + n.length + r.length, e.data.length, !1), i.set(e.data, 32 + n.length + r.length), c("METADATA_BLOCK_PICTURE", ze(i));
			}
			break;
		case "raw": break;
		default: O(e);
...
var Un = [
	...
	let u = Un[o], d;
	return d = i < 3 ? qt[i] / 1e3 : Jt[a] / 1e3, {
	...
	let t = new M(e), n = t.readBits(13), r = t.readBits(3), i = [];
	...
	return a(t), t.fscod < 3 ? qt[t.fscod] : t.fscod2 !== null && t.fscod2 < 3 ? Jt[t.fscod2] : null;
}, qn = (e) => {
	let t = e.substreams[0];
	a(t);
	let n = zn[t.acmod] + t.lfeon;
	if (t.numDepSub > 0) {
		let e = [
			2,
			2,
	...
	dispose() {}
}, Yn = /* #__PURE__ */ new Uint8Array(), R = class e {
	constructor(e, t, n, r, i = -1, a, o) {
		if (this.data = e, this.type = t, this.timestamp = n, this.duration = r, this.sequenceNumber = i, e === Yn && a === void 0) throw Error("Internal error: byteLength must be explicitly provided when constructing metadata-only packets.");
	...
	if (r > 0) {
		...
		if (n += 4, r > 0) {
			a = [];
			for (let t = 0; t < r; t++) a.push(re(e.subarray(n, n + 16))), n += 16;
		}
	}
	let o = t.getUint32(n);
	return n += 4, {
...
}, Qn = (e, t) => e.systemId === t.systemId && Be(e.data, t.data), $n = (e) => {
...
}, er = (e) => Qs(e) / 65536, tr = (e) => Qs(e) / 1073741824, nr = (e) => {
	let t = 0;
	for (let n = 0; n < 4; n++) {
		t <<= 7;
		let n = U(e);
	...
	let t = qs(e);
	return e.skip(2), t = Math.min(t, e.remainingLength), m.decode(H(e, t));
}, ir = (e) => {
	let t = $n(e);
	if (!t || t.name !== "data" || e.remainingLength < 8) return null;
	let n = W(e);
	e.skip(4);
	let r = H(e, t.contentSize - 8);
	switch (n) {
		case 1: return m.decode(r);
		case 2: return new TextDecoder("utf-16be").decode(r);
		case 13: return new $e(r, "image/jpeg");
		case 14: return new $e(r, "image/png");
		case 27: return new $e(r, "image/bmp");
		default: return r;
	}
}, ar = /* @__PURE__ */ new Uint32Array(256), or = /* @__PURE__ */ new Uint32Array(256), sr = /* @__PURE__ */ new Uint32Array(256), cr = /* @__PURE__ */ new Uint32Array(256), lr = /* @__PURE__ */ new Uint32Array(256), ur = /* @__PURE__ */ new Uint32Array(256), dr = /* @__PURE__ */ new Uint32Array(10), fr = !1, pr = () => {
	...
	for (let t = 0; t < 256; t++) {
		...
		ar[t] = n << 24 | n << 16 | n << 8 | n, ur[t] = i << 24 | i << 16 | i << 8 | i;
		let a = r(i, 14), o = r(i, 9), s = r(i, 13), c = r(i, 11), l = a << 24 | o << 16 | s << 8 | c;
		or[t] = l, sr[t] = l >>> 8 | l << 24, cr[t] = l >>> 16 | l << 16, lr[t] = l >>> 24 | l << 8;
	}
	let i = 1;
	for (let e = 0; e < 10; e++) dr[e] = i << 24, i = i << 1 ^ (i & 128 ? 283 : 0);
	fr = !0;
}, mr = class {
	constructor() {
	...
	init({ key: e, iv: t }) {
		a(e.byteLength === 16), a(t.byteLength === 16), fr || pr();
		...
		for (let e = 4; e < 44; e += 4) {
			...
			this.roundkey[e] = this.roundkey[e - 4] ^ ar[t >>> 16 & 255] & 4278190080 ^ ar[t >>> 8 & 255] & 16711680 ^ ar[t >>> 0 & 255] & 65280 ^ ar[t >>> 24 & 255] & 255 ^ dr[e / 4 - 1], this.roundkey[e + 1] = this.roundkey[e - 3] ^ this.roundkey[e], this.roundkey[e + 2] = this.roundkey[e - 2] ^ this.roundkey[e + 1], this.roundkey[e + 3] = this.roundkey[e - 1] ^ this.roundkey[e + 2];
		}
		...
		for (let e = 4; e < 40; e += 4) for (let t = 0; t < 4; t++) {
			...
			this.roundkey[e + t] = or[ar[n >>> 24 & 255] & 255] ^ sr[ar[n >>> 16 & 255] & 255] ^ cr[ar[n >>> 8 & 255] & 255] ^ lr[ar[n >>> 0 & 255] & 255];
		}
	}
	decrypt() {
		...
		for (let i = 1; i < 10; i++) {
			let a = i * 4;
			c = or[e >>> 24] ^ sr[r >>> 16 & 255] ^ cr[n >>> 8 & 255] ^ lr[t & 255] ^ this.roundkey[a], l = or[t >>> 24] ^ sr[e >>> 16 & 255] ^ cr[r >>> 8 & 255] ^ lr[n & 255] ^ this.roundkey[a + 1], u = or[n >>> 24] ^ sr[t >>> 16 & 255] ^ cr[e >>> 8 & 255] ^ lr[r & 255] ^ this.roundkey[a + 2], d = or[r >>> 24] ^ sr[n >>> 16 & 255] ^ cr[t >>> 8 & 255] ^ lr[e & 255] ^ this.roundkey[a + 3], e = c, t = l, n = u, r = d;
		}
		let f = ur[e >>> 24 & 255] & 4278190080 ^ ur[r >>> 16 & 255] & 16711680 ^ ur[n >>> 8 & 255] & 65280 ^ ur[t >>> 0 & 255] & 255 ^ this.roundkey[40], p = ur[t >>> 24 & 255] & 4278190080 ^ ur[e >>> 16 & 255] & 16711680 ^ ur[r >>> 8 & 255] & 65280 ^ ur[n >>> 0 & 255] & 255 ^ this.roundkey[41], m = ur[n >>> 24 & 255] & 4278190080 ^ ur[t >>> 16 & 255] & 16711680 ^ ur[e >>> 8 & 255] & 65280 ^ ur[r >>> 0 & 255] & 255 ^ this.roundkey[42], h = ur[r >>> 24 & 255] & 4278190080 ^ ur[n >>> 16 & 255] & 16711680 ^ ur[t >>> 8 & 255] & 65280 ^ ur[e >>> 0 & 255] & 255 ^ this.roundkey[43];
	...
	return new ReadableStream({
		pull: async (s) => {
			...
			let d = u === c ? u - 16 : u, f = H(l, d), p = new Uint8Array(d);
			...
			for (;;) {
				...
				if (o.name === "ftyp" || o.name === "styp") {
					...
					for (let e of t.tracks) {
						...
						e.trackBacking && (a(t.info), t.info.type === "video" && t.info.width !== -1 ? (t.trackBacking = new vr(t), this.tracks.push(t)) : t.info.type === "audio" && t.info.numberOfChannels !== -1 && (t.trackBacking = new yr(t), this.tracks.push(t)));
					}
					n = !1;
					break;
				}
	...
	getSampleTableForTrack(e) {
		...
		if (this.currentTrack = e, this.traverseBox(n), this.currentTrack = null, e.info?.type === "audio" && e.info.codec && F.includes(e.info.codec) && t.sampleCompositionTimeOffsets.length === 0) {
			a(e.info?.type === "audio");
			let n = wt(e.info.codec), r = [], i = [];
			for (let a = 0; a < t.sampleToChunk.length; a++) {
				...
				for (let a = 0; a < l; a++) {
					let c = o.startSampleIndex + a * o.samplesPerChunk, l = c + o.samplesPerChunk, u = T(t.sampleTimingEntries, c, (e) => e.startIndex), d = t.sampleTimingEntries[u], f = T(t.sampleTimingEntries, l, (e) => e.startIndex), p = t.sampleTimingEntries[f], m = d.startDecodeTimestamp + (c - d.startIndex) * d.delta, h = p.startDecodeTimestamp + (l - p.startIndex) * p.delta - m, g = s(r);
	...
	async readFragment(e) {
		...
		for (let [, e] of i.trackData) {
			...
			if (!e.startTimestampIsFinal) {
				...
				if (r) wr(e, r.timestamp);
				else {
					let t = T(n, i.moofOffset - 1, (e) => e.moofOffset);
					if (t !== -1) {
						let r = n[t];
						wr(e, r.endTimestamp);
					}
	...
	*iterateContiguousBoxes(e) {
	...
	traverseBox(e) {
		...
		switch (n.name) {
			...
			case "mvhd":
				{
					let t = U(e);
					e.skip(3), t === 1 ? (e.skip(16), this.movieTimescale = W(e), this.movieDurationInTimescale = tc(e)) : (e.skip(8), this.movieTimescale = W(e), this.movieDurationInTimescale = W(e));
				}
				break;
			case "trak":
				{
					...
					this.currentTrack = t, this.readContiguousBoxes(e.slice(r, n.contentSize)), t.id !== -1 && t.timescale !== -1 && t.info !== null && (t.info.type === "video" && t.info.width !== -1 ? (t.trackBacking = new vr(t), this.tracks.push(t)) : t.info.type === "audio" && t.info.numberOfChannels !== -1 && (t.trackBacking = new yr(t), this.tracks.push(t))), this.currentTrack = null;
				}
				break;
			case "tkhd":
				{
					...
					else if (n === 1) e.skip(16), t.id = W(e), e.skip(4), t.durationInMovieTimescale = tc(e);
			...
			case "elst":
				{
					...
					let r = !1, a = 0, o = W(e);
					for (let s = 0; s < o; s++) {
						let o = n === 1 ? tc(e) : W(e), s = n === 1 ? nc(e) : Qs(e), c = er(e);
						if (o !== 0) {
							if (r) {
			...
			case "mdhd":
				{
					...
					if (!t) break;
					let n = U(e);
					e.skip(3), n === 0 ? (e.skip(8), t.timescale = W(e), t.durationInMediaTimescale = W(e)) : n === 1 && (e.skip(16), t.timescale = W(e), t.durationInMediaTimescale = tc(e));
					let r = qs(e);
					if (r > 0) {
						t.languageCode = "";
						for (let e = 0; e < 3; e++) t.languageCode = String.fromCharCode(96 + (r & 31)) + t.languageCode, r >>= 5;
						Se(t.languageCode) || (t.languageCode = "und");
					}
				}
				break;
			case "hdlr":
			...
			case "stsd":
				{
					...
					let r = W(e);
					for (let a = 0; a < r; a++) {
						let r = e.filePos, a = $n(e);
						if (!a) break;
						t.internalCodecId = a.name;
						let o = a.name.toLowerCase();
						if (t.info.type === "video") {
							e.skip(24), t.info.width = qs(e), t.info.height = qs(e), t.info.squarePixelWidth = t.info.width, t.info.squarePixelHeight = t.info.height, e.skip(50), t.frmaCodecString = null, this.readContiguousBoxes(e.slice(e.filePos, r + a.totalSize - e.filePos));
							...
							let c = qs(e), l = qs(e);
							e.skip(4);
							let u = W(e) / 65536, d = null;
							n === 0 && s > 0 && (s === 1 ? (e.skip(4), l = 8 * W(e), e.skip(8)) : s === 2 && (e.skip(4), u = ac(e), c = W(e), e.skip(4), l = W(e), d = W(e), e.skip(8))), t.info.numberOfChannels = c, t.info.sampleRate = u, t.frmaCodecString = null, this.readContiguousBoxes(e.slice(e.filePos, r + a.totalSize - e.filePos));
							let f = o === "enca" ? t.frmaCodecString : o;
							if (t.frmaCodecString = null, f !== "mp4a") if (f === "opus") t.info.codec = "opus", t.info.sampleRate = St;
			...
			case "tenc":
				{
					...
					e.skip(3), e.skip(1);
					let r = U(e);
					if (n > 0 ? (t.encryptionInfo.defaultCryptByteBlock = r >> 4, t.encryptionInfo.defaultSkipByteBlock = r & 15) : (t.encryptionInfo.defaultCryptByteBlock = 0, t.encryptionInfo.defaultSkipByteBlock = 0), t.encryptionInfo.defaultIsProtected = U(e) !== 0, t.encryptionInfo.defaultPerSampleIvSize = U(e), t.encryptionInfo.defaultKid = re(H(e, 16)), t.encryptionInfo.defaultIsProtected && t.encryptionInfo.defaultPerSampleIvSize === 0) {
						let n = U(e), r = /* @__PURE__ */ new Uint8Array(16);
						r.set(H(e, n), 0), t.encryptionInfo.defaultConstantIv = r;
					}
				}
				break;
			case "avcC":
				{
					let t = this.currentTrack;
					if (!t) break;
					a(t.info), t.info.codecDescription = H(e, n.contentSize);
				}
				break;
			case "hvcC":
				{
			...
			case "vpcC":
				{
					...
					let n = U(e), r = U(e), i = U(e), o = i >> 4, s = i >> 1 & 7, c = i & 1, l = U(e), u = U(e), d = U(e);
					t.info.vp9CodecInfo = {
						profile: n,
						level: r,
						bitDepth: o,
			...
			case "av1C":
				{
					...
					let n = U(e), r = n >> 5, i = n & 31, o = U(e), s = o >> 7, c = o >> 6 & 1, l = o >> 5 & 1, u = o >> 4 & 1, d = o >> 3 & 1, f = o >> 2 & 1, p = o & 3, m = r === 2 && c ? l ? 12 : 10 : c ? 10 : 8;
					t.info.av1CodecInfo = {
						profile: r,
						level: i,
						tier: s,
			...
			case "colr":
				{
					...
					let r = qs(e), i = qs(e), o = qs(e), s;
					n === "nclx" && (s = !!(U(e) & 128)), t.info.colorSpace = {
						primaries: y[r],
						transfer: x[i],
						matrix: C[o],
						fullRange: s
			...
			case "esds":
				{
					let t = this.currentTrack;
					if (!t) break;
					a(t.info?.type === "audio"), e.skip(4), a(U(e) === 3), nr(e), e.skip(2);
					let n = U(e), r = (n & 128) != 0, o = (n & 64) != 0, s = (n & 32) != 0;
					if (r && e.skip(2), o) {
						let t = U(e);
						e.skip(t);
					}
					s && e.skip(2), a(U(e) === 4);
					let c = nr(e), l = e.filePos, u = U(e);
					if (u === 64 || u === 103 ? (t.info.codec = "aac", t.info.aacCodecInfo = {
						...
						a(U(e) === 5);
						let n = nr(e);
						if (t.info.codecDescription = H(e, n), t.info.codec === "aac") {
							let e = at(t.info.codecDescription);
			...
			case "enda":
				{
					let t = this.currentTrack;
					if (!t) break;
					a(t.info?.type === "audio"), t.info.pcmLittleEndian = !!(qs(e) & 255);
				}
				break;
			case "pcmC":
				{
					...
					let n = U(e);
					t.info.pcmLittleEndian = !!(n & 1), t.info.pcmSampleSize = U(e);
				}
				break;
			case "dOps":
				{
					...
					let n = U(e), r = qs(e), i = W(e), o = Ys(e), s = U(e), c;
					c = s === 0 ? /* @__PURE__ */ new Uint8Array() : H(e, 2 + n);
			...
			case "dfLa":
				{
					...
					let r = e.filePos;
					e.filePos = n;
					let i = H(e, r - n), o = new Uint8Array(4 + i.byteLength);
			...
			case "dac3":
				{
					...
					if (!t) break;
					a(t.info?.type === "audio");
					let n = new M(H(e, 3)), r = n.readBits(2);
					n.skipBits(8);
					let i = n.readBits(3), o = n.readBits(1);
					r < 3 && (t.info.sampleRate = qt[r]), t.info.numberOfChannels = zn[i] + o;
				}
				break;
			case "dec3":
				{
					...
					if (!t) break;
					a(t.info?.type === "audio");
					let r = Gn(H(e, n.contentSize));
					if (!r) {
						i._warn("Invalid dec3 box contents, ignoring.");
						break;
					}
					let o = Kn(r);
					o !== null && (t.info.sampleRate = o), t.info.numberOfChannels = qn(r);
				}
				break;
			case "stts":
				{
			...
			case "stz2":
				{
					...
					if (!t || !t.sampleTable) break;
					e.skip(4), e.skip(3);
					let n = U(e), r = W(e), i = new M(H(e, Math.ceil(r * n / 8)));
					for (let e = 0; e < r; e++) {
						let e = i.readBits(n);
			...
			case "tfra":
				{
					...
					for (let n = 0; n < f; n++) {
						let n = t === 1 ? tc(e) : W(e), i = t === 1 ? tc(e) : W(e);
			...
			case "traf":
				if (a(this.currentFragment), this.readContiguousBoxes(e.slice(r, n.contentSize)), this.currentTrack) {
					...
					cond: if (e) {
						...
						a(r), r.startTimestamp !== null && (wr(e, r.startTimestamp), e.startTimestampIsFinal = !0), r.encryptionAuxInfo && !e.samples[0].encryption && (e.encryptionAuxInfo = r.encryptionAuxInfo);
					}
			...
			case "tfhd":
				{
					...
					let t = Js(e), n = !!(t & 1), r = !!(t & 2), i = !!(t & 8), o = !!(t & 16), s = !!(t & 32), c = !!(t & 65536), l = !!(t & 131072), u = W(e), d = this.tracks.find((e) => e.id === u);
					if (!d) break;
			...
			case "trun":
				{
					...
					let n = U(e), r = Js(e), i = !!(r & 1), o = !!(r & 4), s = !!(r & 256), c = !!(r & 512), l = !!(r & 1024), u = !!(r & 2048), d = W(e), f = null;
					i && (f = Qs(e));
					let p = null;
					o && (p = W(e));
					let m;
					...
					for (let r = 0; r < d; r++) {
						let i;
						s ? i = W(e) : (a(t.currentFragmentState.defaultSampleDuration !== null), i = t.currentFragmentState.defaultSampleDuration);
						let o;
						c ? o = W(e) : (a(t.currentFragmentState.defaultSampleSize !== null), o = t.currentFragmentState.defaultSampleSize);
						let d;
						l ? d = W(e) : (a(t.currentFragmentState.defaultSampleFlags !== null), d = t.currentFragmentState.defaultSampleFlags), r === 0 && p !== null && (d = p);
						let f = 0;
						u && (f = n === 0 ? W(e) : Qs(e));
						let h = !(d & 65536);
						m.samples.push({
			...
			case "senc":
				{
					...
					if (!n) break;
					e.skip(1);
					let r = !!(Js(e) & 2), i = W(e), o = t.encryptionInfo.defaultPerSampleIvSize;
					a(o !== null);
					for (let a = 0; a < Math.min(i, n.samples.length); a++) {
						let i = /* @__PURE__ */ new Uint8Array(16);
						o > 0 ? i.set(H(e, o), 0) : i.set(t.encryptionInfo.defaultConstantIv, 0);
						let s = null;
						if (r) {
							let t = qs(e);
							s = [];
			...
			case "udta":
				{
					...
					for (let { boxInfo: e, slice: n } of t) {
						if (e.name !== "meta" && !this.currentTrack) {
							let t = n.filePos;
							this.metadataTags.raw ??= {}, e.name[0] === "©" ? this.metadataTags.raw[e.name] ??= rr(n) : this.metadataTags.raw[e.name] ??= H(n, e.contentSize), n.filePos = t;
						}
						switch (e.name) {
							case "meta":
							...
							case "©nam":
							case "name":
								this.currentTrack ? this.currentTrack.name = m.decode(H(n, e.contentSize)) : this.metadataTags.title ??= rr(n);
								break;
							case "©des":
					...
					for (let { boxInfo: e, slice: n } of t) {
						...
						switch (this.metadataTags.raw ??= {}, this.metadataTags.raw[t] ??= i, t) {
							...
							case "com.apple.quicktime.artwork":
								i instanceof $e ? (this.metadataTags.images ??= [], this.metadataTags.images.push({
									data: i.data,
									kind: "coverFront",
									mimeType: i.mimeType
	...
	mapTimestampIntoTimescale(e) {
		return j(e * this.internalTrack.timescale) + this.internalTrack.editListOffset;
	}
	async getPacket(e, t) {
		...
		return !Er(r) || !this.internalTrack.demuxer.isFragmented ? a : this.performFragmentedLookup(null, (e) => {
			let t = e.trackData.get(this.internalTrack.id);
			if (!t) return {
				sampleIndex: -1,
				correctSampleFound: !1
			};
			let r = T(t.presentationTimestamps, n, (e) => e.presentationTimestamp);
			return {
	...
	async getKeyPacket(e, t) {
		let n = this.mapTimestampIntoTimescale(e), r = this.internalTrack.demuxer.getSampleTableForTrack(this.internalTrack), i = xr(r, n), a = await this.fetchPacketForSampleIndex(i, t);
		return !Er(r) || !this.internalTrack.demuxer.isFragmented ? a : this.performFragmentedLookup(null, (e) => {
			let t = e.trackData.get(this.internalTrack.id);
			if (!t) return {
				sampleIndex: -1,
			...
			let r = ue(t.presentationTimestamps, (e) => t.samples[e.sampleIndex].isKeyFrame && e.presentationTimestamp <= n);
			return {
				sampleIndex: r === -1 ? -1 : t.presentationTimestamps[r].sampleIndex,
				correctSampleFound: r !== -1 && n < t.endTimestamp
			};
	...
	async getNextKeyPacket(e, t) {
		let n = this.packetToSampleIndex.get(e);
		if (n !== void 0) {
			let e = Cr(this.internalTrack.demuxer.getSampleTableForTrack(this.internalTrack), n);
	...
	async fetchPacketForSampleIndex(e, t) {
		if (e === -1) return null;
		let n = Sr(this.internalTrack.demuxer.getSampleTableForTrack(this.internalTrack), e);
		if (!n) return null;
		let r;
		if (t.metadataOnly) r = Yn;
		else {
			...
			if (r = H(t, n.sampleSize), this.internalTrack.encryptionAuxInfo) {
				a(this.internalTrack.encryptionInfo);
				let t = await Or(this.internalTrack.demuxer.reader, this.internalTrack.encryptionInfo, this.internalTrack.encryptionAuxInfo);
				e < t.length && (r = await kr(this.internalTrack, t[e], r, null));
			}
		}
		let i = (n.presentationTimestamp - this.internalTrack.editListOffset) / this.internalTrack.timescale, o = n.duration / this.internalTrack.timescale, s = new R(r, n.isKeyFrame ? "key" : "delta", i, o, e, n.sampleSize);
	...
	async fetchPacketInFragment(e, t, n) {
		...
		a(r);
		let i;
		if (n.metadataOnly) i = Yn;
		else {
			let t = this.internalTrack.demuxer.reader.requestSlice(r.byteOffset, r.byteSize);
			if (t instanceof Promise && (t = await t), !t) return null;
			i = H(t, r.byteSize), r.encryption && (i = await kr(this.internalTrack, r.encryption, i, e));
		}
		let o = (r.presentationTimestamp - this.internalTrack.editListOffset) / this.internalTrack.timescale, s = r.duration / this.internalTrack.timescale, c = new R(i, r.isKeyFrame ? "key" : "delta", o, s, e.moofOffset + t, r.byteSize);
	...
	async performFragmentedLookup(e, t, n, r, i) {
		...
		let u = T(this.internalTrack.fragmentLookupTable, n, (e) => e.timestamp), d = u === -1 ? null : this.internalTrack.fragmentLookupTable[u], f = T(this.internalTrack.fragmentPositionCache, n, (e) => e.startTimestamp), p = f === -1 ? null : this.internalTrack.fragmentPositionCache[f], m = Math.max(d?.moofOffset ?? 0, p?.moofOffset ?? 0) || null, h;
	...
	async getDecoderConfig() {
		return this.internalTrack.info.codec ? this.decoderConfigPromise ??= (async () => {
			if (this.internalTrack.info.codec === "vp9" && !this.internalTrack.info.vp9CodecInfo) {
				...
				this.internalTrack.info.vp9CodecInfo = e && On(e.data);
			} else if (this.internalTrack.info.codec === "av1" && !this.internalTrack.info.av1CodecInfo) {
				let e = await this.getFirstPacket({});
				this.internalTrack.info.av1CodecInfo = e && An(e.data);
			}
			let e = {
	...
	if (e.presentationTimestamps) {
		let n = T(e.presentationTimestamps, t, (e) => e.presentationTimestamp);
		return n === -1 ? -1 : e.presentationTimestamps[n].sampleIndex;
	} else {
		let n = T(e.sampleTimingEntries, t, (e) => e.startDecodeTimestamp);
		if (n === -1) return -1;
		let r = e.sampleTimingEntries[n];
		return r.startIndex + Math.min(Math.floor((t - r.startDecodeTimestamp) / r.delta), r.count - 1);
	}
}, xr = (e, t) => {
	if (!e.keySampleIndices) return br(e, t);
	if (e.presentationTimestamps) {
		let n = T(e.presentationTimestamps, t, (e) => e.presentationTimestamp);
		if (n === -1) return -1;
		for (let t = n; t >= 0; t--) {
			let n = e.presentationTimestamps[t].sampleIndex;
			if (oe(e.keySampleIndices, n, (e) => e) !== -1) return n;
		}
		return -1;
	} else {
		let n = br(e, t), r = T(e.keySampleIndices, n, (e) => e);
		return e.keySampleIndices[r] ?? -1;
	}
}, Sr = (e, t) => {
	let n = T(e.sampleTimingEntries, t, (e) => e.startIndex), r = e.sampleTimingEntries[n];
	if (!r || r.startIndex + r.count <= t) return null;
	let i = r.startDecodeTimestamp + (t - r.startIndex) * r.delta, o = T(e.sampleCompositionTimeOffsets, t, (e) => e.startIndex), s = e.sampleCompositionTimeOffsets[o];
	s && t - s.startIndex < s.count && (i += s.offset);
	let c = e.sampleSizes[Math.min(t, e.sampleSizes.length - 1)], l = T(e.sampleToChunk, t, (e) => e.startSampleIndex), u = e.sampleToChunk[l];
	a(u);
	...
	return {
		...
		chunkOffset: f,
		chunkSize: m,
		isKeyFrame: e.keySampleIndices ? oe(e.keySampleIndices, t, (e) => e) !== -1 : !0
	};
}, Cr = (e, t) => {
	if (!e.keySampleIndices) return t + 1;
	let n = T(e.keySampleIndices, t, (e) => e);
...
}, Er = (e) => e.sampleSizes.length === 0, Dr = (e) => e.currentFragmentState ? e.currentFragmentState.encryptionAuxInfo ??= {
	...
	for (let e = 0; e < n.sampleCount; e++) {
		...
		o > 0 ? a.set(H(i, o), 0) : a.set(t.defaultConstantIv, 0);
		let c = null;
		if (r > o) {
			let e = qs(i);
			c = [];
	...
	if (c) s = await c;
		...
		let t = (async () => {
			...
			if (r) {
				...
				for (let e = 0; e < t.length - 1; e++) for (let n = e + 1; n < t.length; n++) Qn(t[e], t[n]) && (t.splice(n, 1), n--);
			}
			let n = await e.demuxer.input._formatOptions.isobmff.resolveKeyId({
				keyId: o,
				psshBoxes: t
			});
			if (!(typeof n == "string" && n.length === 32 && ne.test(n) || n instanceof Uint8Array && n.byteLength === 16)) throw TypeError("resolveKeyId must return a 32-character hex string or a 16-byte Uint8Array containing the decryption key.");
			return n instanceof Uint8Array ? n : ie(n);
		})();
		e.demuxer.decryptionKeyCache.set(o, t), s = await t;
	}
	return i.scheme === "cenc" || i.scheme === "cens" ? Ar(s, i, t, n) : jr(s, i, t, n);
}, Ar = async (e, t, n, r) => {
	let i = /* @__PURE__ */ new Uint8Array(16);
	i.set(n.iv, 0);
	...
	let c = Mr(n.subsamples, t.defaultCryptByteBlock, t.defaultSkipByteBlock), l = 0;
	...
	let c = new Uint8Array(r), l = Mr(n.subsamples, o, s), u = new DataView(n.iv.buffer, n.iv.byteOffset, 16);
	for (let e of l) {
...
var Lr = [z.EBML, z.Segment], Rr = [
	...
	z.Chapters,
	z.Tags
], zr = [...Lr, ...Rr], Br = (e) => e < 256 ? 1 : e < 65536 ? 2 : e < 1 << 24 ? 3 : e < 2 ** 32 ? 4 : e < 2 ** 40 ? 5 : 6, Vr = (e) => e < 1n << 8n ? 1 : e < 1n << 16n ? 2 : e < 1n << 24n ? 3 : e < 1n << 32n ? 4 : e < 1n << 40n ? 5 : e < 1n << 48n ? 6 : e < 1n << 56n ? 7 : 8, Hr = (e) => e >= -64 && e < 64 ? 1 : e >= -8192 && e < 8192 ? 2 : e >= -1048576 && e < 1 << 20 ? 3 : e >= -134217728 && e < 1 << 27 ? 4 : e >= -(2 ** 34) && e < 2 ** 34 ? 5 : 6, Ur = (e) => {
	if (e < 127) return 1;
	if (e < 16383) return 2;
	...
	writeEBML(e) {
		...
		else if (e.data instanceof Nr) this.writeVarInt(4), this.writeFloat32(e.data.value);
		else if (e.data instanceof Pr) this.writeVarInt(8), this.writeFloat64(e.data.value);
		else if (e.data instanceof Fr) {
			let t = e.size ?? Hr(e.data.value);
			this.writeVarInt(t), this.writeSignedInt(e.data.value, t);
		} else if (e.data instanceof Ir) {
	...
	let i = t & r - 1;
	for (let t = 1; t < n; t++) i *= 256, i += U(e);
	return i;
}, B = (e, t) => {
	if (t < 1 || t > 8) throw Error("Bad unsigned int size " + t);
	let n = 0;
	for (let r = 0; r < t; r++) n *= 256, n += U(e);
	return n;
}, qr = (e, t) => {
	if (t < 1) throw Error("Bad unsigned int size " + t);
	let n = 0n;
	for (let r = 0; r < t; r++) n <<= 8n, n += BigInt(U(e));
	return n;
}, Jr = (e) => {
	let t = Gr(e);
	return t === null || e.remainingLength < t ? null : B(e, t);
}, Yr = (e) => {
	if (e.remainingLength < 1) return null;
	if (U(e) === 255) return;
	e.skip(-1);
...
var ci = [
...
], li = 10 * 2 ** 20, ui = class extends Jn {
	constructor(e) {
		...
		return this.readMetadataPromise ??= (async () => {
			...
			for (;;) {
				...
				if (r === z.EBML) {
					...
					i === void 0 && (i = (await ei(this.reader, a, zr, this.reader.fileSize)).pos - a);
	...
	async readSegment(e, t) {
		...
		for (; this.currentSegment.elementEndPos === null || n < this.currentSegment.elementEndPos;) {
			...
			if (e instanceof Promise && (e = await e), !e) break;
			let t = n, r = Xr(e);
			if (!r || !Rr.includes(r.id) && r.id !== z.Void) {
				let e = await ti(this.reader, t, Rr, Math.min(this.currentSegment.elementEndPos ?? Infinity, t + li));
				if (e) {
					n = e;
					continue;
				} else break;
			}
			let { id: i, size: a } = r, o = e.filePos, s = ci.findIndex((e) => e.id === i);
			if (s !== -1) {
				let e = ci[s].flag;
				this.currentSegment[e] = !0, ri(a);
				let t = this.reader.requestSlice(o, a);
				t instanceof Promise && (t = await t), t && this.readContiguousElements(t);
			} else if (i === z.Tags || i === z.Attachments) {
				i === z.Tags ? this.currentSegment.tagsSeen = !0 : this.currentSegment.attachmentsSeen = !0, ri(a);
		...
		if (this.currentSegment.seekEntries.sort((e, t) => e.segmentPosition - t.segmentPosition), this.reader.fileSize !== null) for (let t of this.currentSegment.seekEntries) {
			...
			let { id: a, size: o } = i;
			if (a !== n.id) continue;
			ri(o), this.currentSegment[n.flag] = !0;
	...
	async readCluster(e, t) {
		...
		c === void 0 && (c = (await ei(this.reader, l, zr, t.elementEndPos)).pos - l);
		...
		this.currentCluster = d, u && (d.elementEndPos = this.readContiguousElements(u, zr));
		for (let [, e] of d.trackData) {
			...
			for (let t = 0; t < e.blocks.length; t++) {
				let r = e.blocks[t];
				r.timestamp += d.timestamp, n ||= r.lacing !== ai.None;
			}
			...
			for (let n = 0; n < e.presentationTimestamps.length; n++) {
				...
				e.firstKeyFrameTimestamp === null && i.isKeyFrame && (e.firstKeyFrameTimestamp = i.timestamp), n < e.presentationTimestamps.length - 1 ? i.duration = e.presentationTimestamps[n + 1].timestamp - i.timestamp : i.duration === 0 && t.defaultDuration != null && i.lacing === ai.None && (i.duration = t.defaultDuration);
			}
			...
			let c = T(t.clusterPositionCache, e.startTimestamp, (e) => e.startTimestamp);
	...
	expandLacedBlocks(e, t) {
		for (let n = 0; n < e.length; n++) {
			let r = e[n];
			if (r.lacing === ai.None) continue;
			r.decoded ||= (r.data = this.decodeBlockData(t, r.data), !0);
			let i = Ws.tempFromBytes(r.data), o = [], s = U(i) + 1;
			switch (r.lacing) {
				case ai.Xiph:
					{
						let e = 0;
			...
			for (let t = 0; t < s; t++) {
				let a = o[t], l = H(i, a), u = r.timestamp + c * t / s, d = c / s;
				e.splice(n + t, 0, {
					timestamp: u,
					duration: d,
	...
	async loadSegmentMetadata(e) {
		for (let t of e.seekEntries) {
			if (!(t.id === z.Tags && !e.tagsSeen) && !(t.id === z.Attachments && !e.attachmentsSeen)) continue;
			...
			let { size: i } = r;
			ri(i), a(!this.currentSegment), this.currentSegment = e;
			let o = this.reader.requestSlice(n.filePos, i);
			o instanceof Promise && (o = await o), o && this.readContiguousElements(o), this.currentSegment = null, t.id === z.Tags ? e.tagsSeen = !0 : t.id === z.Attachments && (e.attachmentsSeen = !0);
		}
	}
	...
	traverseElement(e, t) {
		...
		switch (ri(s), r) {
			...
			case z.SeekPosition:
				{
					let t = this.currentSegment?.seekEntries[this.currentSegment.seekEntries.length - 1];
					if (!t) break;
					t.segmentPosition = B(e, s);
				}
				break;
			case z.TimestampScale:
				if (!this.currentSegment) break;
				this.currentSegment.timestampScale = B(e, s), this.currentSegment.timestampFactor = 1e9 / this.currentSegment.timestampScale;
				break;
			case z.Duration:
				if (!this.currentSegment) break;
				this.currentSegment.duration = $r(e, s);
				break;
			case z.TrackEntry:
				...
				if (this.currentTrack.decodingInstructions.some((e) => e.data?.type !== "decompress" || e.scope !== oi.Block || e.data.algorithm !== si.HeaderStripping) && (i._warn(`Track #${this.currentTrack.id} has an unsupported content encoding; dropping.`), this.currentTrack = null), this.currentTrack && this.currentTrack.id !== -1 && this.currentTrack.codecId && this.currentTrack.info) {
					...
					if (this.currentTrack.info.type === "video" && this.currentTrack.info.width !== -1 && this.currentTrack.info.height !== -1) {
						...
						this.currentTrack.codecId === ni.avc ? (this.currentTrack.info.codec = "avc", this.currentTrack.info.codecDescription = this.currentTrack.codecPrivate) : this.currentTrack.codecId === ni.hevc ? (this.currentTrack.info.codec = "hevc", this.currentTrack.info.codecDescription = this.currentTrack.codecPrivate) : t === ni.vp8 ? this.currentTrack.info.codec = "vp8" : t === ni.vp9 ? this.currentTrack.info.codec = "vp9" : t === ni.av1 && (this.currentTrack.info.codec = "av1");
						...
						t === ni.aac ? (this.currentTrack.info.codec = "aac", this.currentTrack.info.aacCodecInfo = {
							isMpeg2: this.currentTrack.codecId.includes("MPEG2"),
							objectType: null
						}, this.currentTrack.info.codecDescription = this.currentTrack.codecPrivate) : this.currentTrack.codecId === ni.mp3 ? this.currentTrack.info.codec = "mp3" : t === ni.opus ? (this.currentTrack.info.codec = "opus", this.currentTrack.info.codecDescription = this.currentTrack.codecPrivate, this.currentTrack.info.sampleRate = St) : t === ni.vorbis ? (this.currentTrack.info.codec = "vorbis", this.currentTrack.info.codecDescription = this.currentTrack.codecPrivate) : t === ni.flac ? (this.currentTrack.info.codec = "flac", this.currentTrack.info.codecDescription = this.currentTrack.codecPrivate) : t === ni.ac3 ? (this.currentTrack.info.codec = "ac3", this.currentTrack.info.codecDescription = this.currentTrack.codecPrivate) : t === ni.eac3 ? (this.currentTrack.info.codec = "eac3", this.currentTrack.info.codecDescription = this.currentTrack.codecPrivate) : this.currentTrack.codecId === "A_PCM/INT/LIT" ? this.currentTrack.info.bitDepth === 8 ? this.currentTrack.info.codec = "pcm-u8" : this.currentTrack.info.bitDepth === 16 ? this.currentTrack.info.codec = "pcm-s16" : this.currentTrack.info.bitDepth === 24 ? this.currentTrack.info.codec = "pcm-s24" : this.currentTrack.info.bitDepth === 32 && (this.currentTrack.info.codec = "pcm-s32") : this.currentTrack.codecId === "A_PCM/INT/BIG" ? this.currentTrack.info.bitDepth === 8 ? this.currentTrack.info.codec = "pcm-u8" : this.currentTrack.info.bitDepth === 16 ? this.currentTrack.info.codec = "pcm-s16be" : this.currentTrack.info.bitDepth === 24 ? this.currentTrack.info.codec = "pcm-s24be" : this.currentTrack.info.bitDepth === 32 && (this.currentTrack.info.codec = "pcm-s32be") : this.currentTrack.codecId === "A_PCM/FLOAT/IEEE" && (this.currentTrack.info.bitDepth === 32 ? this.currentTrack.info.codec = "pcm-f32" : this.currentTrack.info.bitDepth === 64 && (this.currentTrack.info.codec = "pcm-f64"));
						let e = this.currentTrack;
						this.currentTrack.trackBacking = new pi(e), this.currentSegment.tracks.push(this.currentTrack);
					}
				}
			...
			case z.FlagEnabled:
				if (!this.currentTrack) break;
				B(e, s) || (this.currentTrack = null);
				break;
			case z.FlagDefault:
				if (!this.currentTrack) break;
				this.currentTrack.disposition.default = !!B(e, s);
				break;
			case z.FlagForced:
				if (!this.currentTrack) break;
				this.currentTrack.disposition.forced = !!B(e, s);
				break;
			case z.FlagOriginal:
				if (!this.currentTrack) break;
				this.currentTrack.disposition.original = !!B(e, s);
				break;
			case z.FlagHearingImpaired:
				if (!this.currentTrack) break;
				this.currentTrack.disposition.hearingImpaired = !!B(e, s);
				break;
			case z.FlagVisualImpaired:
				if (!this.currentTrack) break;
				this.currentTrack.disposition.visuallyImpaired = !!B(e, s);
				break;
			case z.FlagCommentary:
				if (!this.currentTrack) break;
				this.currentTrack.disposition.commentary = !!B(e, s);
				break;
			case z.CodecID:
				if (!this.currentTrack) break;
				this.currentTrack.codecId = Zr(e, s);
				break;
			case z.CodecPrivate:
				if (!this.currentTrack) break;
				this.currentTrack.codecPrivate = H(e, s);
				break;
			case z.DefaultDuration:
				if (!this.currentTrack) break;
				this.currentTrack.defaultDurationNs = B(e, s);
				break;
			case z.Name:
				if (!this.currentTrack) break;
				this.currentTrack.name = Qr(e, s);
				break;
			case z.Language:
				if (!this.currentTrack || this.currentTrack.hasLanguageBcp47) break;
				this.currentTrack.languageCode = Zr(e, s), Se(this.currentTrack.languageCode) || (this.currentTrack.languageCode = "und");
				break;
			case z.LanguageBCP47:
				{
					if (!this.currentTrack) break;
					let t = Zr(e, s).split("-")[0];
			...
			case z.PixelWidth:
				if (this.currentTrack?.info?.type !== "video") break;
				this.currentTrack.info.width = B(e, s);
				break;
			case z.PixelHeight:
				if (this.currentTrack?.info?.type !== "video") break;
				this.currentTrack.info.height = B(e, s);
				break;
			case z.DisplayWidth:
				if (this.currentTrack?.info?.type !== "video") break;
				this.currentTrack.info.displayWidth = B(e, s);
				break;
			case z.DisplayHeight:
				if (this.currentTrack?.info?.type !== "video") break;
				this.currentTrack.info.displayHeight = B(e, s);
				break;
			case z.DisplayUnit:
				if (this.currentTrack?.info?.type !== "video") break;
				this.currentTrack.info.displayUnit = B(e, s);
				break;
			case z.AlphaMode:
				if (this.currentTrack?.info?.type !== "video") break;
				this.currentTrack.info.alphaMode = B(e, s) === 1;
				break;
			case z.Colour:
				if (this.currentTrack?.info?.type !== "video") break;
				this.currentTrack.info.colorSpace = {}, this.readContiguousElements(e.slice(c, s));
				break;
			case z.MatrixCoefficients:
				{
			...
			case z.Range:
				if (this.currentTrack?.info?.type !== "video" || !this.currentTrack.info.colorSpace) break;
				this.currentTrack.info.colorSpace.fullRange = B(e, s) === 2;
				break;
			case z.TransferCharacteristics:
				{
					if (this.currentTrack?.info?.type !== "video" || !this.currentTrack.info.colorSpace) break;
					let t = x[B(e, s)] ?? null;
			...
			case z.Audio:
				...
				this.readContiguousElements(e.slice(c, s));
				break;
			case z.SamplingFrequency:
				if (this.currentTrack?.info?.type !== "audio") break;
				this.currentTrack.info.sampleRate = $r(e, s);
				break;
			case z.Channels:
				if (this.currentTrack?.info?.type !== "audio") break;
				this.currentTrack.info.numberOfChannels = B(e, s);
				break;
			case z.BitDepth:
				if (this.currentTrack?.info?.type !== "audio") break;
				this.currentTrack.info.bitDepth = B(e, s);
				break;
			case z.CuePoint:
				if (!this.currentSegment) break;
				...
				break;
			case z.CueTime:
				this.currentCueTime = B(e, s);
				break;
			case z.CueTrackPositions:
				{
			...
			case z.CueTrack:
				...
				break;
			case z.CueClusterPosition:
				{
					let t = this.currentSegment?.cuePoints[this.currentSegment.cuePoints.length - 1];
					if (!t) break;
					a(this.currentSegment), t.clusterPosition = this.currentSegment.dataStartPos + B(e, s);
				}
				break;
			case z.Timestamp:
				if (!this.currentCluster) break;
				this.currentCluster.timestamp = B(e, s);
				break;
			case z.SimpleBlock:
				{
					if (!this.currentCluster) break;
					...
					if (!n) break;
					let r = Ys(e), i = U(e), a = i >> 1 & 3, o = !!(i & 128);
					n.track.info?.type === "audio" && n.track.info.codec && (o = !0);
					let l = H(e, s - (e.filePos - c)), u = n.track.decodingInstructions.length > 0;
					n.blocks.push({
						timestamp: r,
						duration: 0,
						isKeyFrame: o,
			...
			case z.Block:
				{
					...
					let n = this.getTrackDataInCluster(this.currentCluster, t);
					if (!n) break;
					let r = Ys(e), i = U(e) >> 1 & 3, a = H(e, s - (e.filePos - c)), o = n.track.decodingInstructions.length > 0;
					this.currentBlock = {
						timestamp: r,
						duration: 0,
						isKeyFrame: !0,
			...
			case z.BlockMore:
				...
				break;
			case z.BlockAdditional:
				if (!this.currentBlockAdditional) break;
				this.currentBlockAdditional.data = H(e, s);
				break;
			case z.BlockAddID:
				if (!this.currentBlockAdditional) break;
				this.currentBlockAdditional.addId = B(e, s);
				break;
			case z.BlockDuration:
				if (!this.currentBlock) break;
				this.currentBlock.duration = B(e, s);
				break;
			case z.ReferenceBlock:
				if (!this.currentBlock) break;
			...
			case z.Targets:
				this.readContiguousElements(e.slice(c, s));
				break;
			case z.TargetTypeValue:
				B(e, s) !== 50 && (this.currentTagTargetIsMovie = !1);
				break;
			case z.TagTrackUID:
			case z.TagEditionUID:
			case z.TagChapterUID:
			case z.TagAttachmentUID:
			...
			case z.SimpleTag:
				...
				break;
			case z.TagName:
				this.currentSimpleTagName = Qr(e, s);
				break;
			case z.TagString:
				{
			...
			case z.FileUID:
				...
				this.currentAttachedFile.fileUid = qr(e, s);
				break;
			case z.FileName:
				if (!this.currentAttachedFile) break;
				this.currentAttachedFile.fileName = Qr(e, s);
				break;
			case z.FileMediaType:
				if (!this.currentAttachedFile) break;
				this.currentAttachedFile.fileMediaType = Zr(e, s);
				break;
			case z.FileData:
				if (!this.currentAttachedFile) break;
				this.currentAttachedFile.fileData = H(e, s);
				break;
			case z.FileDescription:
				if (!this.currentAttachedFile) break;
				this.currentAttachedFile.fileDescription = Qr(e, s);
				break;
			case z.ContentEncodings:
				if (!this.currentTrack) break;
				this.readContiguousElements(e.slice(c, s)), this.currentTrack.decodingInstructions.sort((e, t) => t.order - e.order);
				break;
			case z.ContentEncoding:
				...
				break;
			case z.ContentEncodingOrder:
				if (!this.currentDecodingInstruction) break;
				this.currentDecodingInstruction.order = B(e, s);
				break;
			case z.ContentEncodingScope:
				if (!this.currentDecodingInstruction) break;
				this.currentDecodingInstruction.scope = B(e, s);
				break;
			case z.ContentCompression:
				if (!this.currentDecodingInstruction) break;
				...
				break;
			case z.ContentCompAlgo:
				if (this.currentDecodingInstruction?.data?.type !== "decompress") break;
				this.currentDecodingInstruction.data.algorithm = B(e, s);
				break;
			case z.ContentCompSettings:
				if (this.currentDecodingInstruction?.data?.type !== "decompress") break;
				this.currentDecodingInstruction.data.settings = H(e, s);
				break;
			case z.ContentEncryption:
				if (!this.currentDecodingInstruction) break;
	...
	intoTimescale(e) {
		return j(e * this.internalTrack.segment.timestampFactor);
	}
	async getPacket(e, t) {
		...
		return this.performClusterLookup(null, (e) => {
			...
			let r = T(t.presentationTimestamps, n, (e) => e.timestamp);
			return {
	...
	async getKeyPacket(e, t) {
		...
		return this.performClusterLookup(null, (e) => {
			...
			let r = ue(t.presentationTimestamps, (e) => t.blocks[e.blockIndex].isKeyFrame && e.timestamp <= n);
			return {
				blockIndex: r === -1 ? -1 : t.presentationTimestamps[r].blockIndex,
				correctBlockFound: r !== -1 && n < t.endTimestamp
			};
	...
	async fetchPacketInCluster(e, t, n) {
		...
		let i = n.metadataOnly ? Yn : r.data, o = r.timestamp / this.internalTrack.segment.timestampFactor, s = r.duration / this.internalTrack.segment.timestampFactor, c = {};
		r.mainAdditional && this.internalTrack.info?.type === "video" && this.internalTrack.info.alphaMode && (c.alpha = n.metadataOnly ? Yn : r.mainAdditional, c.alphaByteLength = r.mainAdditional.byteLength);
		let l = new R(i, r.isKeyFrame ? "key" : "delta", o, s, e.dataStartPos + t, r.data.byteLength, c);
	...
	async performClusterLookup(e, t, n, r, i) {
		...
		let d = T(this.internalTrack.cuePoints, n, (e) => e.time), f = d === -1 ? null : this.internalTrack.cuePoints[d], p = T(this.internalTrack.clusterPositionCache, n, (e) => e.startTimestamp), m = p === -1 ? null : this.internalTrack.clusterPositionCache[p], h = Math.max(f?.clusterPosition ?? 0, m?.elementStartPos ?? 0) || null, g;
		for (e ? h === null || e.elementStartPos >= h ? (g = e.elementEndPos, c = e) : g = h : g = h ?? s.clusterSeekStartPos; s.elementEndPos === null || g <= s.elementEndPos - 2;) {
			...
			if (e instanceof Promise && (e = await e), !e) break;
			let n = g, d = Xr(e);
			if (!d || !Rr.includes(d.id) && d.id !== z.Void) {
				let e = await ti(o.reader, n, Rr, Math.min(s.elementEndPos ?? Infinity, n + li));
				if (e) {
					g = e;
					continue;
				} else break;
			...
			p === void 0 && (a(f !== z.Cluster), p = (await ei(o.reader, m, zr, s.elementEndPos)).pos - m);
			let h = m + p;
		...
		return this.internalTrack.info.codec ? this.decoderConfigPromise ??= (async () => {
			...
			let t = {
				codec: yt({
					...
					avcType: 1,
					avcCodecInfo: this.internalTrack.info.codec === "avc" && e ? sn(e.data) : null,
					hevcCodecInfo: this.internalTrack.info.codec === "hevc" && e ? _n(e.data) : null,
					vp9CodecInfo: this.internalTrack.info.codec === "vp9" && e ? On(e.data) : null,
					av1CodecInfo: this.internalTrack.info.codec === "av1" && e ? An(e.data) : null
				}),
				codedWidth: this.internalTrack.info.width,
				codedHeight: this.internalTrack.info.height,
				description: this.internalTrack.info.codecDescription ?? void 0,
	...
	for (; n === null || a < n;) {
		...
		for (; o.remainingLength >= 4;) {
			let t = o.filePos, n = Ht(W(o), e.fileSize === null ? null : e.fileSize - a);
			if (n.header && (!r || n.header.sampleRate === r.sampleRate && n.header.mpegVersionId === r.mpegVersionId && n.header.layer === r.layer && Kt(n.header.channel) === Kt(r.channel))) return {
				header: n.header,
				startPos: a
			};
	...
	constructor(e) {
		super(e), this.metadataPromise = null, this.firstFrameHeader = null, this.firstFrameHeaderPos = null, this.loadedSamples = [], this.metadataTags = null, this.xingData = null, this.trackBackings = [], this.readingMutex = new w(), this.lastSampleLoaded = !1, this.lastLoadedPos = 0, this.nextTimestampInSamples = 0, this.reader = e._reader;
	}
	async readMetadata() {
		return this.metadataPromise ??= (async () => {
			...
			this.trackBackings = [new gi(this)];
		})();
	}
	async advanceReader() {
		...
		let e = await mi(this.reader, this.lastLoadedPos, this.reader.fileSize, this.firstFrameHeader);
		if (!e) {
			this.lastSampleLoaded = !0;
			return;
		}
		...
		let n = Vt(t.mpegVersionId, t.channel), r = this.reader.requestSlice(e.startPos + n, 4);
			...
			if (t === 1483304551 || t === 1231971951) {
				if (!this.xingData) {
					...
					if (t instanceof Promise && (t = await t), t) {
						let e = p(H(t, 12)), n = e.getUint32(0, !1);
						this.xingData = {
							frameCount: n & Gt.FrameCount ? e.getUint32(4, !1) : null,
							fileSize: n & Gt.FileSize ? e.getUint32(8, !1) : null
						};
					}
				}
				return;
	...
	async getDurationFromMetadata() {
		...
		if (a(e.firstFrameHeader !== null), a(e.firstFrameHeaderPos !== null), e.xingData) {
			...
			let t = Bt(e.firstFrameHeader.lowSamplingFrequency, e.firstFrameHeader.layer, e.firstFrameHeader.bitrate, e.firstFrameHeader.sampleRate), n = (e.reader.fileSize - e.firstFrameHeaderPos) / t;
	...
	getNumberOfChannels() {
		return a(this.demuxer.firstFrameHeader), Kt(this.demuxer.firstFrameHeader.channel);
	}
	getSampleRate() {
	...
	async getDecoderConfig() {
		return a(this.demuxer.firstFrameHeader), {
			codec: "mp3",
			numberOfChannels: Kt(this.demuxer.firstFrameHeader.channel),
	...
	async getPacketAtIndex(e, t) {
		...
		return new R(r, "key", n.timestamp, n.duration, e, n.dataSize);
	}
	getFirstPacket(e) {
	...
	async getNextPacket(e, t) {
		...
		try {
			let n = oe(this.demuxer.loadedSamples, e.timestamp, (e) => e.timestamp);
	...
	async getPacket(e, t) {
		...
		try {
			for (;;) {
				let n = T(this.demuxer.loadedSamples, e, (e) => e.timestamp);
...
}, _i = 1399285583, vi = 79764919, yi = /* @__PURE__ */ new Uint32Array(256);
for (let e = 0; e < 256; e++) {
	let t = e << 24;
	for (let e = 0; e < 8; e++) t = t & 2147483648 ? t << 1 ^ vi : t << 1;
	yi[e] = t >>> 0 & 4294967295;
}
var bi = (e) => {
	...
	if (e.length > 0) if (t.codec === "vorbis") {
		a(t.vorbisInfo);
		let o = t.vorbisInfo.modeBlockflags.length, s = (1 << be(o - 1)) - 1 << 1, c = (e[0] & s) >> 1;
		...
		r = l === null ? 0 : l + i >> 2;
	} else t.codec === "opus" && (r = Nn(e).durationInSamples);
	return {
		durationInSamples: r,
		vorbisBlockSize: i
	};
	...
	e.skip(1);
	let n = U(e), r = rc(e), i = Zs(e), a = Zs(e), o = Zs(e), s = U(e), c = new Uint8Array(s);
	for (let t = 0; t < s; t++) c[t] = U(e);
	...
	async readMetadata() {
		return this.metadataPromise ??= (async () => {
			...
			for (let e of this.bitstreams) {
				...
				t && (t.data.byteLength >= 7 && t.data[0] === 1 && t.data[1] === 118 && t.data[2] === 111 && t.data[3] === 114 && t.data[4] === 98 && t.data[5] === 105 && t.data[6] === 115 ? await this.readVorbisMetadata(t, e) : t.data.byteLength >= 8 && t.data[0] === 79 && t.data[1] === 112 && t.data[2] === 117 && t.data[3] === 115 && t.data[4] === 72 && t.data[5] === 101 && t.data[6] === 97 && t.data[7] === 100 && await this.readOpusMetadata(t, e), e.codecInfo.codec !== null && this.trackBackings.push(new Di(e, this)));
			}
		})();
	}
	async readVorbisMetadata(e, t) {
		...
		t.codecInfo.vorbisInfo = {
			...
			modeBlockflags: Pn(i.data).modeBlockflags
		}, Ln(r.data.subarray(7), this.metadataTags);
	}
	async readOpusMetadata(e, t) {
		...
		let i = jn(e.data);
		t.numberOfChannels = i.outputChannelCount, t.sampleRate = St, t.codecInfo.opusInfo = { preSkip: i.preSkip }, Ln(r.data.subarray(8), this.metadataTags);
	}
	...
	async getMimeType() {
		return await this.readMetadata(), Si({ codecStrings: (await Promise.all(this.trackBackings.map((e) => e.getDecoderConfig().then((e) => e?.codec ?? null)))).filter(Boolean) });
	}
	async getTrackBackings() {
		return await this.readMetadata(), this.trackBackings;
	}
	...
	constructor(e, t) {
		this.bitstream = e, this.demuxer = t, this.encodedPacketToMetadata = /* @__PURE__ */ new WeakMap(), this.sequentialScanCache = [], this.sequentialScanMutex = new w(), this.internalSampleRate = e.codecInfo.codec === "opus" ? St : e.sampleRate;
	}
	getType() {
		return "audio";
	}
	...
	createEncodedPacketFromOggPacket(e, t, n) {
		if (!e) return null;
		let { durationInSamples: r, vorbisBlockSize: i } = xi(e.data, this.bitstream.codecInfo, t.vorbisLastBlocksize), a = new R(n.metadataOnly ? Yn : e.data, "key", Math.max(0, t.timestampInSamples) / this.internalSampleRate, r / this.internalSampleRate, e.endPage.headerStartPos + e.endSegmentIndex, e.data.byteLength);
	...
	async getPacket(e, t) {
		...
		let n = j(e * this.internalSampleRate);
		...
		outer: for (; i.headerStartPos + i.totalSize < o;) {
			...
			for (;;) {
				let e = Math.min(r + Ci, o - 27), c = this.demuxer.reader.requestSlice(r, e - r);
				if (c instanceof Promise && (c = await c), a(c), !Ti(c, e)) {
					o = t + 27;
					continue outer;
				}
				...
				if (u.serialNumber === this.bitstream.serialNumber) d = !0;
					...
					e instanceof Promise && (e = await e), a(e), d = bi(H(e, u.totalSize)) === u.checksum;
				}
				if (!d) {
		...
		if (l.headerStartPos === r.startPage.headerStartPos) f = this.granulePositionToTimestampInSamples(0), p = !0, d = 0;
			...
			if (await this.demuxer.findNextPacketStart(e)) {
				let e = ki(u, l, d);
				a(e);
				let t = Oi(u, e.page, e.segmentIndex);
	...
	async getPacketSequential(e, t) {
		...
		try {
			...
			let r = T(this.sequentialScanCache, n, (e) => e.timestampInSamples), i;
			if (r !== -1) {
	...
	outer: for (;;) {
		...
		let t = le(e, (e) => e.headerStartPos < r.headerStartPos);
		if (!t) return null;
	...
	let r = le(e, (e) => e.headerStartPos < t.headerStartPos);
	return r ? {
		page: r,
...
var ji = class extends Jn {
	...
	async readMetadata() {
		return this.metadataPromise ??= (async () => {
			...
			e instanceof Promise && (e = await e), a(e);
			let t = G(e, 4), n = t !== "RIFX", r = t === "RF64", i = Xs(e, n), o = r ? this.reader.fileSize : Math.min(i + 8, this.reader.fileSize ?? Infinity);
			if (G(e, 4) !== "WAVE") throw Error("Invalid WAVE file - wrong format");
			let s = 0, c = null, l = e.filePos;
			for (; o === null || l < o;) {
				let e = this.reader.requestSlice(l, 8);
				if (e instanceof Promise && (e = await e), !e) break;
				let t = G(e, 4), i = Xs(e, n), a = e.filePos;
				...
				if (t === "fmt ") await this.parseFmtChunk(a, i, n);
					...
					if (e instanceof Promise && (e = await e), !e) break;
					let t = ec(e, n);
					c = ec(e, n), o = Math.min(t + 8, this.reader.fileSize ?? Infinity);
			...
			this.dataSize = Math.floor(this.dataSize / u) * u, this.trackBackings.push(new Ni(this));
		})();
	}
	async parseFmtChunk(e, t, n) {
		let r = this.reader.requestSlice(e, t);
		if (r instanceof Promise && (r = await r), !r) return;
		let i = Ks(r, n), a = Ks(r, n), o = Xs(r, n);
		r.skip(4);
		let s = Ks(r, n), c;
		if (c = t === 14 ? 8 : Ks(r, n), t >= 18 && i !== 357) {
			let e = Ks(r, n), a = t - 18;
			if (Math.min(a, e) >= 22 && i === Ai.EXTENSIBLE) {
				r.skip(6);
				let e = H(r, 16);
				i = e[0] | e[1] << 8;
			}
		}
		(i === Ai.MULAW || i === Ai.ALAW) && (c = 8), this.audioInfo = {
			format: i,
			numberOfChannels: a,
			sampleRate: o,
	...
	async parseListChunk(e, t, n) {
		...
		for (; a <= e + t - 8;) {
			r.filePos = a;
			let e = G(r, 4), t = Xs(r, n), i = H(r, t), o = 0;
	...
	async parseId3Chunk(e, t) {
		...
		if (r) {
			let i = t - 10;
			r.size = Math.min(r.size, i), r.size > 0 && pc(n.slice(e + 10, r.size), r, this.metadataTags);
		}
	}
	getCodec() {
		if (a(this.audioInfo), this.audioInfo.format === Ai.MULAW) return "ulaw";
		if (this.audioInfo.format === Ai.ALAW) return "alaw";
		if (this.audioInfo.format === Ai.PCM) {
		...
		return this.audioInfo.format === Ai.IEEE_FLOAT && this.audioInfo.sampleSizeInBytes === 4 ? "pcm-f32" : null;
	}
	async getMimeType() {
		return "audio/wav";
	}
	...
	async getPacketAtIndex(e, t) {
		...
		let n = e * Mi * this.demuxer.audioInfo.blockSizeInBytes;
		if (n >= this.demuxer.dataSize) return null;
		let r = Math.min(Mi * this.demuxer.audioInfo.blockSizeInBytes, this.demuxer.dataSize - n);
		if (this.demuxer.reader.fileSize === null) {
			let e = this.demuxer.reader.requestSlice(this.demuxer.dataStart + n, r);
			if (e instanceof Promise && (e = await e), !e) return null;
		}
		let i;
		if (t.metadataOnly) i = Yn;
		else {
			let e = this.demuxer.reader.requestSlice(this.demuxer.dataStart + n, r);
			e instanceof Promise && (e = await e), a(e), i = H(e, r);
		}
		let o = e * Mi / this.demuxer.audioInfo.sampleRate, s = r / this.demuxer.audioInfo.blockSizeInBytes / this.demuxer.audioInfo.sampleRate;
		return this.demuxer.lastKnownPacketIndex = Math.max(e, this.demuxer.lastKnownPacketIndex), new R(i, "key", o, s, e, r);
	}
	getFirstPacket(e) {
		return this.getPacketAtIndex(0, e);
	}
	async getPacket(e, t) {
		...
		let n = Math.floor(Math.min(e * this.demuxer.audioInfo.sampleRate / Mi, (this.demuxer.dataSize - 1) / (Mi * this.demuxer.audioInfo.blockSizeInBytes)));
		if (n < 0) return null;
	...
	getNextPacket(e, t) {
		a(this.demuxer.audioInfo);
		let n = Math.round(e.timestamp * this.demuxer.audioInfo.sampleRate / Mi);
...
}, Fi = 1024, Ii = class extends Jn {
	constructor(e) {
		super(e), this.metadataPromise = null, this.firstFrameHeader = null, this.loadedSamples = [], this.metadataTags = null, this.trackBackings = [], this.readingMutex = new w(), this.lastSampleLoaded = !1, this.lastLoadedPos = 0, this.nextTimestampInSamples = 0, this.reader = e._reader;
	}
	async readMetadata() {
		return this.metadataPromise ??= (async () => {
			for (; !this.firstFrameHeader && !this.lastSampleLoaded;) await this.advanceReader();
			a(this.firstFrameHeader), this.trackBackings = [new Li(this)];
		})();
	}
	async advanceReader() {
		if (this.lastLoadedPos === 0) for (;;) {
		...
		let n = N[t.samplingFrequencyIndex];
		a(n !== void 0);
		let r = Fi / n, i = {
		...
		this.loadedSamples.push(i), this.nextTimestampInSamples += Fi, this.lastLoadedPos = t.startPos + t.frameLength;
	}
	async getMimeType() {
		return "audio/aac";
	}
	...
	async getMetadataTags() {
		...
		try {
			...
			for (;;) {
				...
				if (r instanceof Promise && (r = await r), !r) break;
				pc(r, n, this.metadataTags), e = t.filePos + n.size;
			}
			return this.metadataTags;
		} finally {
			e();
	...
	getNumberOfChannels() {
		...
		let e = P[this.demuxer.firstFrameHeader.channelConfiguration];
		return a(e !== void 0), e;
	}
	getSampleRate() {
		a(this.demuxer.firstFrameHeader);
		let e = N[this.demuxer.firstFrameHeader.samplingFrequencyIndex];
		return a(e !== void 0), e;
	}
	getDisposition() {
		return { ...rt };
...
}, Ri = (e) => e === 0 ? null : e === 1 ? 192 : e >= 2 && e <= 5 ? 144 * 2 ** e : e === 6 ? "uncommon-u8" : e === 7 ? "uncommon-u16" : e >= 8 && e <= 15 ? 2 ** e : null, zi = (e, t) => {
	switch (e) {
		case 0: return t;
		case 1: return 88200;
	...
	let t = 0, n = new M(H(e, 1));
	for (; n.readBits(1) === 1;) t++;
	if (t === 0) return n.readBits(7);
	let r = [], i = t - 1, a = new M(H(e, i)), o = 8 - t - 1;
	...
	if (t === "uncommon-u16") return qs(e) + 1;
	if (t === "uncommon-u8") return U(e) + 1;
	if (typeof t == "number") return t;
	O(t), a(!1);
}, Hi = (e, t) => t === "uncommon-u16" ? qs(e) : t === "uncommon-u16-10" ? qs(e) * 10 : t === "uncommon-u8" ? U(e) : typeof t == "number" ? t : null, Ui = (e) => {
	let t = 0;
	for (let n of e) {
		t ^= n;
	...
	constructor(e) {
		super(e), this.loadedSamples = [], this.metadataPromise = null, this.trackBacking = null, this.metadataTags = {}, this.audioInfo = null, this.lastLoadedPos = null, this.blockingBit = null, this.readingMutex = new w(), this.lastSampleLoaded = !1, this.reader = e._reader;
	}
	async getMetadataTags() {
		return await this.readMetadata(), this.metadataTags;
	}
	...
	async readMetadata() {
		return this.metadataPromise ??= (async () => {
			...
			for (;;) {
				...
				if (!n) break;
				let r = this.reader.requestSlice(t.filePos, n.size);
				r instanceof Promise && (r = await r), a(r), pc(r, n, this.metadataTags), e = t.filePos + n.size;
			}
			for (e += 4; this.reader.fileSize === null || e < this.reader.fileSize;) {
				...
				switch (n & 127) {
					case In.STREAMINFO: {
						...
						let n = H(t, 34), i = new M(n), o = i.readBits(16), s = i.readBits(16), c = i.readBits(24), l = i.readBits(24), u = i.readBits(20), d = i.readBits(3) + 1;
						i.readBits(5);
						let f = i.readBits(36);
						i.skipBits(128);
						...
						p.set(new Uint8Array([
							...
							maximumFrameSize: l,
							description: p
						}, this.trackBacking = new Gi(this);
						break;
					}
					case In.VORBIS_COMMENT: {
						let t = this.reader.requestSlice(e, r);
						t instanceof Promise && (t = await t), a(t), Ln(H(t, r), this.metadataTags);
						break;
					}
					case In.PICTURE: {
						let t = this.reader.requestSlice(e, r);
						t instanceof Promise && (t = await t), a(t);
						let n = W(t), i = W(t), o = m.decode(H(t, i)), s = W(t), c = m.decode(H(t, s));
						t.skip(16);
						let l = W(t), u = H(t, l);
	...
	async readNextFlacFrame({ startPos: e, isFirstPacket: t }) {
		...
		for (o.filePos = e + r;;) {
			...
			if (U(o) === 255) {
				let t = o.filePos;
				if (U(o) !== (this.blockingBit === 1 ? 249 : 248)) {
					o.filePos = t;
					continue;
				}
				o.skip(-2);
	...
	readFlacFrameHeader({ slice: e, isFirstPacket: t }) {
		...
		let i = Ri(r.readBits(4));
		if (!i) return null;
		a(this.audioInfo);
		let o = zi(r.readBits(4), this.audioInfo.sampleRate);
		if (!o || (r.readBits(4), r.readBits(3), r.readBits(1) !== 0)) return null;
		let s = Bi(e), c = Vi(e, i), l = Hi(e, o);
		if (l === null || l !== this.audioInfo.sampleRate) return null;
		let u = e.filePos - n, d = U(e);
		return e.skip(-u), e.skip(-1), d === Ui(H(e, u)) ? {
			num: s,
			blockSize: c,
			sampleRate: l
		} : null;
	...
	async getPacket(e, t) {
		...
		try {
			for (;;) {
				let n = T(this.demuxer.loadedSamples, e, (e) => e.blockOffset / this.demuxer.audioInfo.sampleRate);
				if (n === -1) {
					await this.demuxer.advanceReader();
					continue;
				}
	...
	async getPacketAtIndex(e, t) {
		...
		return new R(r, "key", i, o, e, n.byteSize);
	}
	async getFirstPacket(e) {
...
}, Ji = "PES packet is missing PTS where it was expected. PES packets without PTS are not currently supported. If you think this file should be supported, please report it.", Yi = /* @__PURE__ */ new Set(), Xi = class extends Jn {
	constructor(e) {
		...
		return this.metadataPromise ??= (async () => {
			...
			for (;;) {
				...
				if (!s && t.pid !== 0 && !(t.payload[0] === 0 && t.payload[1] === 0 && t.payload[2] === 1)) {
					let e = new M(t.payload), n = e.readAlignedByte();
					...
					for (e.skipBits(8 * a); 8 * (r + 3) - e.pos > 32;) {
						...
						switch (t) {
							...
							case 6:
								...
								break;
							default: Yi.has(t) || (i._warn(`Note: MPEG-TS streams with stream_type 0x${t.toString(16)} are not currently supported.`), Yi.add(t));
						}
						...
						if (e.info.type === "video") {
							for (;;) {
								...
								if (t.suppliedPacket = null, await r.markNextPacket(), e.info.codec === "avc") {
									...
									if (e.info.avcCodecInfo = sn(r.suppliedPacket.data), !e.info.avcCodecInfo) continue;
									...
									if (e.info.hevcCodecInfo = _n(r.suppliedPacket.data), !e.info.hevcCodecInfo) continue;
									let t = e.info.hevcCodecInfo.arrays.find((e) => e.nalUnitType === Xt.SPS_NUT).nalUnits[0];
									a(t);
									let n = gn(t);
							...
							if (e.info.codec === "aac") {
								let t = Pi(Ws.tempFromBytes(r.suppliedPacket.data));
								if (!t) throw Error("Invalid AAC audio stream; could not read ADTS frame header from first packet.");
								e.info.aacCodecInfo = {
									isMpeg2: !1,
									objectType: t.objectType
								}, e.info.numberOfChannels = P[t.channelConfiguration], e.info.sampleRate = N[t.samplingFrequencyIndex];
							} else if (e.info.codec === "mp3") {
								let t = Ht(W(Ws.tempFromBytes(r.suppliedPacket.data)), r.suppliedPacket.data.byteLength);
								if (!t.header) throw Error("Invalid MP3 audio stream; could not read frame header from first packet.");
								e.info.numberOfChannels = Kt(t.header.channel), e.info.sampleRate = t.header.sampleRate;
							} else if (e.info.codec === "ac3") {
								let t = Bn(r.suppliedPacket.data);
								...
								e.info.numberOfChannels = zn[t.acmod] + t.lfeon, e.info.sampleRate = qt[t.fscod];
							} else if (e.info.codec === "eac3") {
								let t = Wn(r.suppliedPacket.data);
								...
								e.info.numberOfChannels = qn(t), e.info.sampleRate = n;
							} else throw Error("Unhandled.");
							e.info.decoderConfig = {
								codec: xt({
									codec: e.info.codec,
			...
			for (let e of this.elementaryStreams) e.info.type === "video" ? this.trackBackingEntries.push(new ea(e)) : this.trackBackingEntries.push(new ta(e));
		})();
	}
	async getTrackBackings() {
	...
	async getMimeType() {
		return await this.readMetadata(), qi(await Promise.all(this.trackBackingEntries.map((e) => e.getDecoderConfig().then((e) => e?.codec ?? null))));
	}
	async readSection(e, t, n = !1) {
		...
		for (;;) {
			...
			if (oe(this.sectionEndPositions, r, (e) => e) !== -1) {
				c = !1;
				break;
			}
		}
		if (c) {
			let e = T(this.sectionEndPositions, r, (e) => e);
	...
	async readPacketHeader(e) {
		let t = this.reader.requestSlice(e, 4);
		if (t instanceof Promise && (t = await t), !t) return null;
		if (U(t) !== 71) throw Error("Invalid TS packet sync byte. Likely an internal bug, please report this file.");
		let n = qs(t);
		n >> 15;
		let r = n >> 14 & 1;
		n >> 13 & 1;
	...
	createEncodedPacket(e, t, n) {
		let r;
		return r = this.allPacketsAreKeyPackets() || e.randomAccessIndicator === 1 ? "key" : "delta", new R(n.metadataOnly ? Yn : e.data, r, e.pts / Ki, Math.max(t / Ki, 0), e.sequenceNumber, e.data.byteLength);
	}
	async getFirstPacket(e) {
		...
		let n = Qi(t, !0);
		a(n);
		let r = new ra(this.elementaryStream, n), i = new ia(this, r), o = await i.readNext();
		if (!o) return null;
	...
	async getNextPacket(e, t) {
		...
		let o = Qi(i, !0);
		a(o);
		let s = new ra(this.elementaryStream, o);
		n = new ia(this, s);
	...
	async doPacketLookup(e, t, n) {
		let r = j(e * Ki), i = this.elementaryStream.demuxer, { reader: o, seekChunkSize: c } = i, l = this.elementaryStream.pid, u = async (e, t, n) => {
			let r = e;
			for (; r < t;) {
		...
		let p, m = this.elementaryStream.referencePesPackets, h = T(m, r, (e) => e.pts), g = h === -1 ? null : m[h];
		if (g && r - g.pts < 9e4 / 2) p = g.sectionStartPos;
			...
			if (o.fileSize !== null) {
				...
				if (t > 1) {
					let n = 0, a = t - 1;
					for (e = n; n <= a;) {
						let t = Math.floor((n + a) / 2), o = ve(t * c, i.packetStride) + f.sectionStartPos, s = await u(o, o + c, !1);
						if (!s) {
							a = t - 1;
							continue;
						}
			...
			p = ve(e * c, i.packetStride) + f.sectionStartPos;
		}
		...
		let v = this.getReorderSize(), y = async (e, t) => {
			...
			let c = Qi(o, !0);
			a(c);
			let l = new ra(this.elementaryStream, c), u = new ia(this, l);
			for (; !((s(u.presentationOrderPackets)?.pts ?? -Infinity) >= r || !await u.readNextPacket()););
			let d = ue(u.presentationOrderPackets, t);
			if (d === -1) return null;
		...
		if (!t || this.allPacketsAreKeyPackets()) {
					...
					if (t.pid === l && t.payloadUnitStartIndicator === 1) {
						...
						if (t) {
							...
							if (e && e.pts !== null) {
								...
								_ = e, na(this.elementaryStream, _);
								break;
							}
						}
					}
			...
			for (;;) {
				...
				outer: for (; m && !(t !== null && m.sectionStartPos >= t);) {
					if (m.pts <= r) {
						...
						if (this.elementaryStream.canBeTrustedWithKeyPackets) e = m.randomAccessIndicator === 1;
							...
							let t = Qi(h, !0);
							a(t);
							let n = new ra(this.elementaryStream, t);
					...
					for (;;) {
						...
						if (t.pid === l && t.payloadUnitStartIndicator === 1) {
							...
							if (t) {
								let e = Zi(t, !1);
								if (e && e.pts !== null) {
									m = e, h = t, na(this.elementaryStream, m);
									break;
								}
							}
						}
				...
				if (p) return null;
				t = e, e = Math.max(ve(e - f.sectionStartPos - c, i.packetStride) + f.sectionStartPos, f.sectionStartPos);
			}
		}
	}
}, ea = class extends $i {
	...
	let n = e.referencePesPackets, r = T(n, t.sectionStartPos, (e) => e.sectionStartPos);
	if (r >= 0) {
		let i = n[r];
		...
		if (e.info.type === "video") {
			...
			for (;;) {
				...
				for (; d < u;) {
					...
					let y = c[_], b, x, S;
					if (t === "avc") b = en(y), x = b === Yt.NON_IDR_SLICE || b === Yt.SLICE_DPA || b === Yt.IDR, S = b === Yt.SEI || b === Yt.SPS || b === Yt.PPS || b === Yt.AUD;
					else {
						if (b = hn(y), ((y & 1) << 5 | c[_ + 1] >> 3) > 0) {
							d += h;
							continue;
						}
						x = b <= Xt.RASL_R || b >= Xt.BLA_W_LP && b <= 21, S = b >= Xt.VPS_NUT && b <= 37 || b === Xt.PREFIX_SEI_NUT || b >= 41 && b <= 44 || b >= 48 && b <= 55;
					}
					let C = !1;
					if (x) {
						let e;
						if (t === "avc") {
							let t = l(new M(c.subarray(v, v + 6)));
							e = !a || t <= o, o = t;
						} else e = c[v] >> 7 == 1;
						e && (a ? C = !0 : a = !0);
					} else S && a && (C = !0);
			...
			for (;;) {
				...
				for (; this.currentPos - r < n;) {
					...
					if (t === "aac") {
						...
						let i = this.readBytes(9), a = Pi(Ws.tempFromBytes(i));
						if (a) {
							this.seekTo(t);
							let n = this.ensureBuffered(a.frameLength);
							return n instanceof Promise && (n = await n), this.supplyPacket(n, Math.round(Fi * Ki / e.info.sampleRate));
						...
						let i = Ht(p(this.readBytes(4)).getUint32(0), null);
						if (i.header) {
							this.seekTo(t);
							let n = this.ensureBuffered(i.header.totalSize);
							n instanceof Promise && (n = await n);
							let r = i.header.audioSamplesInFrame * Ki / e.info.sampleRate;
						...
						let l = Math.round(Hn * Ki / e.info.sampleRate);
						...
						let a = (((i[2] & 7) << 8 | i[3]) + 1) * 2, o = Un[i[4] >> 6 == 3 ? 3 : i[4] >> 4 & 3];
						this.seekTo(t), r = this.ensureBuffered(a), r instanceof Promise && (r = await r);
						let s = o * 256, c = Math.round(s * Ki / e.info.sampleRate);
	...
	supplyPacket(e, t) {
		...
		if (this.lastSuppliedPesPacket === n) a(this.nextPts !== null), r = this.nextPts;
			...
			if (n.pts === null) throw Error(Ji);
			r = n.pts, na(this.elementaryStream, n);
		}
		...
		if (c === 0 && !this.elementaryStream.canBeTrustedWithKeyPackets) {
			if (this.elementaryStream.info.type === "audio") c = 1;
				...
				let e = Fn(this.elementaryStream.info.codec, this.elementaryStream.info.decoderConfig, s) === "key";
				c = Number(e);
			}
		}
		this.suppliedPacket = {
...
}, aa = "application/vnd.apple.mpegurl", oa = "#EXT-X-STREAM-INF:", sa = "#EXT-X-I-FRAME-STREAM-INF:", ca = "#EXT-X-MEDIA:", la = "#EXTINF:", ua = "#EXT-X-MAP:", da = "#EXT-X-KEY:", fa = "#EXT-X-MEDIA-SEQUENCE:", pa = "#EXT-X-BYTERANGE:", ma = "#EXT-X-PROGRAM-DATE-TIME:", ha = "#EXT-X-TARGETDURATION:", ga = (e) => e.length === 0 || e.startsWith("#") && !e.startsWith("#EXT"), _a = class {
	constructor(e) {
		this._attributes = {};
		let t = "", n = "", r = !1, i = !1;
		...
		return this.trackBackingsPromise ??= (async () => {
			...
			if (this.trackDeclarations) {
				for (let t of this.trackDeclarations) if (t.type === "video") {
					let n = We(e, (e) => e.getType() === "video") + 1;
					e.push(new ba(this, t, n));
				} else if (t.type === "audio") {
					let n = We(e, (e) => e.getType() === "audio") + 1;
					e.push(new xa(this, t, n));
				}
			} else {
				...
				for (let n of t) if (n.type === "video") {
					let t = We(e, (e) => e.getType() === "video") + 1;
					e.push(new ba(this, {
						id: e.length + 1,
						type: "video"
					}, t));
				} else if (n.type === "audio") {
					let t = We(e, (e) => e.getType() === "audio") + 1;
					e.push(new xa(this, {
						id: e.length + 1,
						type: "audio"
					}, t));
	...
	async createAdjustedPacket(e, t, n) {
		...
		let r = await this.segmentedInput.getMediaOffset(t, n.input), i = t.timestamp - this.segmentedInput.firstSegment.timestamp, o = e.clone({
			timestamp: _e(e.timestamp + r, await n.getTimeResolution()),
...
var Ca = class extends Xe {
	...
	async getSizeOrNull() {
		if (this._disposed) throw new Hs();
		return this._sizePromise ??= (async () => {
			let e = this._getFileSize();
			return e === void 0 ? (await this._read(0, 1, 0, Sa), e = this._getFileSize(), a(e !== void 0), e) : e;
		})();
	}
	async getSize() {
		if (this._disposed) throw new Hs();
	...
	_resolveRequest(e) {
		let t = this.requestHandler(e), n = (e) => {
			if (!(e instanceof Ca || e instanceof wa)) throw TypeError("requestHandler must return or resolve to a Source or SourceRef.");
			let t = e instanceof Ca ? e.ref() : e;
			return t.source._usedForHls ||= this._usedForHls, t;
		};
		return t instanceof Promise ? t.then(n) : n(t);
	}
}, Ea = (e, t) => e.path === t.path, Da = class extends Ta {
	constructor() {
	...
	constructor(e, t = {}) {
		...
		if (t.maxCacheSize !== void 0 && (!He(t.maxCacheSize) || t.maxCacheSize < 0)) throw TypeError("options.maxCacheSize, when provided, must be a non-negative number.");
		...
		super(), this._readers = /* @__PURE__ */ new WeakMap(), this._blob = e, this._options = t, this._orchestrator = new Ma({
			maxCacheSize: t.maxCacheSize ?? 8 * 2 ** 20,
			maxWorkerCount: 4,
			runWorker: this._runWorker.bind(this),
			prefetchProfile: ja.fileSystem
	...
	async _runWorker(e) {
		...
		for (t === void 0 && (t = ("stream" in this._blob) && !De() && this._options.useStreamReader !== !1 ? this._blob.slice(e.currentPos).stream().getReader() : null, this._readers.set(e, t)); e.currentPos < e.targetPos && !e.aborted;) if (t) {
	...
	_read(e, t) {
		...
		let n = T(this._cache, e, (e) => e.start), r = n === -1 ? null : this._cache[n];
		...
		let { promise: o, resolve: s, reject: c } = E();
	...
	read(e, t, n, r) {
		...
		a(o <= e && t <= s);
		let c = null, l = T(this.cache, e, (e) => e.start), u = l === -1 ? null : this.cache[l];
		u && u.start <= e && t <= u.end && (u.age = this.nextAge++, c = {
			bytes: u.bytes,
			view: u.view,
			offset: u.start
		});
		let d = T(this.cache, o, (e) => e.start), f = c ? null : new Uint8Array(t - e), m = 0, h = o, g = [];
		if (d !== -1) {
		...
		let { promise: _, resolve: v, reject: y } = E(), b = [];
		for (let n of g) {
		...
		outer: for (let e of g) {
			...
			if (n) x && (n.pendingSlices = [x]), this.runWorker(n);
				...
				let n = T(this.queuedReads, e.start, (e) => e.hole.start), r = n === -1 ? null : this.queuedReads[n];
	...
	checkHoleAgainstWorker(e, t, n) {
		if (Fe(t.start - 2 ** 17, t.start, e.currentPos, e.targetPos)) {
	...
	supplyWorkerData(e, t) {
		...
		for (let t = 0; t < this.workers.length; t++) {
			...
			e === i || i.running || Fe(n, r, i.currentPos, i.targetPos) && (this.workers.splice(t, 1), t--);
		}
	}
	supplyFileSize(e) {
	...
	insertIntoCache(e) {
		...
		let t = T(this.cache, e.start, (e) => e.start) + 1;
		if (t > 0) {
	...
	_getFileSize() {
		...
		return e === void 0 ? this._length === null ? void 0 : this._length : e === null ? this._length === null ? null : this._length : A(e - this._offset, 0, this._length ?? Infinity);
	}
	_read(e, t, n, r) {
...
}), Ia = /^0[xX][0-9a-fA-F]+$/, La = /^data:.*;base64,/i, Ra = class extends va {
	constructor(e, t, n, r) {
	...
	runUpdateSegments() {
		return this.currentUpdateSegmentsPromise ??= (async () => {
			try {
				...
				e > 0 && await Je(e), this.lastSegmentUpdateTime = performance.now(), await this.updateSegments();
			} finally {
	...
	async updateSegments() {
		...
		if (this.nextLines = null, !e) {
			...
			try {
				let n = Pa(t, await this.demuxer.input._getSourceUncached({
					path: this.rootPath,
					isRoot: !1
				}), !1), r = await new Us(n.source).requestEntireFile();
				a(r), e = oc(r, r.length, { ignore: ga }), n.source instanceof Ta && (this.rootPath = n.source.rootPath);
			} catch (e) {
		...
		for (let a = 0; a < e.length; a++) {
			...
			if (x.startsWith("#EXTINF:")) {
				...
				let e = x.slice(la.length), t = e.indexOf(","), n = t === -1 ? e : e.slice(0, t), i = Number(n);
				if (!Number.isFinite(i) || i < 0) throw Error(`Invalid #EXTINF tag duration '${n}'.`);
				o = i;
			} else if (x.startsWith("#EXT-X-MAP:")) {
				let e = new _a(x.slice(ua.length)), t = e.get("uri");
				...
				let e = new _a(x.slice(da.length)), t = e.get("method");
				if (t === "NONE") c = null;
				else if (t === "AES-128") {
					let t = e.get("uri");
					...
					if (r) {
						if (!Ia.test(r)) throw Error(`Unsupported IV format '${r}'.`);
						let e = r.slice(2);
					...
					let r = null;
					if (La.test(n)) {
						let e = n.indexOf(","), t = Re(n.slice(e + 1));
						if (t.length >= 8 && t[4] === 112 && t[5] === 115 && t[6] === 115 && t[7] === 104) {
							let e = p(t).getUint32(0);
							r = Zn(t.subarray(8, Math.min(e, t.length)));
						}
					}
					c = {
						method: t,
				...
				if (v) continue;
				let e = x.slice(ma.length), n = Date.parse(e);
				...
				let e = x.slice(ha.length), t = Number(e);
	...
	async getSegmentAt(e, t) {
		...
		for (;;) {
			let r = T(this.segments, e, (e) => e.timestamp);
			if (r === -1) return null;
	...
	getInputForSegment(e) {
		...
		let i = {
			...
			isobmff: {
				...
				resolveKeyId: this.input._formatOptions.isobmff?.resolveKeyId && ((e) => {
					...
					return (r.keyIds === null || r.keyIds.includes(e.keyId)) && !n.some((e) => Qn(e, r)) && (n = [...n, r]), this.input._formatOptions.isobmff.resolveKeyId({
						...e,
						psshBoxes: n
					});
				})
			...
			source: new Da(t.location.path, async (e) => {
				a(e.isRoot);
				let n = {
					...e,
					isRoot: !1
				...
				if (!t.encryption || t.encryption.method === "SAMPLE-AES" || t.encryption.method === "SAMPLE-AES-CTR") {
					...
					r = new Aa(hr(new Us(o.source), async () => {
						let t = {
							stack: [],
							error: void 0,
							hasError: !1
						...
						try {
							let n = await new Us(Pa(t, await this.input._getSourceCached({
								path: e.keyUri,
								isRoot: !1
			...
			formats: this.input._formats.filter((e) => !(e instanceof io)),
			initInput: r ?? void 0,
			formatOptions: i
		});
		if (o._onFormatDetermined = (e) => {
			...
			let e = Ge(this.inputCache, (e) => e.age);
	...
	readMetadata() {
		return this.metadataPromise ??= (async () => {
			a(this.input._rootSource instanceof Ta);
			let e = await this.input._reader.requestEntireFile();
			a(e);
			let t = oc(e, e.length, { ignore: ga }), { rootPath: n } = this.input._rootSource, r = [], i = [];
			for (let e = 1; e < t.length; e++) {
				...
				if (a.startsWith("#EXT-X-STREAM-INF:")) {
					...
					let s = Ue(n, o), c = new _a(a.slice(oa.length));
					...
					let t = new _a(a.slice(sa.length)), i = t.get("uri");
					...
					let t = new _a(a.slice(ca.length));
			...
			let o = [...new Set(i.filter((e) => e.attributes.get("type").toLowerCase() === "video").map((e) => e.attributes.get("group-id")))], s = [...new Set(i.filter((e) => e.attributes.get("type").toLowerCase() === "audio").map((e) => e.attributes.get("group-id")))], c = await Promise.all(r.map(async (e, t) => {
				...
				let u = e.attributes.get("video"), d = e.attributes.get("audio"), f = l.some((e) => st.includes(L(e))), p = l.some((e) => lt.includes(L(e)));
				if (u !== null && !f) {
					...
					outer: if (e) {
						...
						let r = Ue(n, t), i = (await this.getSegmentedInputForPath(r).getTrackBackings()).find((e) => e.getType() === "video");
				...
				if (d !== null && !p) {
					...
					outer: if (e) {
						let t = e.attributes.get("uri");
						if (t === null) break outer;
						let r = Ue(n, t), i = (await this.getSegmentedInputForPath(r).getTrackBackings()).find((e) => e.getType() === "audio");
						if (!i || await i.getCodec() === null) break outer;
						let o = await i.getDecoderConfig().then((e) => e?.codec ?? null);
						a(o !== null), l.push(o);
					}
							...
							if (a === null) {
								...
								for (let n of i) {
									...
									r.push({
										...
										demuxer: this,
										backingTrack: null,
										default: Ua(n.attributes),
										autoselect: Ua(n.attributes) || Wa(n.attributes),
										languageCode: Ga(n.attributes.get("language")),
			...
			for (let e of l) e.info.type === "video" ? this.trackBackings.push(new Va(e)) : this.trackBackings.push(new Ha(e));
	...
	getSegmentedInputForPath(e) {
		...
		return this.internalTracks && (n = this.internalTracks.filter((t) => t.fullPath === e).map((e) => ({
			id: e.id,
			type: e.info.type
		}))), t = new Ra(this, e, n, null), this.segmentedInputs.push(t), t;
	}
	async getMetadataTags() {
		return {};
	}
	...
	getCodec() {
		return L(this.internalTrack.fullCodecString);
	}
	getCodedWidth() {
...
}, Ga = (e) => e === null ? "und" : e.split("-")[0] || "und", Ka = class {
	constructor() {
		this._isIsobmff = !1;
	}
}, qa = class extends Ka {
	...
	async isSupportedEBMLOfDocType(e, t) {
		...
		if (n instanceof Promise && (n = await n), !n) return !1;
		let r = Gr(n);
		if (r === null || r < 1 || r > 8 || B(n, r) !== z.EBML) return !1;
		let i = Yr(n);
		...
		for (; a.filePos <= o + i - 2;) {
			...
			switch (n) {
				case z.EBMLVersion:
					if (B(a, r) !== 1) return !1;
					break;
				case z.EBMLReadVersion:
					if (B(a, r) !== 1) return !1;
					break;
				case z.DocType:
					if (Zr(a, r) !== t) return !1;
					break;
				case z.DocTypeVersion:
					if (B(a, r) > 4) return !1;
					break;
			}
			a.filePos = i + r;
	...
	async _canReadInput(e) {
		...
		let n = await mi(e._reader, t, t + 4096);
		if (!n) return !1;
		let r = n.header, i = Vt(r.mpegVersionId, r.channel), a = e._reader.requestSlice(n.startPos + i, 4);
		if (a instanceof Promise && (a = await a), !a) return !1;
		let o = W(a);
		if (o === 1483304551 || o === 1231971951) return !0;
		t = n.startPos + n.header.totalSize;
		let s = await mi(e._reader, t, t + 4);
		if (!s) return !1;
		let c = s.header;
	...
	async _canReadInput(e) {
		...
		if (!(e._rootSource instanceof Ta)) throw TypeError("HLS inputs require `InputOptions.source` to be a PathedSource or a ref to one.");
...
Ve();
var lo = -Infinity, uo = -Infinity, fo = null;
typeof FinalizationRegistry < "u" && (fo = new FinalizationRegistry((e) => {
	let t = performance.now();
	e.type === "video" ? (t - lo >= 1e3 && (i._error("A VideoSample was garbage collected without first being closed. For proper resource management, make sure to call close() on all your VideoSamples as soon as you're done using them."), lo = t), typeof VideoFrame < "u" && e.data instanceof VideoFrame && e.data.close()) : (t - uo >= 1e3 && (i._error("An AudioSample was garbage collected without first being closed. For proper resource management, make sure to call close() on all your AudioSamples as soon as you're done using them."), uo = t), typeof AudioData < "u" && e.data instanceof AudioData && e.data.close());
}));
var po = class {
	constructor() {
	...
	constructor(t, n) {
		if (this._closed = !1, t instanceof ArrayBuffer || typeof SharedArrayBuffer < "u" && t instanceof SharedArrayBuffer || ArrayBuffer.isView(t)) {
			...
			if (n.format === void 0 || !ho.has(n.format)) throw TypeError("init.format must be one of: " + mo.join(", "));
			...
			this._data = n._doNotCopy ? f(t) : f(t).slice(), this._layout = n.layout ?? Eo(n.format, n.codedWidth, n.codedHeight), this.format = n.format, this.rotation = n.rotation ?? 0, this.timestamp = n.timestamp, this.duration = n.duration ?? 0;
			...
			e === null && (e = this.format === "RGBA" || this.format === "RGBX" || this.format === "BGRA" || this.format === "BGRX" ? {
				...
				matrix: "bt709",
				fullRange: !1
			}), this.colorSpace = new xo(e), this.visibleRect = {
			...
			}, this.rotation = n?.rotation ?? 0, this.squarePixelWidth = t.displayWidth, this.squarePixelHeight = t.displayHeight, this.timestamp = n?.timestamp ?? t.timestamp / 1e6, this.duration = n?.duration ?? (t.duration ?? 0) / 1e6, this.colorSpace = new xo(t.colorSpace);
			...
			if (typeof VideoFrame < "u") return new e(new VideoFrame(t, {
				timestamp: Math.trunc(n.timestamp * Ce),
				duration: Math.trunc((n.duration ?? 0) * Ce) || void 0
			}), n);
			let r = 0, i = 0;
			...
			o.drawImage(t, 0, 0), this._data = a, this._layout = null, this.format = "RGBX", this.visibleRect = {
				...
				width: r,
				height: i
			}, this.squarePixelWidth = r, this.squarePixelHeight = i, this.rotation = n.rotation ?? 0, this.timestamp = n.timestamp, this.duration = n.duration ?? 0, this.colorSpace = new xo({
				matrix: "rgb",
				primaries: "bt709",
				transfer: "iec61966-2-1",
				fullRange: !0
			...
			if (!Number.isFinite(n.timestamp)) throw TypeError("init.timestamp must be a number.");
			if (n.duration !== void 0 && (!Number.isFinite(n.duration) || n.duration < 0)) throw TypeError("init.duration, when provided, must be a non-negative number.");
			if (this._data = t, t._referenceCount++, this.format = t.getFormat(), this.format !== null && !mo.includes(this.format)) throw TypeError("getFormat() must return a VideoSamplePixelFormat or null.");
			if (this.visibleRect = {
				left: 0,
				top: 0,
		...
		this.encodeOptions = n?.encodeOptions ?? {}, this.pixelAspectRatio = Ke({
	...
	clone() {
		...
		return a(this._data !== null), this._data instanceof po ? new e(this._data, {
			timestamp: this.timestamp,
			duration: this.duration,
			rotation: this.rotation,
			encodeOptions: this.encodeOptions
		}) : So(this._data) ? new e(this._data.clone(), {
			timestamp: this.timestamp,
			duration: this.duration,
			rotation: this.rotation,
			encodeOptions: this.encodeOptions
	...
	close() {
		this._closed ||= (fo?.unregister(this), this._data instanceof po ? (this._data._referenceCount--, this._data._referenceCount === 0 && this._data.close()) : So(this._data) ? this._data.close() : this._data = null, !0);
	}
	allocationSize(e = {}) {
		if (To(e), this._closed) throw Error("VideoSample is closed.");
		if ((e.format ?? this.format) == null) throw Error("Cannot get allocation size when format is null.");
		return So(this._data) ? this._data.allocationSize(e) : Oo(this, e).allocationSize;
	}
	async copyTo(t, n = {}) {
		if (!te(t)) throw TypeError("destination must be an ArrayBuffer or an ArrayBuffer view.");
		if (To(n), this._closed) throw Error("VideoSample is closed.");
		if ((n.format ?? this.format) == null) throw Error("Cannot copy video sample data when format is null.");
		if (a(this._data !== null), So(this._data)) return this._data.copyTo(t, n);
		if (n.format && ![
			"RGBA",
			"RGBX",
			"BGRA",
			...
			"BGRA",
			"BGRX"
		].includes(n.format)) if (this._data instanceof po) {
			let r = {
				stack: [],
				error: void 0,
				hasError: !1
			...
			try {
				let i = so(r, await this._data.toRgbSample({
					timestamp: this.timestamp,
					duration: this.duration,
					rotation: this.rotation
				}, n.colorSpace ?? "srgb"), !1);
		...
		let o = Do(this.format), s;
		if (this._data instanceof po) {
	...
	toVideoFrame() {
		if (this._closed) throw Error("VideoSample is closed.");
		if (a(this._data !== null), this._data instanceof po) {
		...
		} else if (So(this._data)) return new VideoFrame(this._data, {
			timestamp: this.microsecondTimestamp,
	...
	drawWithFit(e, t) {
		...
		t.crop !== void 0 && wo(t.crop, "options.");
	...
	toCanvasImageSource() {
		if (this._closed) throw Error("VideoSample is closed.");
		if (a(this._data !== null), this._data instanceof po || this._data instanceof Uint8Array) {
	...
	async transform(t) {
		...
		if (t.crop !== void 0 && wo(t.crop, "options."), t.alpha !== void 0 && !["keep", "discard"].includes(t.alpha)) throw TypeError("options.alpha, when provided, must be 'keep' or 'discard'.");
		...
		t.width !== void 0 && t.height === void 0 ? (u = t.width, d = u / l) : t.width === void 0 && t.height !== void 0 ? (d = t.height, u = d * l) : t.width !== void 0 && t.height !== void 0 ? (u = t.width, d = t.height) : (u = s, d = c), u = ge(u, t.roundDimensionsTo ?? 1), d = ge(d, t.roundDimensionsTo ?? 1);
		let f = {
			width: u,
			height: d,
			fit: t.fit ?? "fill",
		...
		let p = null, m = !1;
		for (let e of yo) if (e.canvas.width === f.width && e.canvas.height === f.height) {
			p = e.canvas, e.age = bo++;
			break;
		}
		if (p === null) {
			...
			m = !0, yo.length >= vo && yo.splice(Ge(yo, (e) => e.age), 1), yo.push({
				canvas: p,
				age: bo++
			});
		}
...
}, So = (e) => typeof VideoFrame < "u" && e instanceof VideoFrame, Co = (e, t, n) => {
	...
	}, r = t.rect, i = ko(n, r, e.codedWidth, e.codedHeight, e.format), a = t.layout, o;
	...
	if (!Ao(i, a)) throw TypeError("visibleRect alignment is invalid for the format.");
	return a;
}, Ao = (e, t) => {
	if (e === null) return !0;
	let n = Do(e);
	...
	constructor(e) {
		if (this._closed = !1, zo(e)) {
			...
			if (this._data = e, e._referenceCount++, this.format = e.getFormat(), !Mo.has(this.format)) throw TypeError("getFormat() must return an AudioSampleFormat.");
			...
			if (!Mo.has(e.format)) throw TypeError("Invalid AudioDataInit: invalid format.");
			...
			let t = e.data.byteLength / (Fo(e.format) * e.numberOfChannels);
			...
			let r = this.numberOfFrames * this.numberOfChannels * Fo(this.format);
	...
	allocationSize(e) {
		...
		if (e.format !== void 0 && !Mo.has(e.format)) throw TypeError("Invalid format.");
	...
	copyTo(e, t) {
		if (!te(e)) throw TypeError("destination must be an ArrayBuffer or an ArrayBuffer view.");
		if (!t || typeof t != "object") throw TypeError("options must be an object.");
		if (!Number.isInteger(t.planeIndex) || t.planeIndex < 0) throw TypeError("planeIndex must be a non-negative integer.");
		if (t.format !== void 0 && !Mo.has(t.format)) throw TypeError("Invalid format.");
		...
		let g = p(e), _ = Ro(s);
		if (zo(this._data)) De() && l > 2 && s !== o ? Vo(this._data, g, o, s, l, a, u, d) : this._data.copyTo(e, {
			planeIndex: a,
			frameOffset: u,
			frameCount: d,
			format: s
			...
			let e = Lo(o), t = Fo(o), n = Io(o), r;
			if (this._data instanceof No) {
				let e = (e) => {
	...
	close() {
		this._closed ||= (fo?.unregister(this), this._data instanceof No ? (this._data._referenceCount--, this._data._referenceCount === 0 && this._data.close()) : zo(this._data) ? this._data.close() : this._data = /* @__PURE__ */ new Uint8Array(), !0);
	}
	toAudioData() {
		if (this._closed) throw Error("AudioSample is closed.");
		return this._data instanceof No ? this._createAudioDataFromData() : zo(this._data) ? this._data.timestamp === this.microsecondTimestamp ? this._data.clone() : this._createAudioDataFromData() : new AudioData({
			format: this.format,
			sampleRate: this.sampleRate,
			numberOfFrames: this.numberOfFrames,
			numberOfChannels: this.numberOfChannels,
	...
	switch (e) {
		case "u8":
		case "u8-planar": return (e, t, n) => e.setUint8(t, A((n + 1) * 127.5, 0, 255));
		case "s16":
		case "s16-planar": return (e, t, n) => e.setInt16(t, A(Math.round(n * 32767), -32768, 32767), !0);
		case "s32":
		case "s32-planar": return (e, t, n) => e.setInt32(t, A(Math.round(n * 2147483647), -2147483648, 2147483647), !0);
		case "f32":
		case "f32-planar": return (e, t, n) => e.setFloat32(t, n, !0);
	}
}, zo = (e) => typeof AudioData < "u" && e instanceof AudioData, Bo = (e) => {
	switch (e) {
	...
	let c = Lo(n), l = Ro(r), u = Fo(n), d = Fo(r), f = Io(n);
	if (Io(r)) if (f) {
...
}, Uo = /* @__PURE__ */ new Map(), Wo = /* @__PURE__ */ new Map(), Go = (e) => {
	if (!e || typeof e != "object") throw TypeError("Encoding config must be an object.");
	if (!st.includes(e.codec)) throw TypeError(`Invalid video codec '${e.codec}'. Must be one of: ${st.join(", ")}.`);
	if (!(e.bitrate instanceof Zo) && (!Number.isInteger(e.bitrate) || e.bitrate <= 0)) throw TypeError("config.bitrate must be a positive integer or a quality.");
	...
	if (e.transform !== void 0) {
		...
		if (e.transform.crop !== void 0 && wo(e.transform.crop, "config.transform."), e.transform.process !== void 0 && typeof e.transform.process != "function") throw TypeError("config.transform.process, when provided, must be a function.");
	...
	if (t.fullCodecString !== void 0 && L(t.fullCodecString) !== e) throw TypeError(`fullCodecString, when provided, must be a string that matches the specified codec (${e}).`);
	...
	let t = e.bitrate instanceof Zo ? e.bitrate._toVideoBitrate(e.codec, e.width, e.height) : e.bitrate;
	return {
		codec: e.fullCodecString ?? gt(e.codec, e.width, e.height, t),
		width: e.width,
		height: e.height,
	...
	if (!e || typeof e != "object") throw TypeError("Encoding config must be an object.");
	if (!lt.includes(e.codec)) throw TypeError(`Invalid audio codec '${e.codec}'. Must be one of: ${lt.join(", ")}.`);
	if (e.bitrate === void 0 && !(F.includes(e.codec) || e.codec === "flac")) throw TypeError("config.bitrate must be provided for compressed audio codecs.");
	if (e.bitrate !== void 0 && !(e.bitrate instanceof Zo) && (!Number.isInteger(e.bitrate) || e.bitrate <= 0)) throw TypeError("config.bitrate, when provided, must be a positive integer or a quality.");
	if (e.transform !== void 0) {
		if (typeof e.transform != "object" || !e.transform) throw TypeError("config.transform, when provided, must be an object.");
	...
	let t = e.bitrate instanceof Zo ? e.bitrate._toAudioBitrate(e.codec) : e.bitrate;
	return {
		codec: e.fullCodecString ?? bt(e.codec, e.numberOfChannels, e.sampleRate),
		numberOfChannels: e.numberOfChannels,
		sampleRate: e.sampleRate,
		bitrate: t,
		bitrateMode: e.bitrateMode,
...
}, Qo = /* #__PURE__ */ new Zo(.3), $o = /* #__PURE__ */ new Zo(.6), es = /* #__PURE__ */ new Zo(1), ts = /* #__PURE__ */ new Zo(2), ns = /* #__PURE__ */ new Zo(4), rs = async (e, t = {}) => {
	let { width: n = 1280, height: r = 720, bitrate: i = 1e6, ...a } = t;
	if (!st.includes(e)) return !1;
	...
	if (!(i instanceof Zo) && (!Number.isInteger(i) || i <= 0)) throw TypeError("bitrate must be a positive integer or a quality.");
	Ko(e, a);
	let o = qo({
		codec: e,
		width: n,
	...
	if (c) return c;
	let l = (async () => ls.some((t) => t.supports(e, o)) ? !0 : typeof VideoEncoder > "u" || (n % 2 == 1 || r % 2 == 1) && (e === "avc" || e === "hevc") || !(await VideoEncoder.isConfigSupported(o)).supported ? !1 : ke() ? new Promise(async (e) => {
		try {
	...
	if (!(i instanceof Zo) && (!Number.isInteger(i) || i <= 0)) throw TypeError("bitrate must be a positive integer.");
	Yo(e, a);
	let o = Xo({
		codec: e,
		numberOfChannels: n,
		...
		bitrate: i,
		...a
	}), s = JSON.stringify(o), c = Wo.get(s);
	if (c) return c;
	let l = (async () => us.some((t) => t.supports(e, o)) || F.includes(e) ? !0 : typeof AudioEncoder > "u" ? !1 : (await AudioEncoder.isConfigSupported(o)).supported === !0)();
	return Wo.set(s, l), l;
}, as = async (e = lt, t) => {
	let n = await Promise.all(e.map((e) => is(e, t)));
	return e.filter((e, t) => n[t]);
}, os = async (e, t) => {
	for (let n of e) if (await rs(n, t)) return n;
	return null;
}, ss = [], cs = [], ls = [], us = [], ds = (e) => {
	...
	if (!He(e)) throw TypeError("timestamp must be a number.");
}, _s = (e, t, n) => n.verifyKeyPackets ? t.then(async (t) => {
	if (!t || t.type === "delta") return t;
	let n = await e.determinePacketType(t);
	return n && (t.type = n), t;
}) : t, vs = class {
	constructor(e) {
		if (!(e instanceof js)) throw TypeError("track must be an InputTrack.");
		this._track = e;
	}
	async getFirstPacket(e = {}) {
		if (hs(e), this._track.input._disposed) throw new Hs();
		return _s(this._track, this._track._backing.getFirstPacket(e), e);
	}
	...
	async getPacket(e, t = {}) {
		if (gs(e), hs(t), this._track.input._disposed) throw new Hs();
		return _s(this._track, this._track._backing.getPacket(e, t), t);
	}
	async getNextPacket(e, t = {}) {
		if (!(e instanceof R)) throw TypeError("packet must be an EncodedPacket.");
		if (hs(t), this._track.input._disposed) throw new Hs();
		return _s(this._track, this._track._backing.getNextPacket(e, t), t);
	}
	async getKeyPacket(e, t = {}) {
		if (gs(e), hs(t), this._track.input._disposed) throw new Hs();
	...
	packets(e, t, n = {}) {
		if (e !== void 0 && !(e instanceof R)) throw TypeError("startPacket must be an EncodedPacket.");
		...
		if (t !== void 0 && !(t instanceof R)) throw TypeError("endPacket must be an EncodedPacket.");
		if (hs(n), this._track.input._disposed) throw new Hs();
		let r = [], { promise: i, resolve: a } = E(), { promise: o, resolve: s } = E(), c = !1, l = !1, u = null, d = [], f = () => Math.max(2, d.length);
		(async () => {
			let u = e ?? await this.getFirstPacket(n);
			for (; u && !l && !this._track.input._disposed && !(t && u.sequenceNumber >= t?.sequenceNumber);) {
				if (r.length > f()) {
					({promise: o, resolve: s} = E()), await o;
					continue;
				}
				r.push(u), a(), {promise: i, resolve: a} = E(), u = await this.getNextPacket(u, n);
			}
			c = !0, a();
		})().catch((e) => {
			u || (u = e, a());
		...
		return {
			async next() {
				for (;;) if (p.input._disposed) throw new Hs();
				else if (l) return {
					value: void 0,
					done: !0
				};
	...
	mediaSamplesInRange(e = -Infinity, t = Infinity, n) {
		gs(e), gs(t);
		let r = [], i = !1, a = null, { promise: o, resolve: s } = E(), { promise: c, resolve: l } = E(), u = !1, d = !1, f = !1, p = null, m = {
			...n,
			verifyKeyPackets: !0,
			metadataOnly: !1
		};
		(async () => {
			let n = await this._createDecoder((n) => {
				...
				a && (n.timestamp > e ? (r.push(a), i = !0) : a.close()), n.timestamp >= e && (r.push(n), i = !0), a = i ? null : n, r.length > 0 && (s(), {promise: o, resolve: s} = E());
			}, (e) => {
				p || (p = e, s());
		...
		return {
			async next() {
				for (;;) if (h.input._disposed) throw g(), new Hs();
				else if (f) return {
					value: void 0,
					done: !0
				};
	...
	mediaSamplesAtTimestamps(e, t) {
		D(e);
		let n = de(e), r = [], i = [], { promise: o, resolve: s } = E(), { promise: c, resolve: l } = E(), u = !1, d = !1, f = null, p = (e) => {
			i.push(e), s(), {promise: o, resolve: s} = E();
		}, m = {
			...t,
			verifyKeyPackets: !0,
			metadataOnly: !1
		...
		(async () => {
			let e = await this._createDecoder((e) => {
				...
				for (e.decode(n); n.sequenceNumber < g;) {
					let r = xs(i.length);
					for (; i.length + e.getDecodeQueueSize() > r && !d;) ({promise: c, resolve: l} = E()), await c;
					if (d) break;
			...
			for await (let e of n) {
				if (gs(e), d || this._track.input._disposed) break;
...
}, xs = (e) => e === 0 ? 40 : 8, Ss = class extends ys {
	constructor(e, t, n, r, i, o) {
		super(e, t), this.codec = n, this.decoderConfig = r, this.rotation = i, this.timeResolution = o, this.decoder = null, this.customDecoder = null, this.customDecoderCallSerializer = new Te(), this.customDecoderQueueSize = 0, this.inputTimestamps = [], this.sampleQueue = [], this.currentPacketIndex = 0, this.raslSkipped = !1, this.alphaDecoder = null, this.alphaHadKeyframe = !1, this.colorQueue = [], this.alphaQueue = [], this.merger = null, this.decodedAlphaChunkCount = 0, this.alphaDecoderQueueSize = 0, this.nullAlphaFrameQueue = [], this.currentAlphaPacketIndex = 0, this.alphaRaslSkipped = !1, this.frameHandlerSerializer = new Te();
		let s = ss.find((e) => e.supports(n, r));
		if (s) this.customDecoder = new s(), this.customDecoder.codec = n, this.customDecoder.config = r, this.customDecoder.onSample = (e) => {
			if (!(e instanceof go)) throw TypeError("The argument passed to onSample must be a VideoSample.");
			...
			if (n === "avc" && this.decoderConfig.description && je()) {
				let e = ln(f(this.decoderConfig.description));
				if (e && e.sequenceParameterSets.length > 0) {
					let t = dn(e.sequenceParameterSets[0]);
	...
	decode(e) {
		...
		if (this.customDecoder) this.customDecoderQueueSize++, this.customDecoderCallSerializer.call(() => this.customDecoder.decode(e)).then(() => this.customDecoderQueueSize--);
			...
			if (a(this.decoder), De() || se(this.inputTimestamps, e.timestamp, (e) => e), je() && this.currentPacketIndex === 0) {
				if (this.codec === "avc") {
					let t = [];
					for (let n of $t(e.data, this.decoderConfig)) {
						let r = en(e.data[n.offset]);
						r === Yt.AUD && (t.length = 0), r >= 20 && r <= 31 || t.push(e.data.subarray(n.offset, n.offset + n.length));
					}
					e = new R(on(t, this.decoderConfig), e.type, e.timestamp, e.duration);
				} else if (this.codec === "hevc") {
					let t = Dn(e.data, this.decoderConfig);
					t && (e = new R(t, e.type, e.timestamp, e.duration));
				}
			}
	...
	decodeAlphaData(e) {
		...
		if (this.merger ||= new ws(), !this.alphaDecoder) {
			let e = (e) => {
				this.frameHandlerSerializer.call(async () => {
		...
		let t = Fn(this.codec, this.decoderConfig, e.sideData.alpha);
	...
	hasHevcRaslPicture(e) {
		for (let t of mn(e, this.decoderConfig)) {
			let n = hn(e[t.offset]);
			if (n === Xt.RASL_N || n === Xt.RASL_R) return !0;
		}
		return !1;
	}
	sampleHandler(e) {
		if (De()) {
			...
			se(this.sampleQueue, e, (e) => e.timestamp);
		} else {
	...
	constructor() {
		...
		if (!e.forceCpu && t && !Cs) try {
			...
			this.gl = null, this.canvas = null, Cs = !0, i._warn("Falling back to CPU for color/alpha merging.", e);
		}
	}
	async update(e, t) {
	...
	updateCpu(e, t) {
		if (!this.worker) {
			let e = new Blob([`(${Ts.toString()})()`], { type: "application/javascript" }), t = URL.createObjectURL(e);
...
var Ts = () => {
	...
	constructor(e, t = {}) {
		if (!(e instanceof Ns)) throw TypeError("videoTrack must be an InputVideoTrack.");
		Es(t), super(), this._track = e, this._decoderOptions = t;
	}
	...
	constructor(e, t, n, r) {
		super(e, t), this.decoder = null, this.customDecoder = null, this.customDecoderCallSerializer = new Te(), this.customDecoderQueueSize = 0, this.currentTimestamp = null, this.expectedFirstTimestamp = null, this.timestampOffset = 0;
		let i = (t) => {
			let n = t.timestamp;
		...
		}, a = cs.find((e) => e.supports(n, r));
		if (a) this.customDecoder = new a(), this.customDecoder.codec = n, this.customDecoder.config = r, this.customDecoder.onSample = (e) => {
			if (!(e instanceof Po)) throw TypeError("The argument passed to onSample must be an AudioSample.");
			i(e);
		}, this.customDecoderCallSerializer.call(() => this.customDecoder.init());
		else {
	...
	constructor(e, t, n) {
		super(e, t), this.decoderConfig = n, this.currentTimestamp = null, a(F.includes(n.codec)), this.codec = n.codec;
		let { dataType: r, sampleSize: i, littleEndian: o } = wt(this.codec);
		switch (this.inputSampleSize = i, i) {
			case 1:
				r === "unsigned" ? this.readInputValue = (e, t) => e.getUint8(t) - 2 ** 7 : r === "signed" ? this.readInputValue = (e, t) => e.getInt8(t) : r === "ulaw" ? this.readInputValue = (e, t) => fs(e.getUint8(t)) : r === "alaw" ? this.readInputValue = (e, t) => ms(e.getUint8(t)) : a(!1);
				break;
			case 2:
				r === "unsigned" ? this.readInputValue = (e, t) => e.getUint16(t, o) - 2 ** 15 : r === "signed" ? this.readInputValue = (e, t) => e.getInt16(t, o) : a(!1);
				break;
			case 3:
				r === "unsigned" ? this.readInputValue = (e, t) => fe(e, t, o) - 2 ** 23 : r === "signed" ? this.readInputValue = (e, t) => pe(e, t, o) : a(!1);
				break;
			case 4:
	...
	constructor(e) {
		if (!(e instanceof Ps)) throw TypeError("audioTrack must be an InputAudioTrack.");
		super(), this._track = e;
	}
	async _createDecoder(e, t) {
		...
		return a(n && r), F.includes(r.codec) ? new ks(e, t, r) : new Os(e, t, n, r);
	}
	_createPacketSink() {
		return new vs(this._track);
	}
	...
	get internalCodecId() {
		return V(this._backing.getInternalCodecId(), "internalCodecId", "getInternalCodecId");
	}
	async getLanguageCode() {
		return this._backing.getLanguageCode();
	}
	get languageCode() {
		return V(this._backing.getLanguageCode(), "languageCode", "getLanguageCode");
	}
	async getName() {
		return this._backing.getName();
	}
	get name() {
		return V(this._backing.getName(), "name", "getName");
	}
	async getTimeResolution() {
		return this._backing.getTimeResolution();
	}
	get timeResolution() {
		return V(this._backing.getTimeResolution(), "timeResolution", "getTimeResolution");
	}
	async isRelativeToUnixEpoch() {
	...
	get disposition() {
		return V(this._backing.getDisposition(), "disposition", "getDisposition");
	}
	async getBitrate() {
	...
	async computeDuration(e) {
		...
		return _e((t?.timestamp ?? 0) + (t?.duration ?? 0), await this.getTimeResolution());
	}
	async getDurationFromMetadata(e = {}) {
	...
	async getPairableTracks(e) {
		return this.input.getTracks(Rs({ filter: (e) => e.canBePairedWith(this) }, e));
	}
	async getPairableVideoTracks(e) {
		return this.input.getVideoTracks(Rs({ filter: (e) => e.canBePairedWith(this) }, e));
	}
	async getPairableAudioTracks(e) {
		return this.input.getAudioTracks(Rs({ filter: (e) => e.canBePairedWith(this) }, e));
	}
	async getPrimaryPairableVideoTrack(e) {
		return this.input.getPrimaryVideoTrack(Rs({ filter: (e) => e.canBePairedWith(this) }, e));
	}
	async getPrimaryPairableAudioTrack(e) {
		return this.input.getPrimaryAudioTrack(Rs({ filter: (e) => e.canBePairedWith(this) }, e));
	}
	...
	hasPairableVideoTrack(e) {
		return e &&= Ms(e), this.hasPairableTrack(async (t) => t.isVideoTrack() && (!e || await e(t)));
	}
	hasPairableAudioTrack(e) {
		return e &&= Ms(e), this.hasPairableTrack(async (t) => t.isAudioTrack() && (!e || await e(t)));
	}
}, V = (e, t, n) => {
	...
	get codec() {
		return V(this._backing.getCodec(), "codec", "getCodec");
	}
	...
	get codedWidth() {
		return V(this._backing.getCodedWidth(), "codedWidth", "getCodedWidth");
	}
	async getCodedHeight() {
		return this._backing.getCodedHeight();
	}
	get codedHeight() {
		return V(this._backing.getCodedHeight(), "codedHeight", "getCodedHeight");
	}
	async getRotation() {
		return this._backing.getRotation();
	}
	get rotation() {
		return V(this._backing.getRotation(), "rotation", "getRotation");
	}
	async getSquarePixelWidth() {
		return this._backing.getSquarePixelWidth();
	}
	get squarePixelWidth() {
		return V(this._backing.getSquarePixelWidth(), "squarePixelWidth", "getSquarePixelWidth");
	}
	async getSquarePixelHeight() {
		return this._backing.getSquarePixelHeight();
	}
	get squarePixelHeight() {
		return V(this._backing.getSquarePixelHeight(), "squarePixelHeight", "getSquarePixelHeight");
	}
	async getPixelAspectRatio() {
		return this._pixelAspectRatioCache ??= Ke({
	...
	get pixelAspectRatio() {
		return this._pixelAspectRatioCache ??= Ke({
			num: V(this._backing.getSquarePixelWidth(), "pixelAspectRatio", "getPixelAspectRatio") * V(this._backing.getCodedHeight(), "pixelAspectRatio", "getPixelAspectRatio"),
			den: V(this._backing.getSquarePixelHeight(), "pixelAspectRatio", "getPixelAspectRatio") * V(this._backing.getCodedWidth(), "pixelAspectRatio", "getPixelAspectRatio")
		});
	}
	...
	get displayWidth() {
		...
		if (e !== void 0) {
			let t = V(e, "displayWidth", "getDisplayWidth");
			if (t !== null) return t;
		}
		return V(V(this._backing.getRotation(), "displayWidth", "getDisplayWidth") % 180 == 0 ? this._backing.getSquarePixelWidth() : this._backing.getSquarePixelHeight(), "displayWidth", "getDisplayWidth");
	}
	...
	get displayHeight() {
		...
		if (e !== void 0) {
			let t = V(e, "displayHeight", "getDisplayHeight");
			if (t !== null) return t;
		}
		return V(V(this._backing.getRotation(), "displayHeight", "getDisplayHeight") % 180 == 0 ? this._backing.getSquarePixelHeight() : this._backing.getSquarePixelWidth(), "displayHeight", "getDisplayHeight");
	}
	async getColorSpace() {
	...
	async canDecode() {
		try {
			...
			return a(t !== null), ss.some((n) => n.supports(t, e)) ? !0 : typeof VideoDecoder > "u" ? !1 : (await VideoDecoder.isConfigSupported(e)).supported === !0;
		} catch (e) {
	...
	get numberOfChannels() {
		return V(this._backing.getNumberOfChannels(), "numberOfChannels", "getNumberOfChannels");
	}
	async getSampleRate() {
		return this._backing.getSampleRate();
	}
	get sampleRate() {
		return V(this._backing.getSampleRate(), "sampleRate", "getSampleRate");
	}
	async getDecoderConfig() {
		return this._backing.getDecoderConfig();
	}
	...
	async canDecode() {
		try {
			...
			if (!e) return !1;
			let t = await this._backing.getCodec();
			return a(t !== null), cs.some((n) => n.supports(t, e)) || e.codec.startsWith("pcm-") ? !0 : typeof AudioDecoder > "u" ? !1 : (await AudioDecoder.isConfigSupported(e)).supported === !0;
		} catch (e) {
			return i._error("Error during decodability check:", e), !1;
		}
	}
...
var Bs = class e extends Xe {
	...
	constructor(t) {
		...
		if (!Array.isArray(t.formats) || t.formats.some((e) => !(e instanceof Ka))) throw TypeError("options.formats must be an array of InputFormat.");
		if (!(t.source instanceof Ca || t.source instanceof wa)) throw TypeError("options.source must be a Source or SourceRef.");
		if (t.source instanceof Ca && t.source._disposed) throw TypeError("options.source must not be a disposed Source.");
		if (t.initInput !== void 0 && !(t.initInput instanceof e)) throw TypeError("options.initInput, when provided, must be an Input.");
		t.formatOptions !== void 0 && oo(t.formatOptions, "formatOptions"), this._formats = t.formats, this._initInput = t.initInput ?? null, this._formatOptions = t.formatOptions ?? {}, t.source instanceof Ca ? this._rootRef = t.source.ref() : this._rootRef = t.source, this._sourceRefs.push(this._rootRef);
	}
	get _rootSource() {
		return this._rootRef.source;
	}
	async _getSourceUncached(e) {
		a(this._rootSource instanceof Ta);
	...
	_getSourceCached(e, t = 1) {
		let n = this._sourceCache.find((n) => n.cacheGroup === t && Ea(n.request, e));
		if (n) return n.age++, Promise.resolve(n.sourceRef.source.ref());
		let r = this._sourceCachePromises.find((n) => n.cacheGroup === t && Ea(n.request, e));
		if (r) return r.promise.then((e) => e.sourceRef.source.ref());
		let i = (async () => {
			let n = await this._getSourceUncached(e);
			if (We(this._sourceCache, (e) => e.cacheGroup === t && e.sourceRef.source._refCount === 1) >= 4) {
				let e = Ge(this._sourceCache, (e) => e.cacheGroup === t && e.sourceRef.source._refCount === 1 ? e.age : Infinity);
				a(e !== -1);
				let n = this._sourceCache[e];
				this._sourceCache.splice(e, 1), n.sourceRef.free(), ce(this._sourceRefs, n.sourceRef);
			}
	...
	_getDemuxer() {
		return this._demuxerPromise ??= (async () => {
			this._reader = new Us(this._rootSource), this._emit("source", {
	...
	async getTracks(e) {
		return e &&= Ls(e), zs((await this._getTrackBackings()).map((e) => this._wrapBackingAsTrack(e)), e);
	}
	async getVideoTracks(e) {
		return e &&= Ls(e), zs((await this.getTracks()).filter((e) => e.isVideoTrack()), e);
	}
	async getAudioTracks(e) {
		return e &&= Ls(e), zs((await this.getTracks()).filter((e) => e.isAudioTrack()), e);
	}
	async getPrimaryVideoTrack(e) {
		e &&= Ls(e);
		let t = Rs(e, { sortBy: async (e) => [
			Is((await e.getDisposition()).default),
			Is(await e.hasPairableAudioTrack()),
			Is(!await e.hasOnlyKeyPackets()),
			Fs(await e.getBitrate())
		] });
		return (await this.getVideoTracks(t))[0] ?? null;
	}
	async getPrimaryAudioTrack(e) {
		e &&= Ls(e);
		let t = await this.getPrimaryVideoTrack(), n = Rs(e, { sortBy: async (e) => [
			Is(!t || e.canBePairedWith(t)),
			Is((await e.getDisposition()).default),
			Fs(await e.getBitrate())
		] });
	...
	_wrapBackingAsTrack(e) {
		...
		if (t) return t;
		let n = e.getType() === "video" ? new Ns(this, e) : new Ps(this, e);
	...
	requestSlice(e, t) {
		if (this.source._disposed) throw new Hs();
		if (e < 0 || this.fileSizeNonStrict !== null && e + t > this.fileSizeNonStrict) return null;
		if (t === 0) {
			let t = /* @__PURE__ */ new Uint8Array();
			return new Ws(t, p(t), 0, e, e);
		}
		let n = e + t, r = this.source._read(e, n, 0, Sa);
		return r instanceof Promise ? r.then((t) => t ? new Ws(t.bytes, t.view, t.offset, e, n) : null) : r ? new Ws(r.bytes, r.view, r.offset, e, n) : null;
	}
	requestSliceRange(e, t, n) {
		if (this.source._disposed) throw new Hs();
		if (e < 0) return null;
		if (this.fileSizeNonStrict !== null) return this.requestSlice(e, A(this.fileSizeNonStrict - e, t, n));
		{
			let r = this.requestSlice(e, n), i = (r) => r || (a(this.fileSizeNonStrict !== null), this.requestSlice(e, A(this.fileSizeNonStrict - e, t, n)));
			return r instanceof Promise ? r.then(i) : i(r);
		}
	}
	requestEntireFile() {
...
}, U = (e) => (Gs(e, 1), e.view.getUint8(e.bufferPos++)), Ks = (e, t) => {
	Gs(e, 2);
	...
	let n, r;
	return t ? (n = Xs(e, !0), r = Xs(e, !0)) : (r = Xs(e, !1), n = Xs(e, !1)), r * 4294967296 + n;
}, tc = (e) => {
	let t = W(e), n = W(e);
	...
	return n;
}, oc = (e, t, n) => m.decode(H(e, t)).split("\n").map((e) => e.trim()).filter((e) => e.length > 0 && !n?.ignore?.(e)), sc;
(function(e) {
...
var lc = /* @__PURE__ */ "Blues.Classic rock.Country.Dance.Disco.Funk.Grunge.Hip-hop.Jazz.Metal.New age.Oldies.Other.Pop.Rhythm and blues.Rap.Reggae.Rock.Techno.Industrial.Alternative.Ska.Death metal.Pranks.Soundtrack.Euro-techno.Ambient.Trip-hop.Vocal.Jazz & funk.Fusion.Trance.Classical.Instrumental.Acid.House.Game.Sound clip.Gospel.Noise.Alternative rock.Bass.Soul.Punk.Space.Meditative.Instrumental pop.Instrumental rock.Ethnic.Gothic.Darkwave.Techno-industrial.Electronic.Pop-folk.Eurodance.Dream.Southern rock.Comedy.Cult.Gangsta.Top 40.Christian rap.Pop/funk.Jungle music.Native US.Cabaret.New wave.Psychedelic.Rave.Showtunes.Trailer.Lo-fi.Tribal.Acid punk.Acid jazz.Polka.Retro.Musical.Rock 'n' roll.Hard rock.Folk.Folk rock.National folk.Swing.Fast fusion.Bebop.Latin.Revival.Celtic.Bluegrass.Avantgarde.Gothic rock.Progressive rock.Psychedelic rock.Symphonic rock.Slow rock.Big band.Chorus.Easy listening.Acoustic.Humour.Speech.Chanson.Opera.Chamber music.Sonata.Symphony.Booty bass.Primus.Porn groove.Satire.Slow jam.Club.Tango.Samba.Folklore.Ballad.Power ballad.Rhythmic Soul.Freestyle.Duet.Punk rock.Drum solo.A cappella.Euro-house.Dance hall.Goa music.Drum & bass.Club-house.Hardcore techno.Terror.Indie.Britpop.Negerpunk.Polsk punk.Beat.Christian gangsta rap.Heavy metal.Black metal.Crossover.Contemporary Christian.Christian rock.Merengue.Salsa.Thrash metal.Anime.Jpop.Synthpop.Christmas.Art rock.Baroque.Bhangra.Big beat.Breakbeat.Chillout.Downtempo.Dub.EBM.Eclectic.Electro.Electroclash.Emo.Experimental.Garage.Global.IDM.Illbient.Industro-Goth.Jam Band.Krautrock.Leftfield.Lounge.Math rock.New romantic.Nu-breakz.Post-punk.Post-rock.Psytrance.Shoegaze.Space rock.Trop rock.World music.Neoclassical.Audiobook.Audio theatre.Neue Deutsche Welle.Podcast.Indie rock.G-Funk.Dubstep.Garage rock.Psybient".split("."), uc = (e, t) => {
	...
	let a = dc(e, 30);
	a && (t.album ??= a);
	let o = dc(e, 4), s = Number.parseInt(o, 10);
	Number.isInteger(s) && s > 0 && (t.date ??= new Date(String(s)));
	let c = H(e, 30), l;
	if (c[28] === 0 && c[29] !== 0) {
		let n = c[29];
		n > 0 && (t.trackNumber ??= n), e.skip(-30), l = dc(e, 28), e.skip(2);
	} else e.skip(-30), l = dc(e, 30);
	l && (t.comment ??= l);
	let u = U(e);
	u < lc.length && (t.genre ??= lc[u]);
}, dc = (e, t) => {
	let n = H(e, t), r = Pe(n.indexOf(0), n.length), i = n.subarray(0, r), a = "";
	for (let e = 0; e < i.length; e++) a += String.fromCharCode(i[e]);
	return a.trimEnd();
}, fc = (e) => {
	let t = e.filePos, n = G(e, 3), r = U(e), i = U(e), a = U(e), o = W(e);
	if (n !== "ID3" || r === 255 || i === 255 || o & 2155905152) return e.filePos = t, null;
	let s = Wt(o);
	return a & sc.Footer && (s += 10), {
		majorVersion: r,
		revision: i,
		flags: a,
		size: s
	...
	let r = new mc(t, H(e, t.flags & sc.Footer ? t.size - 10 : t.size));
	if (t.flags & sc.Unsynchronisation && t.majorVersion === 3 && r.ununsynchronizeAll(), t.flags & sc.ExtendedHeader) {
		let e = r.readU32();
	...
	for (; r.pos <= r.bytes.length - r.frameHeaderSize();) {
		...
		if (t.majorVersion === 3 ? (s = !!(e.flags & 64), c = !!(e.flags & 128)) : t.majorVersion === 4 && (s = !!(e.flags & 4), c = !!(e.flags & 8), l = !!(e.flags & 2) || !!(t.flags & sc.Unsynchronisation)), s) {
	...
	readId3V2Frame() {
		if (this.header.majorVersion === 2) {
			...
			let t = this.readU32(), n = this.header.majorVersion === 4 ? Wt(t) : t, r = this.readU16(), i = this.pos, a = (e) => {
				let t = this.pos + e;
			...
			if (!a(n)) {
				let e = this.header.majorVersion === 4 ? t : Wt(t);
				a(e) && (n = e);
			}
			return this.pos = i, {
				id: e,
	...
	readId3V2Text(e, t) {
		...
		switch (e) {
			...
			case cc.UTF_16_WITH_BOM: if (r[0] === 255 && r[1] === 254) {
				...
				let e = new TextDecoder("utf-16be"), t = Pe(r.findIndex((e, t) => e === 0 && r[t + 1] === 0 && t % 2 == 0), r.length);
				return this.pos = n + Math.min(t + 2, r.length), e.decode(r.subarray(2, t));
			} else {
				let e = Pe(r.findIndex((e) => e === 0), r.length);
				return this.pos = n + Math.min(e + 1, r.length), m.decode(r.subarray(0, e));
			}
			case cc.UTF_16_BE_NO_BOM: {
				let e = new TextDecoder("utf-16be"), t = Pe(r.findIndex((e, t) => e === 0 && r[t + 1] === 0 && t % 2 == 0), r.length);
	...
	writeId3V2Tag(e) {
		...
		for (let { key: t, value: n } of Ie(e)) switch (t) {
			case "title":
		...
		if (e.raw) for (let t in e.raw) {
			...
			if (typeof n == "string") if (g(n)) {
				i = new Uint8Array(n.length + 2), i[0] = cc.ISO_8859_1;
				for (let e = 0; e < n.length; e++) i[e + 1] = n.charCodeAt(e);
			} else {
				let e = h.encode(n);
				i = new Uint8Array(e.byteLength + 2), i[0] = cc.UTF_8, i.set(e, 1);
			}
				...
				for (let e in n) {
					...
					this.writeAscii("TXXX"), this.writeSynchsafeU32(c), this.writeU16(0), this.writeU8(r ? cc.ISO_8859_1 : cc.UTF_8), r ? (this.writeIsoString(e), this.writeIsoString(t)) : (this.writer.write(i), this.writeU8(0), this.writer.write(a), this.writeU8(0));
				}
				continue;
			} else continue;
	...
	writeId3V2TextFrame(e, t) {
		...
		this.writeAscii(e), this.writeSynchsafeU32(r), this.writeU16(0), this.writeU8(n ? cc.ISO_8859_1 : cc.UTF_8), n ? this.writeIsoString(t) : this.writeUtf8String(t);
	}
	writeId3V2LyricsFrame(e) {
		let t = g(e), n = 5 + e.length + 1;
		this.writeAscii("USLT"), this.writeSynchsafeU32(n), this.writeU16(0), this.writeU8(t ? cc.ISO_8859_1 : cc.UTF_8), this.writeAscii("und"), t ? (this.writeIsoString(""), this.writeIsoString(e)) : (this.writeUtf8String(""), this.writeUtf8String(e));
	}
	writeId3V2CommentFrame(e) {
		let t = g(e), n = 5 + (t ? e.length : h.encode(e).byteLength) + 1;
		this.writeAscii("COMM"), this.writeSynchsafeU32(n), this.writeU16(0), this.writeU8(t ? cc.ISO_8859_1 : cc.UTF_8), this.writeU8(117), this.writeU8(110), this.writeU8(100), t ? (this.writeIsoString(""), this.writeIsoString(e)) : (this.writeUtf8String(""), this.writeUtf8String(e));
	}
	writeId3V2ApicFrame(e, t, n, r) {
		let i = g(e) && g(n), a = i ? n.length : h.encode(n).byteLength, o = 1 + e.length + 1 + 1 + a + 1 + r.byteLength;
		this.writeAscii("APIC"), this.writeSynchsafeU32(o), this.writeU16(0), this.writeU8(i ? cc.ISO_8859_1 : cc.UTF_8), i ? this.writeIsoString(e) : this.writeUtf8String(e), this.writeU8(t), i ? this.writeIsoString(n) : this.writeUtf8String(n), this.writer.write(r);
	}
}, gc = class {
	constructor(e) {
		this.mutex = new w(), this.trackTimestampInfo = /* @__PURE__ */ new WeakMap(), this.output = e;
	}
	onTrackClose(e) {}
...
}, _c = /* #__PURE__ */ new Uint8Array([
	102,
	76,
	97,
	67
]), vc = 38, yc = 34, bc = class extends gc {
	constructor(e, t) {
	...
	async start() {
		...
		this.writer = await this.output._getRootWriter(!!this.format._options.appendOnly), this.writer.write(_c), e();
	}
	writeHeader({ bitsPerSample: e, minimumBlockSize: t, maximumBlockSize: n, minimumFrameSize: r, maximumFrameSize: i, sampleRate: o, channels: s, totalSamples: c }) {
		...
		let l = !nt(this.output._metadataTags), u = new M(/* @__PURE__ */ new Uint8Array(4));
		u.writeBits(1, Number(!l)), u.writeBits(7, In.STREAMINFO), u.writeBits(24, yc), this.writer.write(u.bytes);
		let d = new M(/* @__PURE__ */ new Uint8Array(18));
	...
	writePictureBlock(e) {
		...
		let o = new M(/* @__PURE__ */ new Uint8Array(4));
		o.writeBits(1, 0), o.writeBits(7, In.PICTURE), o.writeBits(24, t), this.writer.write(o.bytes), this.writer.write(n);
	}
	writeVorbisCommentAndPictureBlock() {
		if (this.format._options.appendOnly || this.writer.seek(vc + _c.byteLength), nt(this.output._metadataTags)) {
			this.metadataWritten = !0;
			return;
		}
		let e = this.output._metadataTags.images ?? [];
		for (let t of e) this.writePictureBlock(t);
		let t = Rn(/* @__PURE__ */ new Uint8Array(), this.output._metadataTags, !1), n = new M(/* @__PURE__ */ new Uint8Array(4));
		n.writeBits(1, 1), n.writeBits(7, In.VORBIS_COMMENT), n.writeBits(24, t.length), this.writer.write(n.bytes), this.writer.write(t), this.metadataWritten = !0;
	}
	async getMimeType() {
		return "audio/flac";
	}
	...
	async addEncodedAudioPacket(e, t, n) {
		...
		try {
			if (this.validateTimestamp(e, t.timestamp, t.type === "key"), this.sampleRate === null) {
				Pt(n), a(n), a(n.decoderConfig), a(n.decoderConfig.description), this.sampleRate = n.decoderConfig.sampleRate, this.channels = n.decoderConfig.numberOfChannels;
				let e = new M(f(n.decoderConfig.description));
				e.skipBits(167);
			...
			let r = Ws.tempFromBytes(t.data);
			r.skip(2);
			let i = Ri(new M(H(r, 2)).readBits(4));
...
}, xc = /<(?:(\d{2}):)?(\d{2}):(\d{2}).(\d{3})>/g, Sc = /(?:(\d{2}):)?(\d{2}):(\d{2}).(\d{3})/, Cc = (e) => {
	let t = Sc.exec(e);
...
}, K = /* #__PURE__ */ new Uint8Array(8), Ec = /* #__PURE__ */ new DataView(K.buffer), Dc = (e) => [(e % 256 + 256) % 256], q = (e) => (Ec.setUint16(0, e, !1), [K[0], K[1]]), Oc = (e) => (Ec.setInt16(0, e, !1), [K[0], K[1]]), kc = (e) => (Ec.setUint32(0, e, !1), [
	K[1],
	K[2],
	K[3]
]), J = (e) => (Ec.setUint32(0, e, !1), [
	K[0],
	K[1],
	K[2],
	K[3]
]), Ac = (e) => (Ec.setInt32(0, e, !1), [
	K[0],
	K[1],
	K[2],
	K[3]
]), jc = (e) => (Ec.setUint32(0, Math.floor(e / 2 ** 32), !1), Ec.setUint32(4, e, !1), [
	K[0],
	K[1],
	K[2],
	K[3],
	...
	K[6],
	K[7]
]), Mc = (e) => (Ec.setInt32(0, Math.floor(e / 2 ** 32), !1), Ec.setUint32(4, e, !1), [
	K[0],
	K[1],
	K[2],
	K[3],
	...
	K[6],
	K[7]
]), Nc = (e) => (Ec.setInt16(0, 2 ** 8 * e, !1), [K[0], K[1]]), Pc = (e) => (Ec.setInt32(0, 2 ** 16 * e, !1), [
	K[0],
	K[1],
	K[2],
	K[3]
]), Fc = (e) => (Ec.setInt32(0, 2 ** 30 * e, !1), [
	K[0],
	K[1],
	K[2],
	K[3]
	...
	Kc(e.creationTime, e.trackDatas),
	...e.trackDatas.map((t) => Jc(t, e.creationTime)),
	e.isFragmented ? Fl(e.trackDatas) : null,
	Xl(e)
]), Kc = (e, t) => {
	let n = Math.max(0, ...t.map((e) => Q(qc(e), yu) + Q(e.startTimestampOffset ?? 0, yu))), r = Math.max(0, ...t.map((e) => e.track.id)) + 1, i = !c(e) || !c(n), a = i ? jc : J;
	return Z("mvhd", +i, 0, [
		a(e),
		a(e),
		J(yu),
	...
	let n = xu(e), r = e.startTimestampOffset !== null && e.startTimestampOffset > 0;
	return X("trak", void 0, [
		Yc(e, t),
		r ? Xc(e, e.startTimestampOffset) : null,
		Zc(e, t),
		n.name === void 0 ? null : X("udta", void 0, [X("name", [...h.encode(n.name)])])
	]);
}, Yc = (e, t) => {
	let n = Q(qc(e), yu) + Q(e.startTimestampOffset ?? 0, yu), r = !c(t) || !c(n), i = r ? jc : J, a;
	if (e.type === "video") {
	...
	return e.track.metadata.disposition?.default !== !1 && (o |= 1), Z("tkhd", +r, o, [
		...
		q(0),
		zc(a),
		Pc(e.type === "video" ? e.info.width : 0),
		Pc(e.type === "video" ? e.info.height : 0)
	]);
}, Xc = (e, t) => {
	let n = Q(t, yu), r = Q(qc(e), yu), i = !c(n) || !c(r), a = i ? jc : J, o = i ? Mc : Ac;
...
}, Zc = (e, t) => X("mdia", void 0, [
	Qc(e, t),
	tl(!0, $c[e.type], el[e.type]),
	nl(e)
]), Qc = (e, t) => {
	let n = Q(qc(e), e.timescale), r = !c(t) || !c(n), i = r ? jc : J;
	return Z("mdhd", +r, 0, [
		i(t),
		i(t),
		J(e.timescale),
		i(n),
		q(uu(e.track.metadata.languageCode ?? "und")),
		q(0)
	]);
}, $c = {
	video: "vide",
	...
	subtitle: () => Z("nmhd", 0, 0)
}, il = () => X("dinf", void 0, [al()]), al = () => Z("dref", 0, 0, [J(1)], [ol()]), ol = () => Z("url ", 0, 1), sl = (e) => {
	...
	let t;
	if (e.type === "video") t = ll(iu(e.track.source._codec, e.info.decoderConfig.codec), e);
	else if (e.type === "audio") {
		let n = ou(e.track.source._codec, e.muxer.isQuickTime);
		a(n), t = gl(n, e);
	} else e.type === "subtitle" && (t = El(cu[e.track.source._codec], e));
	...
	au[t.track.source._codec](t),
	ul(t),
	ee(t.info.decoderConfig.colorSpace) ? dl(t) : null
]), ul = (e) => e.info.pixelAspectRatio.num === e.info.pixelAspectRatio.den ? null : X("pasp", [J(e.info.pixelAspectRatio.num), J(e.info.pixelAspectRatio.den)]), dl = (e) => X("colr", [
	Y(e.muxer.isQuickTime ? "nclc" : "nclx"),
	q(v[e.info.decoderConfig.colorSpace.primaries]),
	q(b[e.info.decoderConfig.colorSpace.transfer]),
	q(S[e.info.decoderConfig.colorSpace.matrix]),
	e.muxer.isQuickTime ? [] : Dc(!!e.info.decoderConfig.colorSpace.fullRange << 7)
]), fl = (e) => e.info.decoderConfig && X("avcC", [...f(e.info.decoderConfig.description)]), pl = (e) => e.info.decoderConfig && X("hvcC", [...f(e.info.decoderConfig.description)]), ml = (e) => {
...
}, hl = (e) => X("av1C", vt(e.info.decoderConfig.codec)), gl = (e, t) => {
	let n = 0, r, i = 16, a = F.includes(t.track.source._codec);
	if (a) {
		let e = t.track.source._codec, { sampleSize: r } = wt(e);
		i = 8 * r, i > 16 && (n = 1);
	}
	...
	return X(e, r, [su(t.track.source._codec, t.muxer.isQuickTime)?.(t) ?? null]);
}, _l = (e) => {
	let t;
	...
	bl(e),
	X("\0\0\0\0")
]), yl = (e) => X("frma", [Y(ou(e.track.source._codec, e.muxer.isQuickTime))]), bl = (e) => {
	let { littleEndian: t } = wt(e.track.source._codec);
	return X("enda", [q(+t)]);
}, xl = (e) => {
	...
	return a(t), Z("dfLa", 0, 0, [...f(t).subarray(4)]);
}, Cl = (e) => {
	let { littleEndian: t, sampleSize: n } = wt(e.track.source._codec);
	return Z("pcmC", 0, 0, [Dc(+t), Dc(8 * n)]);
}, wl = (e) => {
	let t = Bn(e.info.firstPacket.data);
	...
	let n = /* @__PURE__ */ new Uint8Array(3), r = new M(n);
	...
	let t = Wn(e.info.firstPacket.data);
	...
	let r = Math.ceil(n / 8), i = new Uint8Array(r), a = new M(i);
	...
	,
	,
].fill(0), q(1)], [lu[t.track.source._codec](t)]), Dl = (e) => X("vttC", [...h.encode(e.info.config.description)]), Ol = (e) => Z("stts", 0, 0, [J(e.timeToSampleTable.length), e.timeToSampleTable.map((e) => [J(e.sampleCount), J(e.sampleDelta)])]), kl = (e) => {
...
}, Al = (e) => Z("stsc", 0, 0, [J(e.compactlyCodedChunkTable.length), e.compactlyCodedChunkTable.map((e) => [
	J(e.firstChunk),
	J(e.samplesPerChunk),
	J(1)
])]), jl = (e) => {
	if (e.type === "audio" && e.info.requiresPcmTransformation) {
		let { sampleSize: t } = wt(e.track.source._codec);
		return Z("stsz", 0, 0, [J(t * e.info.numberOfChannels), J(e.samples.reduce((t, n) => t + Q(n.duration, e.timescale), 0))]);
	}
	return Z("stsz", 0, 0, [
		J(0),
		J(e.samples.length),
...
}, Ml = (e) => e.finalizedChunks.length > 0 && s(e.finalizedChunks).offset >= 2 ** 32 ? Z("co64", 0, 0, [J(e.finalizedChunks.length), e.finalizedChunks.map((e) => jc(e.offset))]) : Z("stco", 0, 0, [J(e.finalizedChunks.length), e.finalizedChunks.map((e) => J(e.offset))]), Nl = (e) => Z("ctts", 1, 0, [J(e.compositionTimeOffsetTable.length), e.compositionTimeOffsetTable.map((e) => [J(e.sampleCount), Ac(e.sampleCompositionTimeOffset)])]), Pl = (e) => {
	...
	for (let t = 0; t < e.samples.length; t++) {
		let n = e.samples[t];
		r = Math.min(r, Q(n.timestamp, e.timescale)), i = Math.max(i, Q(n.timestamp + n.duration, e.timescale));
	}
	let o = Math.max(-t, 0);
...
}, Fl = (e) => X("mvex", void 0, e.map(Il)), Il = (e) => Z("trex", 0, 0, [
	J(e.track.id),
	J(1),
	J(0),
	J(0),
	J(0)
]), Ll = (e, t) => X("moof", void 0, [Rl(e), ...t.map(Bl)]), Rl = (e) => Z("mfhd", 0, 0, [J(e)]), zl = (e) => {
...
}, Hl = (e) => (a(e.currentChunk), Z("tfdt", 1, 0, [jc(Q(e.currentChunk.startTimestamp, e.timescale))])), Ul = (e) => {
	a(e.currentChunk);
	let t = e.currentChunk.samples.map((e) => e.timescaleUnitsToNextSample), n = e.currentChunk.samples.map((e) => e.size), r = e.currentChunk.samples.map(zl), i = e.currentChunk.samples.map((t) => Q(t.timestamp - t.decodeTimestamp, e.timescale)), o = new Set(t), s = new Set(n), c = new Set(r), l = new Set(i), u = c.size === 2 && r[0] !== r[1], d = o.size > 1, f = s.size > 1, p = !u && c.size > 1, m = l.size > 1 || [...l].some((e) => e !== 0), h = 0;
	return h |= 1, h |= 4 * u, h |= 256 * d, h |= 512 * f, h |= 1024 * p, h |= 2048 * m, Z("trun", 1, h, [
...
}, Wl = (e) => X("mfra", void 0, [...e.map(Gl), Kl()]), Gl = (e, t) => Z("tfra", 1, 0, [
	J(e.track.id),
	J(63),
	J(e.finalizedChunks.length),
	e.finalizedChunks.map((n) => [
		jc(Q(n.samples[0].timestamp, e.timescale)),
		jc(n.moofOffset),
		J(t + 1),
		J(1),
		J(1)
	])
]), Kl = () => Z("mfro", 0, 0, [J(0)]), ql = () => X("vtte"), Jl = (e, t, n, r, i) => X("vttc", void 0, [
	i === null ? null : X("vsid", [Ac(i)]),
	n === null ? null : X("iden", [...h.encode(n)]),
	t === null ? null : X("ctim", [...h.encode(wc(t))]),
	r === null ? null : X("sttg", [...h.encode(r)]),
	X("payl", [...h.encode(e)])
]), Yl = (e) => X("vtta", [...h.encode(e)]), Xl = (e) => {
	...
	if (n === "mdir" || n === "auto" && !e.isQuickTime) {
		...
		let e = nu(r);
		e && t.push(e);
	} else (n === "udta" || n === "auto" && e.isQuickTime) && Zl(t, e.output._metadataTags);
	return t.length === 0 ? null : X("udta", void 0, t);
}, Zl = (e, t) => {
	for (let { key: n, value: r } of Ie(t)) switch (n) {
		case "title":
			e.push(Ql("©nam", r));
			break;
		case "description":
		...
		case "genre":
			...
			break;
		case "date":
			e.push(Ql("©day", r.toISOString().slice(0, 10)));
			break;
		case "comment":
			e.push(Ql("©cmt", r));
			break;
	...
	if (t.raw) for (let n in t.raw) {
		let r = t.raw[n];
		r == null || n.length !== 4 || e.some((e) => e.type === n) || (typeof r == "string" ? e.push(Ql(n, r)) : r instanceof Uint8Array && e.push(X(n, Array.from(r))));
	}
}, Ql = (e, t) => {
	let n = h.encode(t);
	return X(e, [
	...
	let n = [];
	for (let { key: r, value: i } of Ie(e)) switch (r) {
		case "title":
			n.push({
				key: t ? "title" : "©nam",
				value: ru(i)
		...
		case "date":
			n.push({
				key: t ? "date" : "©day",
				value: ru(i.toISOString().slice(0, 10))
			});
			break;
		case "images":
	...
	let t = eu(e, !1);
	return t.length === 0 ? null : Z("meta", 0, 0, void 0, [tl(!1, "mdir", "", "appl"), X("ilst", void 0, t.map((e) => X(e.key, void 0, [e.value])))]);
}, nu = (e) => {
	let t = eu(e, !0);
	return t.length === 0 ? null : X("meta", void 0, [
		tl(!1, "mdta", ""),
		Z("keys", 0, 0, [J(t.length)], t.map((e) => X("mdta", [...h.encode(e.key)]))),
	...
	switch (e) {
		...
		case "mp3": return _l;
		case "opus": return xl;
		case "vorbis": return _l;
		case "flac": return Sl;
		case "ac3": return wl;
		case "eac3": return Tl;
	}
	if (t) switch (e) {
		case "pcm-s24": return vl;
		...
		case "pcm-s16": return Cl;
		case "pcm-s16be": return Cl;
		case "pcm-s24": return Cl;
		case "pcm-s24be": return Cl;
		case "pcm-s32": return Cl;
		case "pcm-s32be": return Cl;
		case "pcm-f32": return Cl;
		case "pcm-f32be": return Cl;
		case "pcm-f64": return Cl;
		case "pcm-f64be": return Cl;
	}
	return null;
}, cu = { webvtt: "wvtt" }, lu = { webvtt: Dl }, uu = (e) => {
	a(e.length === 3);
	let t = 0;
...
}, pu = 2 ** 16, mu = 2 ** 32, hu = class extends fu {
	constructor(e = {}) {
		...
		if (this._options = e, this._supportsResize = "resize" in /* @__PURE__ */ new ArrayBuffer(0), this._supportsResize) try {
			this._buffer = new ArrayBuffer(pu, { maxByteLength: mu });
		} catch {
			this._buffer = new ArrayBuffer(pu), this._supportsResize = !1;
		}
		else this._buffer = new ArrayBuffer(pu);
	...
	_ensureSize(e) {
		...
		if (t !== this._buffer.byteLength) {
			if (t > mu) throw Error(`ArrayBuffer exceeded maximum size of ${mu} bytes. Please consider using another target.`);
	...
	constructor(e, t) {
		super(e), this.writer = null, this.boxWriter = null, this.initWriter = null, this.initBoxWriter = null, this.auxTarget = new hu(), this.auxWriter = new du(this.auxTarget, !1), this.auxBoxWriter = new Tc(this.auxWriter), this.mdat = null, this.ftypSize = null, this.trackDatas = [], this.allTracksKnown = E(), this.creationTime = Math.floor(Date.now() / 1e3) + bu, this.finalizedChunks = [], this.nextFragmentNumber = 1, this.maxWrittenTimestamp = -Infinity, this.minWrittenTimestamp = Infinity, this.maxWrittenEndTimestamp = -Infinity, this.segmentHeaderSize = null, this.format = t, this.isQuickTime = t instanceof td, this.isCmaf = t instanceof ed, this.minimumFragmentDuration = t._options.minimumFragmentDuration ?? (t instanceof ed ? Infinity : 1);
	}
	async start() {
		let e = await this.mutex.acquire();
		if (this.isCmaf ? (this.fastStart = "fragmented", this.isFragmented = !0) : (this.writer = await this.output._getRootWriter((e) => this.format._options.fastStart === void 0 ? e instanceof hu : this.format._options.fastStart === "fragmented"), this.boxWriter = new Tc(this.writer), this.fastStart = this.format._options.fastStart ?? (this.writer.target instanceof hu ? "in-memory" : !1), this.isFragmented = this.fastStart === "fragmented"), this.isCmaf) {
			...
			let e = new du(await this.output._getInitTarget(), !0);
			e.start(), this.initWriter = e, this.initBoxWriter = new Tc(e);
		}
		let t = this.output._tracks.some((e) => e.isVideoTrack() && e.source._codec === "avc");
		{
			let e = this.initBoxWriter ?? this.boxWriter;
			if (a(e), this.format._options.onFtyp && e.writer.startTrackingWrites(), e.writeBox(Bc({
				isQuickTime: this.isQuickTime,
				holdsAvc: t,
		...
		} else this.isFragmented || (a(this.writer), a(this.boxWriter), this.format._options.onMdat && this.writer.startTrackingWrites(), this.mdat = Uc(!0), this.boxWriter.writeBox(this.mdat));
	...
	getVideoTrackData(e, t, n) {
		...
		if (e.source._codec === "avc" && !i.description) {
			...
			i.description = Tn(e), o = !0;
		}
		let s = we(1 / (e.metadata.frameRate ?? 57600), 1e6).den, c = i.displayAspectWidth, l = i.displayAspectHeight, u = c === void 0 || l === void 0 ? {
			num: 1,
			den: 1
		} : Ke({
			num: c * i.codedHeight,
	...
	getAudioTrackData(e, t, n) {
		...
		if (e.source._codec === "aac" && !i.description) {
			...
			let n = N[e.samplingFrequencyIndex], r = P[e.channelConfiguration];
		...
		let s = {
			...
			info: {
				...
				decoderConfig: i,
				requiresPcmTransformation: !this.isFragmented && F.includes(e.source._codec),
	...
	async addEncodedVideoPacket(e, t, n) {
		...
		try {
			...
			if (r.info.requiresAnnexBTransformation) {
				let e = [...Zt(i)].map((e) => i.subarray(e.offset, e.offset + e.length));
	...
	async addEncodedAudioPacket(e, t, n) {
		...
		try {
			...
			if (r.info.requiresPcmTransformation) {
				let e = wt(r.info.decoderConfig.codec).sampleSize * r.info.numberOfChannels;
	...
	async padWithSilence(e, t, n) {
		let r = Q(n, e.timescale);
		if (n = r / e.timescale, r > 0) {
			let { sampleSize: i, silentValue: a } = wt(e.info.decoderConfig.codec), o = r * e.info.numberOfChannels, s = new Uint8Array(i * o).fill(a), c = this.createSampleForTrack(e, new Uint8Array(s.buffer), t, n, "key");
	...
	async processWebVTTCues(e, t) {
		for (; e.cueQueue.length > 0;) {
			...
			for (let t = 0; t < e.cueQueue.length; t++) {
				...
				xc.lastIndex = 0;
				let r = xc.test(n.text), a = n.timestamp + n.duration, s = e.cueToSourceId.get(n);
				if (s === void 0 && o < a && (s = e.nextSourceId++, e.cueToSourceId.set(n, s)), n.notes) {
					let e = Yl(n.notes);
					this.auxBoxWriter.writeBox(e);
				}
				let c = Jl(n.text, r ? i : null, n.identifier ?? null, n.settings ?? null, s ?? null);
	...
	createSampleForTrack(e, t, n, r, i) {
		return {
			...
			size: t.byteLength,
			type: i,
			timescaleUnitsToNextSample: Q(r, e.timescale)
		};
	}
	processTimestamps(e, t) {
		...
		if (e.type === "audio" && e.info.requiresPcmTransformation) {
			...
			for (let n = 0; n < e.timestampProcessingQueue.length; n++) {
				let r = e.timestampProcessingQueue[n], i = Q(r.duration, e.timescale);
				t += i;
			}
		...
		for (let t = 0; t < e.timestampProcessingQueue.length; t++) {
			...
			let i = Q(r.timestamp - r.decodeTimestamp, e.timescale), o = Q(r.duration, e.timescale);
			if (e.lastTimescaleUnits !== null) {
				a(e.lastSample);
				let t = Q(r.decodeTimestamp, e.timescale, !1), n = Math.round(t - e.lastTimescaleUnits);
			...
			} else e.lastTimescaleUnits = Q(r.decodeTimestamp, e.timescale, !1), this.isFragmented || (e.timeToSampleTable.push({
				sampleCount: 1,
				sampleDelta: o
		...
		if (e.timestampProcessingQueue.length = 0, a(e.lastSample), a(e.lastTimescaleUnits !== null), t !== void 0 && e.lastSample.timescaleUnitsToNextSample === 0) {
			a(t.type === "key");
			let n = Q(t.timestamp, e.timescale, !1), r = Math.round(n - e.lastTimescaleUnits);
	...
	async finalizeCurrentChunk(e) {
		...
		if (e.type === "audio" && e.info.requiresPcmTransformation && (t = e.currentChunk.samples.reduce((t, n) => t + Q(n.duration, e.timescale), 0)), (e.compactlyCodedChunkTable.length === 0 || s(e.compactlyCodedChunkTable).samplesPerChunk !== t) && e.compactlyCodedChunkTable.push({
	...
	async finalizeFragment(e = !this.isCmaf) {
		...
		if (t === 1) {
			...
			if (this.isCmaf) {
				a(this.initWriter), await this.initWriter.flush(), await this.initWriter.finalize(), this.writer = await this.output._getRootWriter(!0), this.boxWriter = new Tc(this.writer);
				let e = this.boxWriter.measureBox(Vc()), t = this.boxWriter.measureBox(Hc(this, 0));
				this.segmentHeaderSize = e + t, this.writer.seek(this.segmentHeaderSize);
			}
		}
		a(this.writer), a(this.boxWriter);
		let n = this.trackDatas.filter((e) => e.currentChunk), r = Ll(t, n), i = this.writer.getPos(), o = i + this.boxWriter.measureBox(r), s = o + 8, c = Infinity;
		for (let e of n) {
	...
	async registerSampleFastStartReserve(e, t) {
		if (a(this.writer), a(this.boxWriter), this.allTracksAreKnown()) {
			if (!this.mdat) {
				...
				let e = Gc(this), t = this.boxWriter.measureBox(e) + this.computeSampleTableSizeUpperBound() + 4096;
				a(this.ftypSize !== null), this.writer.seek(this.ftypSize + t), this.format._options.onMdat && this.writer.startTrackingWrites(), this.mdat = Uc(!0), this.boxWriter.writeBox(this.mdat);
	...
	async finalize() {
		...
		if (a(this.writer), a(this.boxWriter), this.fastStart === "in-memory") {
			...
			let e;
			for (let t = 0; t < 2; t++) {
				let t = Gc(this), n = this.boxWriter.measureBox(t);
			...
			this.writer.seek(0), this.boxWriter.writeBox(Vc()), this.boxWriter.writeBox(Hc(this, e));
		} else {
	...
	writeEBMLHeader() {
		...
		let e = {
			...
			data: [
				...
				{
					id: z.EBMLReadVersion,
					data: 1
				},
				{
					id: z.EBMLMaxIDLength,
					data: 4
				},
				{
					id: z.EBMLMaxSizeLength,
					data: 8
				},
				{
					id: z.DocType,
					data: this.format instanceof rd ? "webm" : "matroska"
				},
				{
					id: z.DocTypeVersion,
					data: 2
	...
	createTracks() {
		...
		for (let t of this.trackDatas) {
			let n = ni[t.track.source._codec];
			a(n);
			let r = 0;
			...
			e.data.push({
				...
				data: [
					...
					t.track.metadata.disposition?.hearingImpaired ? {
						id: z.FlagHearingImpaired,
						data: 1
					} : null,
					t.track.metadata.disposition?.visuallyImpaired ? {
						id: z.FlagVisualImpaired,
						data: 1
					} : null,
					...
					t.track.metadata.name === void 0 ? null : {
						id: z.Name,
						data: new Ir(t.track.metadata.name)
					},
		...
		let { frameRate: t, rotation: n } = e.track.metadata, r = [e.info.decoderConfig.description ? {
			...
			data: [
				...
				ee(s) ? {
					...
					data: [
						{
							id: z.MatrixCoefficients,
							data: S[s.matrix]
						},
						{
							id: z.TransferCharacteristics,
							data: b[s.transfer]
						},
						{
							id: z.Primaries,
				...
				i ? {
					...
					data: [{
						...
						id: z.ProjectionPoseRoll,
						data: new Nr((i + 180) % 360 - 180)
					}]
				} : null
			]
		};
	...
	audioSpecificTrackInfo(e) {
		let t = F.includes(e.track.source._codec) ? wt(e.track.source._codec) : null;
		return [e.info.decoderConfig.description ? {
			...
			data: [
				{
					id: z.SamplingFrequency,
					data: new Nr(e.info.sampleRate)
				},
				{
					id: z.Channels,
	...
	maybeCreateTags() {
		...
		for (let { key: e, value: i } of Ie(n)) switch (e) {
			case "title":
	...
	maybeCreateAttachments() {
		...
		for (let e of r) {
			let r = e.name;
			r === void 0 && (r = (e.kind === "coverFront" ? "cover" : e.kind === "coverBack" ? "back" : "image") + (Le(e.mimeType) ?? ""));
			let i;
			for (;;) {
				i = 0n;
			...
			n.add(i), t.push({
				...
				data: [
					e.description === void 0 ? null : {
						id: z.FileDescription,
						data: new Ir(e.description)
					},
					{
						id: z.FileName,
						data: new Ir(r)
		...
		for (let [n, i] of Object.entries(e.raw ?? {})) i instanceof et && /^\d+$/.test(n) && (r.find((e) => e.mimeType === i.mimeType && Be(e.data, i.data)) || t.push({
			id: z.AttachedFile,
			data: [
				i.description === void 0 ? null : {
					id: z.FileDescription,
					data: new Ir(i.description)
				},
				{
					id: z.FileName,
					data: new Ir(i.name ?? "")
	...
	async getMimeType() {
		...
		let e = this.trackDatas.map((e) => e.type === "video" || e.type === "audio" ? e.info.decoderConfig.codec : { webvtt: "wvtt" }[e.track.source._codec]);
		return ii({
			isWebM: this.format instanceof rd,
			hasVideo: this.trackDatas.some((e) => e.type === "video"),
			hasAudio: this.trackDatas.some((e) => e.type === "audio"),
			codecStrings: e
		});
	...
	getVideoTrackData(e, t, n) {
		let r = this.trackDatas.find((t) => t.track === e);
		if (r) return r;
		Mt(n), a(n), a(n.decoderConfig), a(n.decoderConfig.codedWidth !== void 0), a(n.decoderConfig.codedHeight !== void 0);
		let i = n.decoderConfig.displayAspectWidth, o = n.decoderConfig.displayAspectHeight, s = i === void 0 || o === void 0 ? null : Ke({
			num: i,
			den: o
		}), c = {
			track: e,
		...
		return e.source._codec === "vp9" ? c.info.decoderConfig = {
			...
			...c.info.decoderConfig,
			description: new Uint8Array(vt(c.info.decoderConfig.codec))
	...
	async addEncodedVideoPacket(e, t, n) {
		...
		try {
			...
			let a = t.timestamp, o = t.duration;
			e.metadata.frameRate !== void 0 && (a = _e(a, e.metadata.frameRate), o = _e(o, e.metadata.frameRate));
	...
	async addSubtitleCue(e, t, n) {
		...
		try {
			...
			xc.lastIndex = 0, i = i.replace(xc, (e) => `<${wc(Cc(e.slice(1, -1)) - a)}>`);
	...
	writeBlock(e, t) {
		...
		if (!this.currentCluster) i = !0;
			...
			i = r && n > this.currentClusterMaxMsTimestamp && e >= 1e3 * (this.format._options.minimumClusterDuration ?? 1) || e > wu;
		}
		...
		if (t.additions) {
			let r = {
				...
				data: [
					...
					t.type === "delta" ? {
						id: z.ReferenceBlock,
						data: new Fr(e.lastWrittenMsTimestamp - n)
					} : null,
					t.additions ? {
						id: z.BlockAdditions,
						data: [{
	...
	createNewCluster(e) {
		this.currentCluster && this.finalizeCurrentCluster(), this.format._options.onCluster && this.writer.startTrackingWrites(), this.currentCluster = {
			id: z.Cluster,
			size: this.format._options.appendOnly ? -1 : Du,
			data: [{
				id: z.Timestamp,
				data: e
			}]
	...
	finalizeCurrentCluster() {
		if (a(this.currentCluster), !this.format._options.appendOnly) {
			...
			this.writer.seek(this.ebmlWriter.offsets.get(this.currentCluster) + 4), this.ebmlWriter.writeVarInt(e, Du), this.writer.seek(t);
		}
		...
		for (let [t, r] of n) a(this.cues), this.cues.data.push({
			...
			data: [{
				...
				id: z.CueTrackPositions,
				data: [{
					id: z.CueTrack,
					data: t.track.id
				}, {
					id: z.CueClusterPosition,
					data: e
				}]
			}))]
		});
	...
	async finalize() {
		...
		if (this.segment || this.createSegment(), await this.interleaveChunks(!0), this.currentCluster && this.finalizeCurrentCluster(), a(this.cues), this.ebmlWriter.writeEBML(this.cues), !this.format._options.appendOnly) {
			...
			this.writer.seek(this.ebmlWriter.offsets.get(this.segment) + 4), this.ebmlWriter.writeVarInt(e, Eu);
			let t = this.startTimestamp === Infinity ? 0 : this.endTimestamp - this.startTimestamp;
			this.segmentDuration.data = new Pr(t), this.writer.seek(this.ebmlWriter.offsets.get(this.segmentDuration)), this.ebmlWriter.writeEBML(this.segmentDuration), a(this.seekHead), this.writer.seek(this.ebmlWriter.offsets.get(this.seekHead)), this.maybeCreateSeekHead(!0), this.ebmlWriter.writeEBML(this.seekHead);
		}
		e();
	}
}, Au = class {
	...
	writeXingFrame(e) {
		...
		for (let t = 0; t < 16; t++) {
			let n = Lt[a + t];
			if (zt(r, e.layer, 1e3 * n, e.sampleRate, 0) >= 155) {
				i = t;
				break;
			}
		}
		...
		let c = Vt(e.mpegVersionId, e.channel);
		this.writer.seek(t + c), this.writeU32(Rt);
		let l = 0;
		e.frameCount !== null && (l |= Gt.FrameCount), e.fileSize !== null && (l |= Gt.FileSize), e.toc !== null && (l |= Gt.Toc), this.writeU32(l), this.writeU32(e.frameCount ?? 0), this.writeU32(e.fileSize ?? 0), this.writer.write(e.toc ?? /* @__PURE__ */ new Uint8Array(100));
		let u = Lt[a + i], d = zt(r, e.layer, 1e3 * u, e.sampleRate, 0);
	...
	async start() {
		let e = await this.mutex.acquire();
		this.writer = await this.output._getRootWriter(this.format._options.xingHeader === !1), this.mp3Writer = new Au(this.writer), nt(this.output._metadataTags) || new hc(this.writer).writeId3V2Tag(this.output._metadataTags), e();
	}
	async getMimeType() {
		return "audio/mpeg";
	}
	...
	async addEncodedAudioPacket(e, t) {
		...
		try {
			...
			if (!this.xingFrameData && n) {
				...
				let n = Ht(e.getUint32(0, !1), null).header;
				if (!n) throw Error("Invalid MP3 header in sample.");
				let r = Vt(n.mpegVersionId, n.channel);
				if (e.byteLength >= r + 4) {
...
}, Mu = 8192, Nu = class extends gc {
	constructor(e, t) {
		super(e), this.trackDatas = [], this.bosPagesWritten = !1, this.allTracksKnown = E(), this.pageBytes = new Uint8Array(Ci), this.pageView = new DataView(this.pageBytes.buffer), this.format = t;
	}
	async start() {
		let e = await this.mutex.acquire();
	...
	async getMimeType() {
		return await this.allTracksKnown.promise, Si({ codecStrings: this.trackDatas.map((e) => e.codecInfo.codec) });
	}
	...
	getTrackData(e, t) {
		...
		a(e.source._codec === "vorbis" || e.source._codec === "opus"), Pt(t), a(t), a(t.decoderConfig);
		let i = {
			track: e,
			serialNumber: r,
			internalSampleRate: e.source._codec === "opus" ? St : t.decoderConfig.sampleRate,
			codecInfo: {
	...
	queueHeaderPackets(e, t) {
		if (a(t.decoderConfig), e.track.source._codec === "vorbis") {
			...
			let d = Rn(u, this.output._metadataTags, !0);
			e.packetQueue.push({
				data: c,
			...
			e.codecInfo.vorbisInfo = {
				...
				modeBlockflags: Pn(l).modeBlockflags
			};
			...
			let a = Rn(r, this.output._metadataTags, !0);
			e.packetQueue.push({
				data: n,
				timestampInSamples: 0,
				durationInSamples: 0,
				...
				durationInSamples: 0,
				forcePageFlush: !0
			}), e.codecInfo.opusInfo = { preSkip: jn(n).preSkip };
		}
	}
	async addEncodedAudioPacket(e, t, n) {
		let r = await this.mutex.acquire();
		try {
			...
			this.validateTimestamp(r.track, t.timestamp, t.type === "key");
			let i = r.currentTimestampInSamples, { durationInSamples: a, vorbisBlockSize: o } = xi(t.data, r.codecInfo, r.vorbisLastBlocksize);
	...
	writePacket(e, t, n) {
		...
		e.currentPageData.push(s), e.currentPageSize += s.length, e.currentGranulePosition = r, (e.currentPageSize >= Mu || t.forcePageFlush) && this.writePage(e, n);
	}
	writePage(e, t) {
		this.pageView.setUint32(0, _i, !0), this.pageView.setUint8(4, 0);
		let n = 0;
		...
		k(this.pageView, 6, r, !0), this.pageView.setUint32(14, e.serialNumber, !0), this.pageView.setUint32(18, e.pagesWritten, !0), this.pageView.setUint32(22, 0, !0), this.pageView.setUint8(26, e.currentLacingValues.length), this.pageBytes.set(e.currentLacingValues, 27);
		let i = 27 + e.currentLacingValues.length;
		for (let t of e.currentPageData) this.pageBytes.set(t, i), i += t.length;
		let a = this.pageBytes.subarray(0, i), o = bi(a);
	...
	async start() {
		let e = await this.mutex.acquire();
		this.writer = await this.output._getRootWriter(!1), this.riffWriter = new Pu(this.writer), e();
	}
	async getMimeType() {
		return "audio/wav";
	}
	...
	async addEncodedAudioPacket(e, t, n) {
		let r = await this.mutex.acquire();
		try {
			if (this.headerWritten ||= (Pt(n), a(n), a(n.decoderConfig), this.writeHeader(e, n.decoderConfig), this.sampleRate = n.decoderConfig.sampleRate, !0), this.validateTimestamp(e, t.timestamp, t.type === "key"), !this.isRf64 && this.writer.getPos() + t.data.byteLength >= 2 ** 32) throw Error("Adding more audio data would exceed the maximum RIFF size of 4 GiB. To write larger files, use RF64 by setting `large: true` in the WavOutputFormatOptions.");
	...
	writeHeader(e, t) {
		...
		let n, r = e.source._codec, i = wt(r);
		n = i.dataType === "ulaw" ? Ai.MULAW : i.dataType === "alaw" ? Ai.ALAW : i.dataType === "float" ? Ai.IEEE_FLOAT : Ai.PCM;
		let a = t.numberOfChannels, o = t.sampleRate, s = i.sampleSize * a;
		if (this.riffWriter.writeAscii(this.isRf64 ? "RF64" : "RIFF"), this.isRf64 ? this.riffWriter.writeU32(4294967295) : (this.riffSizePos = this.writer.getPos(), this.riffWriter.writeU32(0)), this.riffWriter.writeAscii("WAVE"), this.isRf64 && (this.riffWriter.writeAscii("ds64"), this.riffWriter.writeU32(28), this.ds64RiffSizePos = this.writer.getPos(), this.riffWriter.writeU64(0), this.ds64DataSizePos = this.writer.getPos(), this.riffWriter.writeU64(0), this.ds64SampleCountPos = this.writer.getPos(), this.riffWriter.writeU64(0), this.riffWriter.writeU32(0)), this.riffWriter.writeAscii("fmt "), this.riffWriter.writeU32(16), this.riffWriter.writeU16(n), this.riffWriter.writeU16(a), this.riffWriter.writeU32(o), this.riffWriter.writeU32(o * s), this.riffWriter.writeU16(s), this.riffWriter.writeU16(8 * i.sampleSize), !nt(this.output._metadataTags)) {
			let e = this.format._options.metadataFormat ?? "info";
			e === "info" ? this.writeInfoChunk(this.output._metadataTags) : e === "id3" ? this.writeId3Chunk(this.output._metadataTags) : O(e);
		}
	...
	writeInfoChunk(e) {
		...
		for (let { key: t, value: i } of Ie(e)) switch (t) {
			case "title":
				r("INAM", i), n.add("INAM");
				break;
			case "artist":
	...
	writeId3Chunk(e) {
		...
		let n = new hc(this.writer).writeId3V2Tag(e), r = this.writer.getPos();
	...
	constructor(e) {
		if (super(), this._connectedTrack = null, !st.includes(e)) throw TypeError(`Invalid video codec '${e}'. Must be one of: ${st.join(", ")}.`);
		this._codec = e;
	}
}, zu = (e, t) => {
	...
	add(e, t) {
		...
		return this._ensureValidAdd(), zu(this._connectedTrack, e), this._connectedTrack.output._muxer.addEncodedVideoPacket(this._connectedTrack, e, t);
	}
}, Vu = class {
	constructor(e, t) {
		this.source = e, this.encodingConfig = t, this.ensureEncoderPromise = null, this.encoderInitialized = !1, this.encoder = null, this.muxer = null, this.lastMultipleOfKeyFrameInterval = -1, this.emittedEncoderPackets = 0, this.codedWidth = null, this.codedHeight = null, this.outputWidth = null, this.outputHeight = null, this.frameRateLastSample = null, this.frameRateLastTimestamp = null, this.frameRateLastEndTimestamp = null, this.preciseTimings = [], this.customEncoder = null, this.customEncoderCallSerializer = new Te(), this.customEncoderQueueSize = 0, this.alphaEncoder = null, this.splitter = null, this.splitterCreationFailed = !1, this.alphaFrameQueue = [], this.error = null, this.closed = !1, this.lastMuxerPromise = Promise.resolve();
	}
	async add(e, t, n) {
		let r = e;
		try {
			...
			if (c !== void 0) {
				let i = e.timestamp + e.duration, a = ye(e.timestamp, c);
	...
	async processAndEncode(e, t) {
		...
		if (n.transform?.process) {
			...
			Array.isArray(t) || (t = [t]), r = t.map((t) => t instanceof go ? t : typeof VideoFrame < "u" && t instanceof VideoFrame ? new go(t) : new go(t, {
				timestamp: e.timestamp,
				duration: e.duration
			}));
		} else r = [e];
		try {
			for (let e of r) {
				...
				if (this.lastMultipleOfKeyFrameInterval = r, this.encodingConfig.onEncodedSample?.(e), this.customEncoder) {
					...
					a(this.encoder);
					let t = e.toVideoFrame(), n = T(this.preciseTimings, t.timestamp, (e) => e.microsecondTimestamp), r = n === -1 ? null : this.preciseTimings[n];
	...
	ensureEncoder(e) {
		this.ensureEncoderPromise = (async () => {
			...
			let n = ls.find((e) => e.supports(this.encodingConfig.codec, t));
			if (n) this.customEncoder = new n(), this.customEncoder.codec = this.encodingConfig.codec, this.customEncoder.config = t, this.customEncoder.onPacket = (e, t) => {
				if (!(e instanceof R)) throw TypeError("The first argument passed to onPacket must be an EncodedPacket.");
				if (t !== void 0 && (!t || typeof t != "object")) throw TypeError("The second argument passed to onPacket must be an object or undefined.");
				zu(this.source._connectedTrack, e), this.encodingConfig.onEncodedPacket?.(e, t), this.lastMuxerPromise = this.muxer.addEncodedVideoPacket(this.source._connectedTrack, e, t).catch((e) => {
					this.error ??= e;
				});
				...
				let e = [], n = [], r = 0, i = 0, o = (e, t, n) => {
					...
					let i = R.fromEncodedChunk(e, r), a = T(this.preciseTimings, e.timestamp, (e) => e.microsecondTimestamp), o = a === -1 ? null : this.preciseTimings[a], s = null;
					this.emittedEncoderPackets === 0 && i.type === "delta" && n?.decoderConfig && (s = Fn(this.encodingConfig.codec, n.decoderConfig, i.data)), (o && o.microsecondTimestamp === e.timestamp || s !== null) && (i = i.clone({
						timestamp: o?.timestampIsValid ? o.timestamp : void 0,
						duration: o?.durationIsValid ? o.duration : void 0,
						type: s ?? void 0
					})), zu(this.source._connectedTrack, i), this.encodingConfig.onEncodedPacket?.(i, n), this.lastMuxerPromise = this.muxer.addEncodedVideoPacket(this.source._connectedTrack, i, n).catch((e) => {
						this.error ??= e;
	...
	async flushAndClose(e) {
		if (e || this.checkForEncoderError(), !e && this.frameRateLastSample) {
			let e = this.encodingConfig.transform.frameRate, t = ye(this.frameRateLastEndTimestamp, e);
	...
	constructor(t, n) {
		...
		if (!e.forceCpu && r && !Hu) try {
			...
			this.gl = null, this.canvas = null, Hu = !0, i._warn("Falling back to CPU for color/alpha splitting.", e);
		}
	}
	async update(e) {
	...
	updateCpu(e) {
		if (!this.worker) {
			let e = new Blob([`(${Wu.toString()})()`], { type: "application/javascript" }), t = URL.createObjectURL(e);
			this.worker = new Worker(t), URL.revokeObjectURL(t), this.worker.addEventListener("message", (e) => {
				let t = e.data, n = this.pendingRequests.get(t.id);
...
var Wu = () => {
	...
	constructor(e) {
		Go(e), super(e.codec), this._encoder = new Vu(this, e);
	}
	add(e, t) {
		if (!(e instanceof go)) throw TypeError("videoSample must be a VideoSample.");
	...
	constructor(e) {
		if (super(), this._connectedTrack = null, !lt.includes(e)) throw TypeError(`Invalid audio codec '${e}'. Must be one of: ${lt.join(", ")}.`);
		this._codec = e;
	}
}, qu = class extends Ku {
	constructor(e) {
	...
	constructor(e, t) {
		this.source = e, this.encodingConfig = t, this.ensureEncoderPromise = null, this.encoderInitialized = !1, this.encoder = null, this.muxer = null, this.lastNumberOfChannels = null, this.lastSampleRate = null, this.isPcmEncoder = !1, this.outputSampleSize = null, this.writeOutputValue = null, this.customEncoder = null, this.customEncoderCallSerializer = new Te(), this.customEncoderQueueSize = 0, this.lastEndSampleIndex = null, this.resampler = null, this.error = null, this.lastMuxerPromise = Promise.resolve(), this.closed = !1;
	}
	async add(e, t) {
		try {
			...
			n.transform?.numberOfChannels !== void 0 || n.transform?.sampleRate !== void 0 ? (this.resampler ||= new Iu({
	...
	async processAndEncode(e, t) {
		let n = this.encodingConfig;
		if (n.transform?.sampleFormat !== void 0 && Bo(e.format) !== n.transform.sampleFormat) {
			let r = Ho(e, n.transform.sampleFormat);
			t && e.close(), e = r, t = !0;
		}
		if (n.transform?.process) {
			...
			Array.isArray(r) || (r = [r]);
			for (let e of r) {
				if (!(e instanceof Po)) throw TypeError("The audio process function must return an AudioSample, null, or an array of AudioSamples.");
	...
	async doPcmEncoding(e, t) {
		...
		for (let e = 0; e < c.length; e++) {
			let { frameCount: t, view: n } = c[e], r = n.buffer, a = e * s, l = new R(new Uint8Array(r), "key", o + a / i, t / i);
			this.encodingConfig.onEncodedPacket?.(l, d), await this.muxer.addEncodedAudioPacket(this.source._connectedTrack, l, d);
		}
	}
	ensureEncoder(e) {
		this.ensureEncoderPromise = (async () => {
			let { numberOfChannels: t, sampleRate: n } = e, r = Xo({
				numberOfChannels: t,
				sampleRate: n,
				...this.encodingConfig
			});
			this.encodingConfig.onEncoderConfig?.(r);
			let i = us.find((e) => e.supports(this.encodingConfig.codec, r));
			...
			else if (F.includes(this.encodingConfig.codec)) this.initPcmEncoder();
			else {
				...
				this.encoder = new AudioEncoder({
					output: (e, t) => {
						if (this.encodingConfig.codec === "aac" && t?.decoderConfig) {
							let e = !1;
							if (e = !t.decoderConfig.description || t.decoderConfig.description.byteLength < 2 ? !0 : at(f(t.decoderConfig.description)).objectType === 0, e) {
								let e = Number(s(r.codec.split(".")));
								t.decoderConfig.description = ot({
									objectType: e,
						...
						let n = R.fromEncodedChunk(e);
						n = n.clone({
							timestamp: _e(n.timestamp, r.sampleRate),
							duration: e.duration == null ? void 0 : _e(n.duration, r.sampleRate)
	...
	initPcmEncoder() {
		this.isPcmEncoder = !0;
		let e = this.encodingConfig.codec, { dataType: t, sampleSize: n, littleEndian: r } = wt(e);
		switch (this.outputSampleSize = n, n) {
			case 1:
				t === "unsigned" ? this.writeOutputValue = (e, t, n) => e.setUint8(t, A((n + 1) * 127.5, 0, 255)) : t === "signed" ? this.writeOutputValue = (e, t, n) => {
					e.setInt8(t, A(Math.round(n * 128), -128, 127));
				} : t === "ulaw" ? this.writeOutputValue = (e, t, n) => {
					let r = A(Math.floor(n * 32767), -32768, 32767);
					e.setUint8(t, ds(r));
				...
				break;
			case 2:
				t === "unsigned" ? this.writeOutputValue = (e, t, n) => e.setUint16(t, A((n + 1) * 32767.5, 0, 65535), r) : t === "signed" ? this.writeOutputValue = (e, t, n) => e.setInt16(t, A(Math.round(n * 32767), -32768, 32767), r) : a(!1);
				break;
			case 3:
				t === "unsigned" ? this.writeOutputValue = (e, t, n) => me(e, t, A((n + 1) * 8388607.5, 0, 16777215), r) : t === "signed" ? this.writeOutputValue = (e, t, n) => he(e, t, A(Math.round(n * 8388607), -8388608, 8388607), r) : a(!1);
				break;
			case 4:
				t === "unsigned" ? this.writeOutputValue = (e, t, n) => e.setUint32(t, A((n + 1) * 2147483647.5, 0, 4294967295), r) : t === "signed" ? this.writeOutputValue = (e, t, n) => e.setInt32(t, A(Math.round(n * 2147483647), -2147483648, 2147483647), r) : t === "float" ? this.writeOutputValue = (e, t, n) => e.setFloat32(t, n, r) : a(!1);
				break;
			case 8:
	...
	constructor(e) {
		Jo(e), super(e.codec), this._encoder = new Ju(this, e);
	}
	add(e) {
		if (!(e instanceof Po)) throw TypeError("audioSample must be an AudioSample.");
	...
	constructor(e) {
		if (super(), this._connectedTrack = null, !ut.includes(e)) throw TypeError(`Invalid subtitle codec '${e}'. Must be one of: ${ut.join(", ")}.`);
		this._codec = e;
	}
}, Zu = class {
	getSupportedVideoCodecs() {
		return this.getSupportedCodecs().filter((e) => st.includes(e));
	}
	...
	_codecUnsupportedHint(e) {
		return new td().getSupportedCodecs().includes(e) ? " Switching to MOV will grant support for this codec." : "";
	}
}, ed = class extends Qu {
	constructor(e) {
		super(e);
	...
	_codecUnsupportedHint(e) {
		return new $u().getSupportedCodecs().includes(e) ? " Switching to MP4 will grant support for this codec." : "";
	}
}, nd = class extends Zu {
	constructor(e = {}) {
		if (!e || typeof e != "object") throw TypeError("options must be an object.");
	...
	getSupportedCodecs() {
		return [
			...
			...lt.filter((e) => ["opus", "vorbis"].includes(e)),
			...ut
		];
	}
	get _name() {
	...
	_codecUnsupportedHint(e) {
		return new nd().getSupportedCodecs().includes(e) ? " Switching to MKV will grant support for this codec." : "";
	}
}, id = class extends Zu {
	constructor(e = {}) {
		if (!e || typeof e != "object") throw TypeError("options must be an object.");
	...
	getSupportedCodecs() {
		return [...lt.filter((e) => ["vorbis", "opus"].includes(e))];
	}
	get supportsVideoRotationMetadata() {
		return !1;
	}
	...
	canBePairedWith(t) {
		...
		if (this === t) return !1;
		let n = Ye(this.metadata.group), r = Ye(t.metadata.group);
	...
	if (e.languageCode !== void 0 && !Se(e.languageCode)) throw TypeError("metadata.languageCode, when provided, must be a three-letter, ISO 639-2/T language code.");
	if (e.name !== void 0 && typeof e.name != "string") throw TypeError("metadata.name, when provided, must be a string.");
	if (e.disposition !== void 0 && it(e.disposition), e.maximumPacketCount !== void 0 && (!Number.isInteger(e.maximumPacketCount) || e.maximumPacketCount < 0)) throw TypeError("metadata.maximumPacketCount, when provided, must be a non-negative integer.");
	if (e.group !== void 0 && !(e.group instanceof pd) && (!Array.isArray(e.group) || e.group.some((e) => !(e instanceof pd)))) throw TypeError("metadata.group, when provided, must be an OutputTrackGroup instance or an array of OutputTrackGroup instances.");
}, hd = class extends Xe {
	get target() {
	...
	constructor(e) {
		if (super(), this.state = "pending", this.defaultTrackGroup = new pd(), this._onFinalize = null, this._unfinalizedTargets = /* @__PURE__ */ new Set(), this._rootWriterPromise = null, this._tracks = [], this._startPromise = null, this._cancelPromise = null, this._finalizePromise = null, this._mutex = new w(), this._metadataTags = {}, this._rootTarget = null, this._rootTargetPromise = null, this._firstMediaStreamTimestamp = null, !e || typeof e != "object") throw TypeError("options must be an object.");
		if (!(e.format instanceof Zu)) throw TypeError("options.format must be an OutputFormat.");
		if (!(e.target instanceof fu || e.target instanceof vu)) throw TypeError("options.target must be a Target or a PathedTarget.");
		if (e.target instanceof fu && this._rememberTarget(e.target), e.initTarget !== void 0 && !(e.initTarget instanceof fu) && typeof e.initTarget != "function") throw Error("options.initTarget, when provided, must be a Target or a function that returns or resolves to a Target.");
		if (e.onFinalize !== void 0 && typeof e.onFinalize != "function") throw TypeError("options.onFinalize, when provided, must be a function.");
		this.format = e.format, this._target = e.target, this._onFinalize = e.onFinalize ?? null, this._initTarget = e.initTarget ?? null, this._initTarget instanceof fu && this._rememberTarget(this._initTarget), this._muxer = e.format._createMuxer(this);
	}
	_getTargetValidated(e) {
		a(this._target instanceof vu);
		let t = this._target.getTarget(e), n = (e) => {
			if (!(e instanceof fu)) throw TypeError("getTarget must return a Target.");
			return e;
		};
		return t instanceof Promise ? t.then(n) : n(t);
	}
	...
	async _getInitTarget() {
		if (a(this._initTarget !== null), this._initTarget instanceof fu) return this._initTarget;
	...
	_getRootTarget() {
		...
		if (this._target instanceof fu) return this._emit("target", {
			target: this._target,
			request: null,
			isRoot: !0
	...
	_getRootWriter(e) {
		return this._rootWriterPromise ??= (async () => {
			let t = await this._getRootTarget(), n = new du(t, typeof e == "boolean" ? e : e(t));
			return n.start(), n;
		})();
	}
	addVideoTrack(e, t = {}) {
		if (!(e instanceof Ru)) throw TypeError("source must be a VideoSource.");
		if (md(t), t.rotation !== void 0 && ![
			0,
			90,
			180,
			270
	...
	addAudioTrack(e, t = {}) {
		if (!(e instanceof Ku)) throw TypeError("source must be an AudioSource.");
		md(t);
		let n = { ...t };
		return n.group ??= this.defaultTrackGroup, this._addTrack(new dd(this._tracks.length + 1, this, e, n));
	}
	addSubtitleTrack(e, t = {}) {
		if (!(e instanceof Xu)) throw TypeError("source must be a SubtitleSource.");
		md(t);
		let n = { ...t };
		return n.group ??= this.defaultTrackGroup, this._addTrack(new fd(this._tracks.length + 1, this, e, n));
	}
	setMetadataTags(e) {
		if (tt(e), this.state !== "pending") throw Error("Cannot set metadata tags after output has been started or canceled.");
	...
	if (e?.codec !== void 0 && !st.includes(e.codec)) throw TypeError(`options.video.codec, when provided, must be one of: ${st.join(", ")}.`);
	if (e?.bitrate !== void 0 && !(e.bitrate instanceof Zo) && (!Number.isInteger(e.bitrate) || e.bitrate <= 0)) throw TypeError("options.video.bitrate, when provided, must be a positive integer or a quality.");
	...
	if (e?.crop !== void 0 && wo(e.crop, "options.video."), e?.frameRate !== void 0 && (!Number.isFinite(e.frameRate) || e.frameRate <= 0)) throw TypeError("options.video.frameRate, when provided, must be a finite positive number.");
	...
	if (e?.group !== void 0 && !(e.group instanceof pd || Array.isArray(e.group) && e.group.every((e) => e instanceof pd))) throw TypeError("options.video.group, when provided, must be an OutputTrackGroup or an array of OutputTrackGroups.");
}, _d = (e) => {
	...
	if (e?.codec !== void 0 && !lt.includes(e.codec)) throw TypeError(`options.audio.codec, when provided, must be one of: ${lt.join(", ")}.`);
	if (e?.bitrate !== void 0 && !(e.bitrate instanceof Zo) && (!Number.isInteger(e.bitrate) || e.bitrate <= 0)) throw TypeError("options.audio.bitrate, when provided, must be a positive integer or a quality.");
	...
	if (e?.group !== void 0 && !(e.group instanceof pd || Array.isArray(e.group) && e.group.every((e) => e instanceof pd))) throw TypeError("options.audio.group, when provided, must be an OutputTrackGroup or an array of OutputTrackGroups.");
}, vd = 2, yd = 48e3, bd = class e {
	static async init(t) {
		let n = new e(t);
	...
	constructor(e) {
		if (this._addedCounts = {
			...
			audio: 0,
			subtitle: 0
		}, this._totalTrackCount = 0, this._nextOutputTrackId = 0, this._outputTrackIds = [], this._outputOwnTrackGroups = [], this._trackPromises = [], this._executed = !1, this._synchronizer = new Cd(), this._totalDuration = null, this._maxTimestamps = /* @__PURE__ */ new Map(), this._canceled = !1, this.onProgress = void 0, this._computeProgress = !1, this._lastProgress = 0, this.isValid = !1, this.utilizedTracks = [], this.discardedTracks = [], !e || typeof e != "object") throw TypeError("options must be an object.");
		if (!(e.input instanceof Bs)) throw TypeError("options.input must be an Input.");
		if (!(e.output instanceof hd)) throw TypeError("options.output must be an Output.");
		...
		if (e.video !== void 0 && typeof e.video != "function") if (Array.isArray(e.video)) for (let t of e.video) gd(t);
		else gd(e.video);
		if (e.audio !== void 0 && typeof e.audio != "function") if (Array.isArray(e.audio)) for (let t of e.audio) _d(t);
		else _d(e.audio);
		...
		if (typeof e.tags == "object" && tt(e.tags), e.showWarnings !== void 0 && typeof e.showWarnings != "boolean") throw TypeError("options.showWarnings, when provided, must be a boolean.");
		this._options = e, this.input = e.input, this.output = e.output;
		let { promise: t, resolve: n } = E();
		this._started = t, this._start = n;
	}
	async _init() {
		let e = await this.input.getFormat(), t, n = this._options.tracks;
		n === void 0 && (n = e.name.includes("(HLS)") ? "primary" : "all"), n === "all" ? t = await this.input.getTracks() : n === "primary" ? t = [await this.input.getPrimaryVideoTrack(), await this.input.getPrimaryAudioTrack()].filter((e) => e !== null) : (O(n), a(!1));
		...
		for (let e of t) {
			...
			if (e.isVideoTrack()) if (this._options.video) if (typeof this._options.video == "function") {
				...
				if (Array.isArray(n)) for (let e of n) _d(e);
				else _d(n);
...
Tracks were discarded because your environment is not able to encode any of the following codecs: ${n.map((e) => `'${e}'`).join(", ")}.`), n.includes("mp3") && e.push("\nThe @mediabunny/mp3-encoder extension package provides support for encoding MP3."), n.includes("aac") && e.push("\nThe @mediabunny/aac-encoder extension package provides support for encoding AAC."), (n.includes("ac3") || n.includes("eac3")) && e.push("\nThe @mediabunny/ac3 extension package provides support for encoding and decoding AC-3/E-AC-3."), n.includes("flac") && e.push("\nThe @mediabunny/flac-encoder extension package provides support for encoding FLAC.");
	...
	async execute() {
		...
		if (this._canceled) throw new xd();
	...
	async _processVideoTrack(e, t, n) {
		...
		t.width !== void 0 && t.height === void 0 ? (y = Ze(t.width), b = Ze(Math.round(y / x))) : t.width === void 0 && t.height !== void 0 ? (b = Ze(t.height), y = Ze(Math.round(b * x))) : t.width !== void 0 && t.height !== void 0 && (y = Ze(t.width), b = Ze(t.height));
		let S = await e.getFirstTimestamp(), C = this.output.format.getSupportedVideoCodecs(), ee = !!t.forceTranscode || S < this._startTimestamp || !!t.frameRate || t.keyFrameInterval !== void 0 || t.process !== void 0 || t.bitrate !== void 0 || !C.includes(r) || t.codec && t.codec !== r || y !== _ || b !== v || l !== 0 && !d || !!g, te = t.alpha ?? "discard";
		if (ee) {
			...
			let r = t.bitrate ?? ts, m = await os(C, {
			...
			if (!x) {
				...
				let r = await new Ds(e).getSample(S);
				if (r) try {
			...
			t.frameRate && (h.transform.frameRate = t.frameRate), t.process && (h.transform.process = t.process), x && (u = 0, h.transform.width = y, h.transform.height = b, h.transform.fit = t.fit ?? "fill", h.transform.rotate = o(l - c), h.transform.crop = g, h.transform.alpha = te);
			let ee = null;
			h.onEncodedSample = (e) => {
				ee = e.timestamp;
			};
			...
			s = w, this._trackPromises.push((async () => {
				...
				for await (let e of t.samples(this._startTimestamp, this._endTimestamp)) {
					...
					e.setTimestamp(t), this._reportProgress(n, e.timestamp + e.duration), await w.add(e), ee !== null && this._synchronizer.shouldWait(n, ee) && await this._synchronizer.wait(ee), e.close();
				}
				w.close(), this._synchronizer.closeTrack(n);
			})());
		} else {
			let t = new Bu(r);
			s = t, this._trackPromises.push((async () => {
				await this._started;
				let r = new vs(e), i = { decoderConfig: await e.getDecoderConfig() ?? void 0 };
				for await (let e of r.packets(void 0, void 0, { verifyKeyPackets: !0 })) {
					...
					let r = e.clone({
						...
						sideData: te === "discard" ? {} : e.sideData
					});
		...
		let w = null;
		t.group || (w = new pd());
		let ne = await e.getLanguageCode();
		this.output.addVideoTrack(s, {
			frameRate: t.frameRate,
			languageCode: Se(ne) ? ne : void 0,
			name: await e.getName() ?? void 0,
			disposition: await e.getDisposition(),
			rotation: u,
			group: w ?? t.group
		}), this._addedCounts.video++, this._totalTrackCount++, this.utilizedTracks.push(e), this._outputTrackIds.push(n), this._outputOwnTrackGroups.push(w);
	}
	async _processAudioTrack(e, t, n) {
		...
		if (!t.forceTranscode && !t.bitrate && l === o && u === s && !d && !f && p.includes(r) && (!t.codec || t.codec === r) && !t.process && t.sampleFormat === void 0) {
			...
			let d = t.bitrate ?? ts, m = await as(p, {
			...
			if (!m.some((e) => ct.includes(e)) && p.some((e) => ct.includes(e)) && (l !== vd || u !== yd)) {
				let e = (await as(p, {
					numberOfChannels: vd,
					sampleRate: yd,
					bitrate: d
				})).find((e) => ct.includes(e));
				e && (r = e, l = vd, u = yd);
			} else r = m[0] ?? null;
			if (r === null) {
				this.discardedTracks.push({
			...
			i = _, this._trackPromises.push((async () => {
				if (await this._started, f) {
					let e = c - this._startTimestamp, t = Math.round(e * s), r = new Po({
	...
	_reportProgress(e, t) {
		...
		let n = Math.min(...this._maxTimestamps.values()), r = A(n / this._totalDuration, 0, 1);
	...
	shouldWait(e, t) {
		...
		return a(n !== void 0), this.maxTimestamps.set(e, Math.max(t, n)), t - this.computeMinAndMaybeResolve() > Sd;
	}
	wait(e) {
		let { promise: t, resolve: n } = E();
	...
	computeMinAndMaybeResolve() {
		...
		for (let t = 0; t < this.resolvers.length; t++) {
			...
			n.timestamp - e < Sd && (n.resolve(), this.resolvers.splice(t, 1), t--);
		}
		return e;
	}
}, wd = 12, Td = 8, Ed = 1, Dd = 4, Od = 4;
function kd({ root: e, formatBytes: t, revealLoadedSection: n }) {
	function r(t, n) {
		let r = e.getElementById(t);
		if (!r) throw Error(`DOM element not found: #${t} (expected ${n})`);
		return r;
	}
	let i = r("image-canvas-stage", "div#image-canvas-stage"), a = r("image-preview-canvas", "canvas#image-preview-canvas"), o = r("image-mask-canvas", "canvas#image-mask-canvas"), s = r("img-meta-name", "span#img-meta-name"), c = r("img-meta-size", "span#img-meta-size"), l = r("img-meta-resolution", "span#img-meta-resolution"), u = r("img-meta-aspect", "span#img-meta-aspect"), d = r("img-meta-type", "span#img-meta-type"), f = r("img-enable-crop", "input#img-enable-crop"), p = r("img-tool-crop", "input#img-tool-crop"), m = r("img-tool-paint", "input#img-tool-paint"), h = r("img-crop-x", "input#img-crop-x"), g = r("img-crop-y", "input#img-crop-y"), _ = r("img-crop-width", "input#img-crop-width"), v = r("img-crop-height", "input#img-crop-height"), y = r("img-crop-full", "button#img-crop-full"), b = r("img-crop-square", "button#img-crop-square"), x = r("img-enable-resize", "input#img-enable-resize"), S = r("img-out-width", "input#img-out-width"), C = r("img-out-height", "input#img-out-height"), ee = r("img-scale-preset", "select#img-scale-preset"), te = r("img-maxdim-preset", "select#img-maxdim-preset"), w = r("img-lock-aspect", "input#img-lock-aspect"), ne = r("img-enable-blur", "input#img-enable-blur"), re = r("img-redaction-mode", "select#img-redaction-mode"), ie = r("img-brush-size", "input#img-brush-size"), ae = r("img-blur-strength", "input#img-blur-strength"), oe = r("img-erase-mode", "input#img-erase-mode"), T = r("img-clear-mask", "button#img-clear-mask"), se = r("img-out-format", "select#img-out-format"), E = r("img-quality", "input#img-quality"), ce = r("img-quality-label", "span#img-quality-label"), le = r("image-form", "form#image-form"), ue = r("image-result-section", "section#image-result-section"), de = r("image-output-placeholder", "div#image-output-placeholder"), D = r("image-download-anchor", "a#image-download-anchor"), O = r("image-output-size-tag", "span#image-output-size-tag"), fe = r("image-output-preview", "img#image-output-preview"), pe = null, me = null, he = null, k = null, A = 0, j = 0, ge = null, _e = null, ve = !1, ye = null, be = !1, xe = {
		scale: 1,
		offsetX: 0,
		offsetY: 0,
		drawWidth: 0,
	...
	function Ce() {
		ge &&= (URL.revokeObjectURL(ge), null), _e &&= (URL.revokeObjectURL(_e), null);
	}
	function we(e, t, n) {
	...
	function Te() {
		...
		let e = we(parseInt(h.value) || 0, 0, A - 1), t = we(parseInt(g.value) || 0, 0, j - 1), n = we(parseInt(_.value) || A, 1, A - e), r = we(parseInt(v.value) || j, 1, j - t);
	...
	function De() {
		let e = Te(), { offsetX: t, offsetY: n, scale: r } = xe;
		return {
			x: t + e.x * r,
			y: n + e.y * r,
			width: e.width * r,
	...
	function ke(e) {
		let t = we(e.x, 0, Math.max(0, A - 1)), n = we(e.y, 0, Math.max(0, j - 1)), r = we(e.width, 1, Math.max(1, A - t)), i = we(e.height, 1, Math.max(1, j - n));
	...
	function Ae(e, t) {
		...
		for (let [n, i, a] of r) if (Math.hypot(e - i, t - a) <= wd) return n;
		if (e >= n.x && e <= n.x + n.width && t >= n.y && t <= n.y + n.height) return "move";
		let { offsetX: i, offsetY: a, drawWidth: o, drawHeight: s } = xe;
		return e >= i && e <= i + o && t >= a && t <= a + s ? "new" : null;
	}
	function je() {
		let e = o.getContext("2d");
		e.clearRect(0, 0, o.width, o.height), !(!he || !ne.checked) && e.drawImage(he, 0, 0, o.width, o.height);
	}
	function Me() {
		if (!me) return;
		let e = i.getBoundingClientRect(), t = Math.max(1, Math.floor(e.width));
		if (t <= 1) return;
		let n = t / A, r = t, s = Math.max(1, Math.floor(j * n));
		i.style.height = `${s}px`, xe = {
			scale: n,
			offsetX: 0,
			offsetY: 0,
			drawWidth: r,
			drawHeight: s
		}, Ee(r, s), a.style.left = "0px", a.style.top = "0px", o.style.left = "0px", o.style.top = "0px";
		let c = a.getContext("2d");
		if (c.clearRect(0, 0, r, s), c.drawImage(me, 0, 0, r, s), f.checked) {
			let e = Te(), t = e.x * n, r = e.y * n, i = e.width * n, a = e.height * n;
	...
	function Ne() {
		!k || !he || (k.clearRect(0, 0, he.width, he.height), je());
	}
	function Pe(e, t) {
		let n = Oe(e, t), r = n.x, i = n.y, { offsetX: a, offsetY: o, scale: s, drawWidth: c, drawHeight: l } = xe;
	...
	function Fe(e, t) {
		if (!k) return;
		let n = parseInt(ie.value) || 40;
		k.save(), k.lineCap = "round", k.lineJoin = "round", k.lineWidth = Math.max(2, n / Math.max(.1, xe.scale)), k.globalCompositeOperation = oe.checked ? "destination-out" : "source-over", k.strokeStyle = "rgba(255, 72, 72, 0.82)", k.beginPath(), k.moveTo(e.x, e.y), k.lineTo(t.x, t.y), k.stroke(), k.restore(), je();
	}
	function Ie() {
		h.value = "0", g.value = "0", _.value = String(A || 1), v.value = String(j || 1), S.value = _.value, C.value = v.value;
	}
	function Le() {
		let e = Te();
	...
	function Be() {
		let e = f.checked, t = ne.checked;
		p.disabled = !e, m.disabled = !t, p.checked && !e && (p.checked = !1, t && (m.checked = !0)), m.checked && !t && (m.checked = !1, e && (p.checked = !0)), !p.checked && !m.checked && (e ? p.checked = !0 : t && (m.checked = !0)), ze();
	}
	function Ve() {
		let e = parseFloat(E.value).toFixed(2);
		ce.textContent = se.value === "image/png" ? "Lossless" : e, E.disabled = se.value === "image/png";
	}
	function He(e) {
		if (!Number.isFinite(e) || e <= 0) return;
		let t = Te(), n = Math.max(1, Math.round(t.width * e)), r = Math.max(1, Math.round(t.height * e));
		x.checked = !0, S.value = String(n), C.value = String(r);
	}
	function Ue(e) {
		if (!Number.isFinite(e) || e <= 0) return;
		let t = Te(), n = Math.max(t.width, t.height), r = n > 0 ? e / n : 1, i = Math.max(1, Math.round(t.width * r)), a = Math.max(1, Math.round(t.height * r));
		x.checked = !0, S.value = String(i), C.value = String(a);
	}
	function We(e) {
		if (!Se) return;
		let { handle: t, startPoint: n, startCrop: r } = Se, i = e.x - n.x, a = e.y - n.y;
		if (t === "move") {
			ke({
				x: r.x + i,
				y: r.y + a,
		...
		if (t === "new") {
			...
			ke({
				x: t,
				y: r,
				width: Math.max(Td, i - t),
				height: Math.max(Td, a - r)
			});
			return;
		}
		let o = r.x, s = r.y, c = r.width, l = r.height, u = r.x + r.width, d = r.y + r.height;
		(t === "nw" || t === "sw") && (o = Math.min(e.x, u - Td), c = u - o), (t === "ne" || t === "se") && (c = Math.max(Td, e.x - r.x)), (t === "nw" || t === "ne") && (s = Math.min(e.y, d - Td), l = d - s), (t === "sw" || t === "se") && (l = Math.max(Td, e.y - r.y)), ke({
			x: o,
			y: s,
			width: c,
			height: l
	...
	function qe() {
		me &&= (me.close(), null), he = null, k = null, A = 0, j = 0, pe = null, ve = !1, ye = null, Se = null, Ce();
	}
	async function Je(e) {
		qe(), pe = e, ue.style.display = "none", de.style.display = "", ge = URL.createObjectURL(e), me = await createImageBitmap(e), A = me.width, j = me.height, he = document.createElement("canvas"), he.width = A, he.height = j, k = he.getContext("2d"), s.textContent = e.name, c.textContent = t(e.size), l.textContent = `${A}x${j}`, u.textContent = `${(A / j).toFixed(2)}:1`, d.textContent = e.type || "image/*", fe.src = "", Ie(), Ne(), Be(), Ve(), n(), Me(), requestAnimationFrame(() => {
			Me();
		}), console.log(`Loaded image file: "${e.name}" (${A}x${j})`);
	}
	function Ye(e) {
		be = e, ze();
	}
	[
		...
		Be(), Le(), Me();
	}), p.addEventListener("change", ze), m.addEventListener("change", ze), y.addEventListener("click", () => {
		Ie(), Me();
	}), b.addEventListener("click", () => {
		let e = Math.min(A, j), t = Math.floor((A - e) / 2), n = Math.floor((j - e) / 2);
		h.value = String(t), g.value = String(n), _.value = String(e), v.value = String(e), Le(), Me();
	}), x.addEventListener("change", () => {
		Le();
	}), ee.addEventListener("change", () => {
		let e = parseFloat(ee.value);
		Number.isNaN(e) || He(e);
	}), te.addEventListener("change", () => {
		let e = parseInt(te.value);
		Number.isNaN(e) || Ue(e);
	}), S.addEventListener("input", () => {
		if (!w.checked) return;
		let e = Te(), t = parseInt(S.value) || e.width, n = e.width / e.height;
		C.value = String(Math.max(1, Math.round(t / n)));
	}), C.addEventListener("input", () => {
		if (!w.checked) return;
		let e = Te(), t = parseInt(C.value) || e.height, n = e.width / e.height;
		...
		if (!me) return;
		let t = Pe(e.clientX, e.clientY);
		if (!t) return;
		let n = Re();
		if (n === "crop") {
			if (!f.checked) return;
			let n = Oe(e.clientX, e.clientY), r = Ae(n.x, n.y);
			if (!r) return;
			Se = {
				handle: r,
				startPoint: t,
	...
	let Xe = () => {
		ve = !1, ye = null, Se = null;
	}, Ze = (e) => {
		e?.pointerId !== void 0 && o.releasePointerCapture(e.pointerId), Xe();
	};
	return o.addEventListener("pointerup", Ze), o.addEventListener("pointercancel", Ze), o.addEventListener("pointerleave", Xe), window.addEventListener("resize", () => {
		be && Me();
	}), le.addEventListener("submit", async (e) => {
		if (e.preventDefault(), !pe || !me) {
			alert("Please load an image first.");
			return;
		}
		try {
			let e = Te(), n = document.createElement("canvas");
			n.width = e.width, n.height = e.height;
			let r = n.getContext("2d");
			if (r.drawImage(me, e.x, e.y, e.width, e.height, 0, 0, e.width, e.height), ne.checked && he && k) {
				let t = Math.max(Ed, parseInt(ae.value) || Dd), i = document.createElement("canvas");
				i.width = e.width, i.height = e.height, i.getContext("2d").drawImage(he, e.x, e.y, e.width, e.height, 0, 0, e.width, e.height);
				let a = document.createElement("canvas");
				a.width = e.width, a.height = e.height;
				let o = a.getContext("2d");
				if (re.value === "pixelate") {
					let r = Math.max(Od, t), i = Math.max(1, Math.round(e.width / r)), a = Math.max(1, Math.round(e.height / r)), s = document.createElement("canvas");
				...
				} else re.value === "black" ? (o.fillStyle = "#000000", o.fillRect(0, 0, e.width, e.height)) : (o.filter = `blur(${t}px)`, o.drawImage(n, 0, 0), o.filter = "none");
			...
			let a = se.value, o = a === "image/png" ? void 0 : parseFloat(E.value), s;
			try {
				s = await Ke(i, a, o);
			} catch {
				console.warn(`Primary output format ${a} was unsupported. Falling back to JPEG.`), s = await Ke(i, "image/jpeg", .9);
			}
			_e && URL.revokeObjectURL(_e), _e = URL.createObjectURL(s);
			let c = Ge(s.type || a), l = pe.name.lastIndexOf("."), u = l > 0 ? pe.name.slice(0, l) : pe.name;
			D.href = _e, D.download = `${u}_web_export.${c}`, O.textContent = `Size: ${t(s.size)}`, fe.src = _e, de.style.display = "none", ue.style.display = "block", ue.scrollIntoView({ behavior: "smooth" }), console.log(`Image processing complete. Output: ${t(s.size)} (${c.toUpperCase()})`);
		} catch (e) {
...
function Ld(e, t) {
	let n = t === "mp4" ? [{
		value: "avc",
		label: "H.264 / AVC (High compatibility)"
	}, {
		value: "hevc",
		label: "H.265 / HEVC (High compression)"
	}] : t === "webm" ? [
		{
			value: "vp9",
			label: "VP9 (Modern WebM Open-source)"
		},
		{
			value: "vp8",
			label: "VP8 (Legacy compatibility)"
		},
		{
			value: "av1",
			label: "AV1 (Ultra Next-Gen Format)"
		}
	] : [];
	e.innerHTML = "", n.forEach((t, n) => {
		let r = document.createElement("option");
		r.value = t.value, r.textContent = t.label, n === 0 && (r.selected = !0), e.appendChild(r);
	});
}
function Rd(e) {
	return e === "webm" ? {
...
//#endregion
//#region src/trimController.ts
function zd(e) {
	let { media: t, enable: n, controlsGroup: r, startInput: i, endInput: a, startLabel: o, endLabel: s, selectionBar: c, onChange: l } = e, u = 0, d = !1;
	function f(e, t) {
		o.textContent = `${e.toFixed(2)}s`, s.textContent = `${t.toFixed(2)}s`, u && (c.style.left = `${e / u * 100}%`, c.style.width = `${(t - e) / u * 100}%`), l?.();
	}
	return n.addEventListener("change", () => {
		if (n.checked) {
			r.style.display = "block", t.pause();
			let e = parseFloat(i.value);
			f(e, parseFloat(a.value)), t.currentTime = e;
		} else r.style.display = "none", l?.();
	}), i.addEventListener("input", () => {
		d = !0, t.pause();
		let e = parseFloat(i.value), n = parseFloat(a.value);
		e >= n && (e = Math.max(0, n - .05), i.value = String(e)), i.style.zIndex = "3", a.style.zIndex = "2", f(e, n), t.currentTime = e;
	}), a.addEventListener("input", () => {
		d = !0, t.pause();
		let e = parseFloat(i.value), n = parseFloat(a.value);
		n <= e && (n = Math.min(u, e + .05), a.value = String(n)), i.style.zIndex = "2", a.style.zIndex = "3", f(e, n), t.currentTime = n;
	}), [i, a].forEach((e) => [
		"change",
		"mouseup",
		"touchend"
		...
		if (!n.checked || d) return;
		let e = parseFloat(i.value), r = parseFloat(a.value);
		t.currentTime >= r && (t.pause(), t.currentTime = e);
	}), t.addEventListener("play", () => {
		if (!n.checked) return;
		let e = parseFloat(i.value), r = parseFloat(a.value);
		(t.currentTime < e || t.currentTime >= r) && (t.currentTime = e);
	}), {
		setDuration(e) {
			u = e, i.max = String(e), a.max = String(e), i.value = "0", a.value = String(e), f(0, e);
		},
		isEnabled: () => n.checked,
		getRange: () => n.checked ? {
			start: parseFloat(i.value),
			end: parseFloat(a.value)
		} : null
	};
}
//#endregion
...
function Vd({ root: e, formatBytes: t, revealLoadedSection: n }) {
	function r(t, n) {
		let r = e.getElementById(t);
		if (!r) throw Error(`DOM element not found: #${t} (expected ${n})`);
		return r;
	}
	let i = r("audio-preview", "audio#audio-preview"), a = r("audio-waveform", "canvas#audio-waveform"), o = r("audio-meta-name", "span"), s = r("audio-meta-size", "span"), c = r("audio-meta-duration", "span"), l = r("audio-meta-codec", "span"), u = r("audio-meta-samplerate", "span"), d = r("audio-meta-channels", "span"), f = r("audio-meta-bitrate", "span"), p = r("audio-form", "form#audio-form"), m = r("audio-enable-trim", "input"), h = r("audio-trim-controls", "div"), g = r("audio-trim-start", "input"), _ = r("audio-trim-end", "input"), v = r("audio-trim-start-val", "span"), y = r("audio-trim-end-val", "span"), b = r("audio-trim-selection-bar", "div"), x = r("audio-out-format", "select"), S = r("audio-out-bitrate", "select"), C = r("audio-out-samplerate", "select"), ee = r("audio-out-channels", "select"), te = r("audio-process-btn", "button"), w = r("audio-cancel-btn", "button"), ne = r("audio-size-estimate", "strong"), re = r("audio-output-placeholder", "div"), ie = r("audio-progress-section", "section"), ae = r("audio-progress-title", "span"), oe = r("audio-progress-pct", "strong"), T = r("audio-progress", "progress"), se = r("audio-result-section", "section"), E = r("audio-output-preview", "audio"), ce = r("audio-download-anchor", "a"), le = r("audio-output-size-tag", "span"), ue = null, de = null, D = 0, O = null, fe = null, pe = null, me = [], he = null, k = 0;
	function A() {
		fe &&= (URL.revokeObjectURL(fe), null), pe &&= (URL.revokeObjectURL(pe), null);
	}
	function j() {
		return Bd[x.value] || Bd.mp3;
	}
	function ge() {
		if (!D) {
			ne.textContent = "—";
		...
		let n = j(), r;
		r = n.ext === "wav" ? (parseInt(C.value) || 44100) * (parseInt(ee.value) || 2) * 2 * e : n.lossless ? (parseInt(C.value) || 44100) * (parseInt(ee.value) || 2) * 2 * e * .6 : (parseInt(S.value) || 192e3) * e / 8, ne.textContent = "≈ " + t(r);
	}
	function _e() {
		S.disabled = j().lossless, ge();
	}
	async function ve() {
	...
	function ye() {
		...
		if (m.checked && D) {
			let n = parseFloat(g.value) / D * e, i = parseFloat(_.value) / D * e;
		...
		if (D && i.currentTime > 0) {
			let n = i.currentTime / D * e;
	...
	async function be(e, t) {
		...
		try {
			...
			he ||= new (window.AudioContext || window.webkitAudioContext)();
			let r = await he.decodeAudioData(n);
			if (t !== k) return;
	...
	a.addEventListener("click", (e) => {
		...
		i.currentTime = Math.max(0, Math.min(1, (e.clientX - t.left) / t.width)) * D, ye();
	}), i.addEventListener("timeupdate", () => ye()), window.addEventListener("resize", () => ye());
	async function xe(e) {
		Ce(), ue = e, se.style.display = "none", re.style.display = "", ie.style.display = "none", fe = URL.createObjectURL(e), i.src = fe, be(e, ++k), o.textContent = e.name, s.textContent = t(e.size);
		try {
			de = new Bs({
				formats: ao,
				source: new Oa(e)
			});
			let t = await de.getFormat();
			console.log(`Detected audio container: ${t.name} (${t.mimeType})`);
			let r = await de.getPrimaryAudioTrack();
			if (!r) {
				l.textContent = "No audio track", console.warn("No audio track found in this file."), n();
				return;
			}
			let i = await r.getCodec();
			if (D = await de.computeDuration(), l.textContent = String(i || "unknown").toUpperCase(), c.textContent = jd(D), u.textContent = r.sampleRate ? `${r.sampleRate.toLocaleString()} Hz` : "-", d.textContent = String(r.numberOfChannels || "-"), D > 0) {
				let t = e.size * 8 / D / 1e3;
				f.textContent = `~${Math.round(t)} kbps`;
			} else f.textContent = "-";
			Se.setDuration(D), console.log(`Loaded audio: "${e.name}" — ${jd(D)}, ${r.sampleRate}Hz, ${r.numberOfChannels}ch.`), n(), _e();
		} catch (e) {
	...
	x.addEventListener("change", _e), p.addEventListener("input", ge), p.addEventListener("change", ge), p.addEventListener("submit", async (e) => {
		if (e.preventDefault(), !ue || !de) {
			alert("Please load an audio file first.");
			return;
		}
		te.style.display = "none", w.style.display = "inline-block", ie.style.display = "block", se.style.display = "none", re.style.display = "none", T.value = 0, oe.textContent = "0%", ae.textContent = "🎵 Initializing audio pipeline...";
		try {
			let e = j(), n = new hu(), r = new hd({
				format: e.makeFormat(),
				target: n
			}), i = {
				forceTranscode: !0,
			...
			if (O = await bd.init({
				...
				audio: i,
				trim: s
			}), !O.isValid) throw O.discardedTracks.forEach((e) => console.warn(`Track discarded: ${e.reason}`)), Error("This audio format/codec combination is not supported.");
			O.onProgress = (e) => {
				let t = Math.min(100, Math.round(e * 100));
				T.value = t, oe.textContent = `${t}%`, ae.textContent = `🎵 Transcoding audio (${t}%)`;
			}, console.log(`🚀 Converting audio to ${e.ext.toUpperCase()} (${e.codec})...`), await O.execute();
			let c = n.buffer;
			if (!c) throw Error("Conversion produced an empty buffer.");
			let l = new Blob([c], { type: e.mime });
			pe && URL.revokeObjectURL(pe), pe = URL.createObjectURL(l);
			let u = ue.name.lastIndexOf("."), d = u > 0 ? ue.name.slice(0, u) : ue.name;
			ce.href = pe, ce.download = `${d}_web_export.${e.ext}`, E.src = pe, le.textContent = `Size: ${t(l.size)}`, console.log(`🎉 Audio conversion complete! Output: ${t(l.size)} (${e.ext.toUpperCase()}).`), se.style.display = "block", se.scrollIntoView({ behavior: "smooth" });
		} catch (e) {
			...
			te.style.display = "inline-block", w.style.display = "none", ie.style.display = "none", se.style.display === "none" && (re.style.display = ""), O = null;
		}
	}), w.addEventListener("click", async () => {
		O && (console.log("Requesting cancellation of audio conversion..."), await O.cancel());
	});
	function Ce() {
		de &&= (de.dispose(), null), A(), i.removeAttribute("src"), E.removeAttribute("src"), D = 0, ue = null, k++, me = [], ye();
	}
	function we(e) {
		e || i.pause();
	}
...
function Ud(e) {
	let t = 4294967295;
	for (let n = 0; n < e.length; n++) t = Hd[(t ^ e[n]) & 255] ^ t >>> 8;
	return (t ^ 4294967295) >>> 0;
}
var $ = (e) => new Uint8Array([e & 255, e >>> 8 & 255]), Wd = (e) => new Uint8Array([
	e & 255,
	e >>> 8 & 255,
	e >>> 16 & 255,
	e >>> 24 & 255
...
function Kd(e) {
	...
	for (let o of e) {
		let e = t.encode(o.name), s = Ud(o.data), c = o.data.length, l = Gd([
			Wd(67324752),
			$(20),
			$(a),
			$(0),
...
//#endregion
//#region src/batchShared.ts
function qd(e) {
	let { elements: t, zipName: n, processButtonLabel: r, makeThumb: i, process: a } = e, o = [], s = [];
	function c() {
		o.forEach((e) => e.url && URL.revokeObjectURL(e.url)), s.forEach((e) => e.startsWith("blob:") && URL.revokeObjectURL(e)), s = [];
	}
	function l(e) {
		return e.status === "pending" ? "Pending" : e.status === "processing" ? `Processing… ${Math.round(e.progress * 100)}%` : e.status === "error" ? `Error: ${e.error || "failed"}` : e.blob ? Ad(e.blob.size) : "Done";
	}
	function u() {
		t.count.textContent = String(o.length), t.queue.innerHTML = "", o.forEach((e, n) => {
			let r = document.createElement("div");
			r.className = "batch-item", r.dataset.status = e.status;
			let i = document.createElement("span");
			i.className = "batch-item-name", i.textContent = e.file.name;
			let a = document.createElement("span");
			if (a.className = "batch-item-status", a.textContent = l(e), r.append(i, a), e.status === "done" && e.url) {
				let t = document.createElement("a");
				t.className = "batch-item-dl", t.href = e.url, t.download = e.outName || `output_${n}`, t.textContent = "Download", r.appendChild(t);
			}
			t.queue.appendChild(r);
		}), t.downloadAll.style.display = o.some((e) => e.status === "done") ? "inline-block" : "none";
	}
	async function d(e) {
		t.thumbs.innerHTML = "";
		let n = 0;
		for (let t of e) n += t.size;
		t.inputCount.textContent = String(e.length), t.totalSize.textContent = Ad(n);
		for (let n of e) {
			let e = document.createElement("img");
			e.className = "batch-thumb", e.alt = n.name, e.title = n.name, t.thumbs.appendChild(e), i(n).then((t) => {
				t && (e.src = t, s.push(t));
			}).catch(() => {});
		}
	}
	async function f() {
		t.processBtn.setAttribute("aria-busy", "true"), t.processBtn.disabled = !0;
		for (let e of o) {
			e.status = "processing", e.progress = 0, u();
			try {
				let { blob: t, outName: n } = await a(e.file, (t) => {
					e.progress = t, u();
				});
				e.url && URL.revokeObjectURL(e.url), e.blob = t, e.url = URL.createObjectURL(t), e.outName = n, e.status = "done";
			} catch (t) {
				e.status = "error", e.error = t?.message || String(t), console.error(`Batch item "${e.file.name}" failed:`, t);
			}
			u();
		}
		t.processBtn.removeAttribute("aria-busy"), t.processBtn.disabled = !1;
		let e = o.filter((e) => e.status === "done").length;
		console.log(`✅ Batch complete: ${e}/${o.length} succeeded.`);
	}
	async function p() {
		let e = o.filter((e) => e.status === "done" && e.blob);
		if (e.length) {
			t.downloadAll.setAttribute("aria-busy", "true"), t.downloadAll.disabled = !0;
			try {
				...
				for (let n of e) {
					...
					t.add(e), r.push({
						name: e,
						data: new Uint8Array(await n.blob.arrayBuffer())
					});
				}
				let i = Kd(r), a = URL.createObjectURL(i), o = document.createElement("a");
				o.href = a, o.download = n, o.style.display = "none", document.body.appendChild(o), o.click(), o.remove(), setTimeout(() => URL.revokeObjectURL(a), 1e4), console.log(`📦 Zipped ${r.length} file(s) → ${Ad(i.size)}.`);
			} catch (e) {
				console.error("Failed to build zip:", e), alert(`Could not build the zip: ${e?.message || e}`);
			} finally {
				t.downloadAll.removeAttribute("aria-busy"), t.downloadAll.disabled = !1;
			}
		}
	}
	return t.processBtn.addEventListener("click", () => void f()), t.downloadAll.addEventListener("click", () => void p()), {
		start(e) {
			c(), o = e.map((e) => ({
				file: e,
				status: "pending",
				progress: 0
			})), t.processBtn.disabled = !1, t.processBtn.textContent = r(o.length), d(e), u(), console.log(`Batch queued: ${o.length} file(s).`);
		},
		dispose() {
			c(), o = [];
		},
...
function Yd({ root: e }) {
	let t = (t) => e.getElementById(t), n = t("batch-out-format"), r = t("batch-quality"), i = t("batch-quality-label"), a = t("batch-enable-resize"), o = t("batch-resize-controls"), s = t("batch-maxdim-preset"), c = t("batch-maxdim");
	function l() {
		let e = n.value === "image/png";
		i.textContent = e ? "Lossless" : parseFloat(r.value).toFixed(2), r.disabled = e;
	}
	function u() {
	...
	n.addEventListener("change", l), r.addEventListener("input", l), a.addEventListener("change", () => {
		o.style.display = a.checked ? "block" : "none";
	...
	let p = qd({
		elements: {
			thumbs: t("batch-thumbs"),
			inputCount: t("batch-input-count"),
			totalSize: t("batch-total-size"),
			queue: t("batch-queue"),
			count: t("batch-count"),
			processBtn: t("batch-process-btn"),
			downloadAll: t("batch-download-all")
		},
		zipName: "media-converter-images.zip",
		processButtonLabel: (e) => `🖼️ Process All Images (${e})`,
		makeThumb: async (e) => URL.createObjectURL(e),
		process: async (e) => {
			let t = await createImageBitmap(e);
			try {
				let { w: i, h: a } = d(t.width, t.height), o = document.createElement("canvas");
				o.width = i, o.height = a, o.getContext("2d").drawImage(t, 0, 0, i, a);
				let s = n.value, c = s === "image/png" ? void 0 : parseFloat(r.value), l = Jd[s] || "jpg", p;
				try {
					p = await f(o, s, c);
				} catch {
					console.warn(`Format ${s} unsupported for ${e.name}; falling back to JPEG.`), p = await f(o, "image/jpeg", .9), l = "jpg";
				}
				let m = e.name.lastIndexOf("."), h = m > 0 ? e.name.slice(0, m) : e.name, g = u() === null ? "_web_export" : `_${Math.max(i, a)}px`;
				return {
					blob: p,
					outName: `${h}${g}.${l}`
				};
...
//#endregion
//#region src/videoBatchWorkflow.ts
function Xd(e) {
	return new Promise((t) => {
		let n = document.createElement("video");
		n.muted = !0, n.preload = "metadata", n.playsInline = !0;
		let r = URL.createObjectURL(e), i = !1, a = (e) => {
			i || (i = !0, URL.revokeObjectURL(r), t(e));
		};
		n.addEventListener("loadeddata", () => {
			try {
				n.currentTime = Math.min(.1, (n.duration || 1) * .1);
			} catch {
				a(null);
			}
		}), n.addEventListener("seeked", () => {
			try {
				let e = Math.min(1, 160 / Math.max(n.videoWidth || 160, 1)), t = document.createElement("canvas");
				t.width = Math.max(1, Math.round((n.videoWidth || 160) * e)), t.height = Math.max(1, Math.round((n.videoHeight || 90) * e)), t.getContext("2d").drawImage(n, 0, 0, t.width, t.height), a(t.toDataURL("image/jpeg", .6));
			} catch {
				a(null);
			}
		}), n.addEventListener("error", () => a(null)), setTimeout(() => a(null), 5e3), n.src = r;
	});
}
function Zd({ root: e }) {
	let t = (t) => e.getElementById(t), n = t("vbatch-out-format"), r = t("vbatch-out-codec"), i = t("vbatch-quality"), a = t("vbatch-quality-val"), o = t("vbatch-quality-rate"), s = t("vbatch-mute"), c = t("vbatch-enable-resize"), l = t("vbatch-resize-controls"), u = t("vbatch-maxdim-preset"), d = t("vbatch-maxdim");
	function f() {
		let e = parseInt(i.value);
		a.textContent = Nd[e] || "Medium", o.textContent = Fd[e] || "";
	}
	function p() {
	...
	function m(e, t) {
		...
		let i = n / r;
		return {
			w: Math.max(2, Math.round(e * i) & -2),
			h: Math.max(2, Math.round(t * i) & -2)
		};
	}
	n.addEventListener("change", () => Ld(r, n.value)), i.addEventListener("input", f), c.addEventListener("change", () => {
	...
	let h = qd({
		elements: {
			thumbs: t("vbatch-thumbs"),
			inputCount: t("vbatch-input-count"),
			totalSize: t("vbatch-total-size"),
			queue: t("vbatch-queue"),
			count: t("vbatch-count"),
			processBtn: t("vbatch-process-btn"),
			downloadAll: t("vbatch-download-all")
		},
		zipName: "media-converter-videos.zip",
		processButtonLabel: (e) => `🎬 Process All Videos (${e})`,
		makeThumb: Xd,
		process: async (e, t) => {
			let a = new Bs({
				formats: ao,
			...
			try {
				let o = await a.getPrimaryVideoTrack(), c = o ? await o.getDisplayWidth() : 0, l = o ? await o.getDisplayHeight() : 0, u = Rd(n.value), d = new hd({
					format: u.format,
					target: new hu()
				}), f = {
					forceTranscode: !0,
					codec: r.value,
					bitrate: Md[parseInt(i.value)] || Md[3]
				}, h = m(c, l);
				h && (f.width = h.w, f.height = h.h, f.fit = "contain");
				let g = s.checked ? { discard: !0 } : { forceTranscode: !1 }, _ = await bd.init({
					input: a,
					output: d,
					video: f,
					audio: g
				});
				if (!_.isValid) throw _.discardedTracks.forEach((e) => console.warn(`Track discarded: ${e.reason}`)), Error("Unsupported codec/format combination for this file.");
				_.onProgress = (e) => t(e), await _.execute();
				let v = d.target.buffer;
				if (!v) throw Error("Conversion produced an empty buffer.");
				let y = new Blob([v], { type: u.mime }), b = e.name.lastIndexOf("."), x = b > 0 ? e.name.slice(0, b) : e.name, S = h ? Math.max(h.w, h.h) : Math.max(c, l);
				return {
					blob: y,
					outName: `${x}${p() && S ? `_${S}px` : "_web_export"}.${u.ext}`
				};
			} finally {
				a.dispose();
			}
...
function tf() {
	...
	let e = console.log, t = console.warn, n = console.error, r = (e, t, n) => {
		if (n.apply(console, t), Qd.length === 0) return;
		let r = (/* @__PURE__ */ new Date()).toLocaleTimeString(), i = t.map(ef).join(" ").replace(/</g, "&lt;").replace(/>/g, "&gt;"), a = "#a6e22e";
		e === "warn" && (a = "#fd971f"), e === "error" && (a = "#f92672");
		for (let e of Qd) e.innerHTML += `<div style="color: ${a}">[${r}] ${i}</div>`, e.scrollTop = e.scrollHeight;
	};
	console.log = (...t) => r("log", t, e), console.warn = (...e) => r("warn", e, t), console.error = (...e) => r("error", e, n);
}
function nf(e, { themeElement: t }) {
	tf();
	let n = [
		...
		e.getElementById("log-console-vbatch")
	].filter((e) => e != null);
	n.forEach((e) => Qd.push(e)), [
		...
		e.getElementById("clear-console-btn-vbatch")
	...
	let r = e.getElementById("theme-toggle"), i = e.getElementById("theme-icon-moon"), a = e.getElementById("theme-icon-sun"), o = e.getElementById("dropzone"), s = e.getElementById("video-file-input"), c = e.getElementById("loaded-file-section"), l = e.getElementById("video-workspace"), u = e.getElementById("image-workspace"), d = e.getElementById("audio-workspace"), f = e.getElementById("batch-workspace"), p = e.getElementById("video-batch-workspace"), m = e.getElementById("preview-video"), h = e.getElementById("meta-name"), g = e.getElementById("meta-size"), _ = e.getElementById("meta-duration"), v = e.getElementById("meta-resolution"), y = e.getElementById("meta-aspect"), b = e.getElementById("meta-vcodec"), x = e.getElementById("meta-fps"), S = e.getElementById("meta-atrack"), C = e.getElementById("meta-tags"), ee = e.getElementById("conversion-form"), te = e.getElementById("enable-trim"), w = e.getElementById("trim-controls-group"), ne = e.getElementById("trim-start"), re = e.getElementById("trim-end"), ie = e.getElementById("trim-start-val"), ae = e.getElementById("trim-end-val"), oe = e.getElementById("trim-selection-bar"), T = e.getElementById("enable-resize"), se = e.getElementById("resize-controls-group"), E = e.getElementById("resize-preset"), ce = e.getElementById("resize-width"), le = e.getElementById("resize-height"), ue = e.getElementById("preserve-aspect"), de = e.getElementById("resize-fit"), D = e.getElementById("out-format"), O = e.getElementById("out-vcodec"), fe = e.getElementById("out-quality"), pe = e.getElementById("out-quality-val"), me = e.getElementById("out-quality-rate"), he = e.getElementById("quality-help"), k = e.getElementById("fast-copy-tag"), A = [
		"panel-crop",
		"panel-resize",
		"panel-codec",
		"panel-compression",
		"panel-rotation",
		"panel-resample"
	].map((t) => e.getElementById(t)), j = e.getElementById("enable-crop-video"), ge = e.getElementById("crop-controls-group"), _e = e.getElementById("crop-x"), ve = e.getElementById("crop-y"), ye = e.getElementById("crop-w"), be = e.getElementById("crop-h"), xe = e.getElementById("crop-full"), Se = e.getElementById("crop-square"), Ce = e.getElementById("video-crop-overlay"), we = e.getElementById("video-crop-box"), Te = e.querySelector("label[for=\"audio-mode-transcode\"]"), Ee = e.getElementById("rotate-correction"), De = e.getElementById("allow-rot-metadata"), Oe = e.getElementById("enable-fps"), ke = e.getElementById("fps-controls-group"), Ae = e.getElementById("target-fps"), je = e.getElementById("fps-mode"), Me = e.getElementById("use-custom-bitrate"), Ne = e.getElementById("custom-bitrate-group"), Pe = e.getElementById("custom-bitrate"), Fe = e.getElementById("custom-bitrate-mbps-label"), Ie = e.getElementById("audio-mode-copy"), Le = e.getElementById("audio-mode-transcode"), Re = e.getElementById("audio-mode-mute"), ze = e.getElementById("audio-transcode-controls"), Be = e.getElementById("audio-codec"), Ve = e.getElementById("audio-bitrate"), He = e.getElementById("audio-channels"), Ue = e.getElementById("audio-samplerate"), We = e.getElementById("convert-btn"), Ge = e.getElementById("cancel-btn"), Ke = e.getElementById("progress-section"), qe = e.getElementById("progress-title"), Je = e.getElementById("progress-percentage"), Ye = e.getElementById("conversion-progress"), Xe = e.getElementById("progress-time-processed"), Ze = e.getElementById("progress-speed"), Qe = e.getElementById("result-section"), $e = e.getElementById("download-anchor"), et = e.getElementById("output-size-tag"), tt = e.getElementById("output-video"), nt = e.getElementById("output-placeholder"), rt = e.getElementById("image-result-section"), it = null, M = null, N = 0, P = 0, at = 0, ot = 0, st = !1, F = null, ct = null, lt = null, ut = null, dt = null, I = {
		lastSample: null,
	...
	function pt() {
		...
		t.setAttribute("data-theme", e), mt(e);
	}
	function mt(e) {
	...
	r.addEventListener("click", () => {
		...
		t.setAttribute("data-theme", e), localStorage.setItem("theme", e), mt(e);
	}), pt();
	function ht() {
	...
	ct = kd({
		root: e,
		formatBytes: Ad,
		revealLoadedSection: ht
	}), lt = Vd({
		root: e,
		formatBytes: Ad,
		revealLoadedSection: ht
	}), ut = Yd({ root: e }), dt = Zd({ root: e }), o.addEventListener("click", () => s.click()), ["dragenter", "dragover"].forEach((e) => {
		...
		t && t.length > 0 && gt(Array.from(t));
	}), s.addEventListener("change", () => {
		s.files && s.files.length > 0 && gt(Array.from(s.files));
	});
	function gt(e) {
		if (e.length <= 1) {
			yt(e[0]);
		...
		let t = e.filter((e) => _t(e) === "image"), n = e.filter((e) => _t(e) === "video"), r = () => {
			ct?.dispose(), lt?.dispose(), M &&= (M.dispose(), null);
		};
		n.length >= 2 ? (vt("vbatch"), r(), dt?.start(n), ht(), n.length < e.length && console.warn(`Video batch: ${e.length - n.length} non-video file(s) were ignored.`)) : t.length >= 2 ? (vt("batch"), r(), ut?.start(t), ht(), t.length < e.length && console.warn(`Image batch: ${e.length - t.length} non-image file(s) were ignored.`)) : yt(e[0]);
	}
	function _t(e) {
	...
	function vt(e) {
		l.style.display = e === "video" ? "grid" : "none", u.style.display = e === "image" ? "grid" : "none", d.style.display = e === "audio" ? "grid" : "none", f.style.display = e === "batch" ? "block" : "none", p.style.display = e === "vbatch" ? "block" : "none", Ke.style.display = "none", Qe.style.display = "none", nt.style.display = "", rt.style.display = "none", ct?.setActive(e === "image"), lt?.setActive(e === "audio"), e !== "batch" && ut?.dispose(), e !== "vbatch" && dt?.dispose();
	}
	async function yt(e) {
		let t = _t(e);
		if (!t) {
		...
		M && t !== "video" && (M.dispose(), M = null), t === "video" ? await bt(e) : t === "image" ? (vt("image"), lt?.dispose(), await ct?.load(e)) : (vt("audio"), ct?.dispose(), await lt?.load(e));
	}
	async function bt(e) {
		it = e, vt("video"), console.log(`Loading video file: "${e.name}" (${Ad(e.size)})`), ct?.dispose(), lt?.dispose(), Qe.style.display = "none", tt.src && URL.revokeObjectURL(tt.src), tt.src = "", m.src = URL.createObjectURL(e), h.textContent = e.name, g.textContent = Ad(e.size);
		try {
			M && M.dispose(), M = new Bs({
				formats: ao,
				source: new Oa(e)
			}), await M.canRead() || console.warn("Input format is unrecognized by MediaBunny. Transcoding might fail depending on engine codecs.");
			let t = await M.getFormat();
			console.log(`Detected Container Format: ${t.name} (MimeType: ${t.mimeType})`);
			let n = await M.getVideoTracks(), r = await M.getAudioTracks();
			console.log(`Detected: ${n.length} video track(s) and ${r.length} audio track(s).`);
			let i = await M.getPrimaryVideoTrack();
			if (i) {
				N = await i.getDisplayWidth(), P = await i.getDisplayHeight();
				let e = await i.getCodec(), t = await i.getCodedWidth(), n = await i.getCodedHeight(), a = await i.getRotation();
				at = await M.computeDuration(), _.textContent = jd(at), v.textContent = `${N}x${P}`, y.textContent = `${(N / P).toFixed(2)}:1`, b.textContent = String(e).toUpperCase();
				try {
					let e = await i.computePacketStats(300);
					e && e.averagePacketRate ? (ot = e.averagePacketRate, x.textContent = `${e.averagePacketRate.toFixed(2)} fps`, console.log(`Computed original FPS estimate: ${e.averagePacketRate} fps from prefix stats.`)) : x.textContent = "Unknown";
				} catch (e) {
					console.warn("Could not compute primary video packet stats for FPS metadata:", e), x.textContent = "Unknown";
				}
				st = r.length > 0, S.textContent = r.length > 0 ? `${r.length} track(s)` : "Muted / None", console.log(`Video details: ${t}x${n} coded dimensions, display size ${N}x${P}, natural rotation: ${a}°`), ce.value = String(N), le.value = String(P), ce.max = String(N * 2), le.max = String(P * 2), xt.setDuration(at), kt();
			} else console.warn("No video track detected inside this clip! Options might behave differently."), v.textContent = "Audio Only", y.textContent = "-", b.textContent = "-";
			try {
				let e = await M.getMetadataTags(), t = {};
				for (let [n, r] of Object.entries(e)) r instanceof Uint8Array ? t[n] = `[Binary Array: ${Ad(r.length)}]` : Array.isArray(r) ? t[n] = `[Array of ${r.length} entries]` : t[n] = r;
				C.textContent = Object.keys(t).length > 0 ? JSON.stringify(t, null, 2) : "No tags parsed from metadata container.";
			} catch {
				C.textContent = "Unabled to parse metadata block tags.";
			}
			ht(), Mt();
		} catch (e) {
	...
	function St() {
		let e = Me.checked;
		Ne.style.display = e ? "block" : "none", fe.disabled = e, pe.style.opacity = e ? "0.4" : "", me.style.opacity = e ? "0.4" : "";
	}
	Me.addEventListener("change", () => {
		St(), Mt();
	}), St(), Pe.addEventListener("input", () => {
		let e = parseInt(Pe.value);
		!isNaN(e) && e > 0 ? Fe.textContent = `${(e / 1e6).toFixed(2)} Mbps` : Fe.textContent = "- Mbps";
	}), Oe.addEventListener("change", () => {
		ke.style.display = Oe.checked ? "block" : "none";
	}), T.addEventListener("change", () => {
		se.style.display = T.checked ? "block" : "none";
	});
	function Ct(e) {
		if (!N || !P) return e;
		let t = N / P;
	...
	ce.addEventListener("input", () => {
		if (ue.checked && ce.value) {
			let e = parseInt(ce.value);
			e > 0 && (le.value = String(Ct(e)));
		}
	}), le.addEventListener("input", () => {
		if (ue.checked && le.value) {
			let e = parseInt(le.value);
			e > 0 && (ce.value = String(wt(e)));
		}
	}), E.addEventListener("change", () => {
		let e = E.value;
		if (e === "custom") {
			ce.disabled = !1, le.disabled = !1;
			return;
		}
		if (e.startsWith("square")) {
			let t = e === "square-1080" ? 1080 : 720;
			ce.value = String(t), le.value = String(t), ue.checked = !1;
		} else {
			let t = parseInt(e);
			ce.value = String(t), le.value = String(Ct(t)), ue.checked = !0;
		}
	...
	function Et(e) {
		let t = N, n = P, r = Math.max(0, Math.min(Math.round(e.x), Math.max(0, t - 8))), i = Math.max(0, Math.min(Math.round(e.y), Math.max(0, n - 8)));
		return {
			x: r,
			y: i,
	...
	function Dt() {
		!N || !P || (we.style.left = `${L.x / N * 100}%`, we.style.top = `${L.y / P * 100}%`, we.style.width = `${L.width / N * 100}%`, we.style.height = `${L.height / P * 100}%`);
	}
	function Ot(e) {
		L = Et(e), _e.value = String(L.x), ve.value = String(L.y), ye.value = String(L.width), be.value = String(L.height), Dt(), Mt();
	}
	function kt() {
		Ot({
			x: 0,
	...
	j.addEventListener("change", () => {
		let e = j.checked;
		ge.style.display = e ? "block" : "none", Ce.style.display = e ? "block" : "none", e && (!L.width || !L.height) && kt(), Dt(), Mt();
	}), [
		_e,
		ve,
		ye,
		...
		e.addEventListener("input", () => {
			Ot({
				x: parseInt(_e.value) || 0,
				y: parseInt(ve.value) || 0,
				width: parseInt(ye.value) || 8,
				height: parseInt(be.value) || 8
			});
		});
	}), xe.addEventListener("click", () => kt()), Se.addEventListener("click", () => {
		let e = Math.min(N, P);
		Ot({
			x: Math.floor((N - e) / 2),
			y: Math.floor((P - e) / 2),
	...
	}), we.addEventListener("pointerdown", (e) => {
		N && (Tt = {
		...
		let n = (e.clientX - Tt.startX) / t.width * N, r = (e.clientY - Tt.startY) / t.height * P, i = Tt.start;
		if (Tt.handle === "move") {
			Ot({
				x: Math.max(0, Math.min(i.x + n, N - i.width)),
				y: Math.max(0, Math.min(i.y + r, P - i.height)),
				width: i.width,
				height: i.height
			});
			return;
		}
		let a = i.x, o = i.y, s = i.width, c = i.height, l = i.x + i.width, u = i.y + i.height, d = Tt.handle;
		(d === "nw" || d === "sw") && (a = Math.min(i.x + n, l - 8), s = l - a), (d === "ne" || d === "se") && (s = Math.max(8, i.width + n)), (d === "nw" || d === "ne") && (o = Math.min(i.y + r, u - 8), c = u - o), (d === "sw" || d === "se") && (c = Math.max(8, i.height + r)), Ot({
			x: a,
			y: o,
			width: s,
			height: c
	...
	function At() {
		let e = parseInt(fe.value);
		pe.textContent = Nd[e] || "Medium", me && (me.textContent = Fd[e] || ""), he.textContent = Pd[e] || "";
	}
	fe.addEventListener("input", At), At();
	let jt = e.getElementById("size-estimate");
	function Mt() {
		if (!jt) return;
		if (k.checked) {
			jt.textContent = "≈ source size (stream copy, no re-encode)";
			return;
		}
		if (!at) {
			jt.textContent = "—";
		...
		let e = at;
		if (te.checked) {
			let t = parseFloat(ne.value), n = parseFloat(re.value);
			!isNaN(t) && !isNaN(n) && n > t && (e = n - t);
		}
		let t = N, n = P;
		if (j.checked && L.width && L.height && (t = L.width, n = L.height), T.checked) {
			let e = parseInt(ce.value), r = parseInt(le.value);
			e > 0 && (t = e), r > 0 && (n = r);
		}
		let r = ot || 30;
		if (Oe.checked) {
			let e = parseInt(Ae.value);
			e > 0 && (r = e);
		}
		let i;
		if (Me.checked) i = parseInt(Pe.value) || 0;
		else {
			let e = Id[parseInt(fe.value)] ?? 3.5, a = t && n ? t * n / (1920 * 1080) : 1, o = r / 30;
			i = e * 1e6 * a * o;
		}
		let a = 0;
		Le.checked ? a = parseInt(Ve.value) || 0 : Ie.checked && st && (a = 128e3), jt.textContent = "≈ " + Ad((i + a) * e / 8);
	}
	ee.addEventListener("input", Mt), ee.addEventListener("change", Mt);
	function Nt() {
		let e = k.checked;
		A.forEach((t) => {
			t && (t.style.display = e ? "none" : "");
		}), Te && (Te.style.display = e ? "none" : ""), e && Le.checked && (Ie.checked = !0, ze.style.display = "none");
	}
	k.addEventListener("change", Nt), Nt(), Ie.addEventListener("change", () => ze.style.display = "none"), Re.addEventListener("change", () => ze.style.display = "none"), Le.addEventListener("change", () => ze.style.display = "block"), ee.addEventListener("submit", async (e) => {
		if (e.preventDefault(), !it || !M) {
			alert("Please load a source media file before executing transcription.");
			return;
		}
		ft(), We.style.display = "none", Ge.style.display = "inline-block", Ke.style.display = "block", Qe.style.display = "none", nt.style.display = "none", qe.textContent = "🐰 Initializing conversion pipeline...", Je.textContent = "0%", Ye.value = 0, Xe.textContent = "Processed Time: 0s / 0s";
		let t = performance.now();
		try {
			let e = D.value === "mp4", n = e ? new $u() : new rd(), r = new hu(), i = new hd({
				format: n,
				target: r
			}), a = {};
			if (k.checked) console.log("⚡ Fast Copy trim mode enabled. Omitting size / quality alterations."), a.forceTranscode = !1;
			else {
				if (a.forceTranscode = !0, a.codec = O.value, Me.checked) {
					let e = parseInt(Pe.value);
					!isNaN(e) && e > 1e3 ? (a.bitrate = e, console.log(`Using custom target video bitrate: ${(e / 1e6).toFixed(2)} Mbps (${e} bps)`)) : (a.bitrate = es, console.log("Custom bitrate was invalid. Defaulting to Medium Preset Quality."));
				} else {
					let e = parseInt(fe.value);
					a.bitrate = Md[e] || es, console.log(`Using video quality preset level: ${e} (${Nd[e] || "Medium"})`);
				}
				if (j.checked && (a.crop = {
					left: L.x,
					top: L.y,
					width: L.width,
					height: L.height
				}, console.log(`Cropping frame to ${L.width}x${L.height} at (${L.x}, ${L.y}).`)), T.checked && (ce.value && (a.width = parseInt(ce.value)), le.value && (a.height = parseInt(le.value)), a.fit = de.value, console.log(`Setting resize dimensions: ${a.width}x${a.height} (${a.fit})`)), Oe.checked) {
					let e = parseInt(Ae.value);
					if (!isNaN(e) && e > 0) if (je.value === "blend") {
						let t = 1 / e;
						console.log(`Setting up hardware-accelerated Bidirectional Frame Blending at ${e} FPS.`), a.process = async (e) => {
							...
							if (I.isFirstFrame) {
								I.isFirstFrame = !1, I.nextOutputTimestamp = e.timestamp, I.lastSample = e.clone(), I.blendCanvas = document.createElement("canvas"), I.blendCanvas.width = n, I.blendCanvas.height = r, I.blendCtx = I.blendCanvas.getContext("2d");
								let i = e.clone();
								return i.setTimestamp(I.nextOutputTimestamp), i.setDuration(t), I.nextOutputTimestamp += t, [i];
							}
							let i = I.lastSample, a = e, o = i.timestamp, s = a.timestamp, c = s - o, l = [];
							for (; I.nextOutputTimestamp <= s;) {
								let s = I.nextOutputTimestamp, u = 0;
								c > 0 && (u = (s - o) / c), u = Math.max(0, Math.min(1, u));
								let d = u * u * (3 - 2 * u), f = I.blendCanvas, p = I.blendCtx;
								p.clearRect(0, 0, n, r);
								...
								l.push(g), I.nextOutputTimestamp += t;
							}
							return i.close(), I.lastSample = a.clone(), l;
						};
					} else a.frameRate = e, console.log(`Setting output target frame rate: ${e} FPS (continuous repeating mode).`);
				}
			}
			let o = parseInt(Ee.value);
			o !== 0 && (a.rotate = o, a.forceTranscode = !0, console.log(`Applying manual rotation adjustment: ${o}° CW.`)), a.allowRotationMetadata = De.checked;
			let s = {};
			if (Re.checked) console.log("🔇 Mutex setting: Stripping entire audio stream from output."), s.discard = !0;
			else if (Ie.checked) console.log("⚡ Audio block: Direct pass-through copy selected."), s.forceTranscode = !1;
			else if (Le.checked) {
				s.forceTranscode = !0, s.codec = Be.value, s.bitrate = parseInt(Ve.value);
				let e = parseInt(He.value);
				e > 0 && (s.numberOfChannels = e);
				let t = parseInt(Ue.value);
				t > 0 && (s.sampleRate = t), console.log(`Transcoding Audio Stream: ${s.codec} at ${parseInt(Ve.value) / 1e3}kbps, SampleRate: ${t || "Original"}, Channels: ${e || "Original"}`);
			}
			let c = {};
			if (te.checked && (c.start = parseFloat(ne.value), c.end = parseFloat(re.value), console.log(`Clip window enabled: ${c.start}s to ${c.end}s (Trim duration: ${(c.end - c.start).toFixed(2)}s)`)), F = await bd.init({
				input: M,
				output: i,
				video: a,
				audio: s,
				trim: te.checked ? c : void 0
			}), !F.isValid) throw console.error("Transcode pipeline validation failed!"), F.discardedTracks.forEach((e) => {
			...
			let l = te.checked ? c.end - c.start : at;
			F.onProgress = (e, n) => {
				let r = Math.min(100, Math.round(e * 100));
				Je.textContent = `${r}%`, Ye.value = r, qe.textContent = `🐰 Transcoding active clip frames (${r}%)`, Xe.textContent = `Processed Time: ${n.toFixed(1)}s / ${l.toFixed(1)}s`;
				let i = (performance.now() - t) / 1e3;
				n > 0 && (Ze.textContent = `Processing speed: ${(n / i).toFixed(2)}x real-time`);
			}, console.log("🚀 Launching conversion backend. Please wait..."), await F.execute();
			let u = r.buffer;
			...
			$e.href = m;
			let h = it.name.lastIndexOf(".");
			$e.download = `${h > 0 ? it.name.slice(0, h) : it.name}_web_export.${f}`, et.textContent = `Size: ${Ad(p.size)}`, tt.src = m, console.log(`🎉 Transcoding successfully finished! Outfile Size: ${Ad(p.size)}.`), Qe.style.display = "block", Qe.scrollIntoView({ behavior: "smooth" });
		} catch (e) {
			...
			ft(), We.style.display = "inline-block", Ge.style.display = "none", Ke.style.display = "none", Qe.style.display === "none" && (nt.style.display = ""), F = null;
		}
	}), Ge.addEventListener("click", async () => {
		F && (console.log("Requesting cancellation of active codec processors..."), await F.cancel());
	});
}
//#endregion
//#region src/component.ts
var rf = t.replace(/:root\b/g, ":host"), af = "\n:host { display: block; }\n.mb-app {\n  font-family: var(--pico-font-family, system-ui, sans-serif);\n  font-size: var(--pico-font-size, 100%);\n  line-height: var(--pico-line-height, 1.5);\n  color: var(--pico-color);\n  background-color: var(--pico-background-color);\n  -webkit-font-smoothing: antialiased;\n  padding: 0.5rem 1.5rem 2rem;\n}\n", of = class extends HTMLElement {
	connectedCallback() {
		if (this.shadowRoot) return;
		let e = this.attachShadow({ mode: "open" }), t = document.createElement("style");
		t.textContent = rf + af, e.appendChild(t);
		let r = document.createElement("div");
		r.className = "mb-app", r.setAttribute("data-theme", this.getAttribute("theme") || "dark"), r.innerHTML = n, e.appendChild(r), nf(e, { themeElement: r });
	}
};
customElements.get("media-converter") || customElements.define("media-converter", of), customElements.get("mediabunny-toolkit") || customElements.define("mediabunny-toolkit", class extends of {});
//#endregion
export { of as MediaConverter };
